...
The real September 6 capture is cached locally: 233 actions × 28 values, 234 states, 3.883 seconds of simulation. Browser tests cover frame navigation, playback, alternate fields, selector persistence and downloads. See the validation receipts for later task and hand checks.
