...
7. Choose Share beside a saved recording to open AirDrop / Save to Files. Sharing dismisses any remaining tracking space before presenting the system share sheet. In the Skynet browser, Data → Collection → Import recording. Verify left/right/head counts, duration and warnings. Export the original and compare SHA-256 if checking data integrity.
