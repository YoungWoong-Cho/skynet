...
const elements = {
  ...
  jobsPartitionFilterLabel: document.querySelector("#jobs-partition-filter-label"),
  jobsPartitionFilterOptions: document.querySelector("#jobs-partition-filter-options"),
  jobsAccountFilterLabel: document.querySelector("#jobs-account-filter-label"),
  jobsAccountFilterOptions: document.querySelector("#jobs-account-filter-options"),
  ...
  experimentRuntimeProfileSelect: document.querySelector("#experiment-runtime-profile-select"),
  experimentRuntimeProfile: document.querySelector("#experiment-runtime-profile"),
  ...
  hpBatchSemanticsDefault: document.querySelector("#hp-batch-semantics-default"),
  ...
  adapterDeclaredFieldsGrid: document.querySelector("#adapter-declared-fields-grid"),
  ...
  checkpointSaveStepsDefault: document.querySelector("#checkpoint-save-steps-default"),
  ...
  wandbExperimentConnection: document.querySelector("#wandb-experiment-connection"),
  ...
  mlflowExperimentConnection: document.querySelector("#mlflow-experiment-connection"),
  ...
  experimentEvaluationSuites: document.querySelector("#experiment-evaluation-suites"),
  ...
  experimentRevisionIntent: document.querySelector("#experiment-revision-intent"),
  ...
  experimentPreviewBlockers: document.querySelector("#experiment-preview-blockers"),
  experimentPreviewBlockerList: document.querySelector("#experiment-preview-blocker-list"),
  ...
  experimentDetailTracking: document.querySelector("#experiment-detail-tracking"),
  ...
  evaluationCheckpointValidation: document.querySelector("#evaluation-checkpoint-validation"),
  ...
  evaluationTasksFilterLabel: document.querySelector("#evaluation-tasks-filter-label"),
  ...
  dataBundleCount: document.querySelector("#data-bundle-count"),
  dataBundlesBody: document.querySelector("#data-bundles-body"),
  dataBundlePreview: document.querySelector("#data-bundle-preview"),
  dataBundlePreviewTitle: document.querySelector("#data-bundle-preview-title"),
  dataBundlePreviewStatus: document.querySelector("#data-bundle-preview-status"),
  dataBundlePreviewSummary: document.querySelector("#data-bundle-preview-summary"),
  dataBundlePreviewUsage: document.querySelector("#data-bundle-preview-usage"),
  dataBundlePreviewRoles: document.querySelector("#data-bundle-preview-roles"),
  dataBundlePreviewVersions: document.querySelector("#data-bundle-preview-versions"),
  dataBundlePreviewDatasets: document.querySelector("#data-bundle-preview-datasets"),
  dataBundlePreviewTasks: document.querySelector("#data-bundle-preview-tasks"),
  dataBundlePreviewEpisodes: document.querySelector("#data-bundle-preview-episodes"),
  dataBundlePreviewFeatures: document.querySelector("#data-bundle-preview-features"),
  dataBundlePreviewModalities: document.querySelector("#data-bundle-preview-modalities"),
  dataBundlePreviewSamples: document.querySelector("#data-bundle-preview-samples"),
  dataBundlePreviewMediaEmpty: document.querySelector("#data-bundle-preview-media-empty"),
  dataBundlePreviewMediaControls: document.querySelector("#data-bundle-preview-media-controls"),
  dataBundlePreviewMediaSelect: document.querySelector("#data-bundle-preview-media-select"),
  dataBundlePreviewMediaPlayer: document.querySelector("#data-bundle-preview-media-player"),
  dataBundlePreviewMediaMeta: document.querySelector("#data-bundle-preview-media-meta"),
  dataBundlePreviewWarnings: document.querySelector("#data-bundle-preview-warnings"),
  ...
  dataVersionResourceLabel: document.querySelector("#data-version-resource-label"),
  ...
  dataImportResourceLabel: document.querySelector("#data-import-resource-label"),
  ...
  dataImportBundleName: document.querySelector("#data-import-bundle-name"),
  dataImportBundleVersion: document.querySelector("#data-import-bundle-version"),
  ...
  dataBundleForm: document.querySelector("#data-bundle-form"),
  dataBundleName: document.querySelector("#data-bundle-name"),
  dataBundleVersion: document.querySelector("#data-bundle-version"),
  dataBundleDescription: document.querySelector("#data-bundle-description"),
  dataBundleAssignments: document.querySelector("#data-bundle-assignments"),
  createDataBundle: document.querySelector("#create-data-bundle"),
  experimentDataBundle: document.querySelector("#experiment-data-bundle"),
  experimentDataBundleStatus: document.querySelector("#experiment-data-bundle-status"),
  ...
  adapterValidationRepository: document.querySelector("#adapter-validation-repository"),
  adapterValidationRevision: document.querySelector("#adapter-validation-revision"),
  ...
  collectionAdapterEditorTitle: document.querySelector("#collection-adapter-editor-title"),
  ...
  collectionAdapterVersion: document.querySelector("#collection-adapter-version"),
  collectionAdapterRunnable: document.querySelector("#collection-adapter-runnable"),
  collectionAdapterDescription: document.querySelector("#collection-adapter-description"),
  collectionAdapterStreams: document.querySelector("#collection-adapter-streams"),
  collectionAdapterRequirements: document.querySelector("#collection-adapter-requirements"),
  collectionAdapterLauncher: document.querySelector("#collection-adapter-launcher"),
  collectionAdapterCapabilities: document.querySelector("#collection-adapter-capabilities"),
  collectionAdapterDefaults: document.querySelector("#collection-adapter-defaults"),
  collectionAdapterTodos: document.querySelector("#collection-adapter-todos"),
  collectionAdapterMetadata: document.querySelector("#collection-adapter-metadata"),
  ...
  collectionSessionAdapter: document.querySelector("#collection-session-adapter"),
  collectionSessionName: document.querySelector("#collection-session-name"),
  collectionSessionOperator: document.querySelector("#collection-session-operator"),
  collectionSessionTask: document.querySelector("#collection-session-task"),
  collectionSessionEmbodiment: document.querySelector("#collection-session-embodiment"),
  collectionRuntimeProfile: document.querySelector("#collection-runtime-profile"),
  ...
  collectionRegisterOutput: document.querySelector("#collection-register-output"),
  collectionRegisterProvider: document.querySelector("#collection-register-provider"),
  collectionRegisterNamespace: document.querySelector("#collection-register-namespace"),
  ...
  collectionStorageMetadata: document.querySelector("#collection-storage-metadata"),
  collectionCalibrationIdentity: document.querySelector("#collection-calibration-identity"),
  collectionCalibrationSha: document.querySelector("#collection-calibration-sha"),
  collectionCalibrationMetadata: document.querySelector("#collection-calibration-metadata"),
  collectionSoftware: document.querySelector("#collection-software"),
  collectionConfig: document.querySelector("#collection-config"),
  collectionCaptureSchemaName: document.querySelector("#collection-capture-schema-name"),
  collectionCaptureSchemaVersion: document.querySelector("#collection-capture-schema-version"),
  ...
  collectionTimestampsRecorded: document.querySelector("#collection-timestamps-recorded"),
  collectionCaptureMetadata: document.querySelector("#collection-capture-metadata"),
  collectionCapabilities: document.querySelector("#collection-capabilities"),
  collectionCapabilitiesHelp: document.querySelector("#collection-capabilities-help"),
  ...
  collectionSessionDetailTitle: document.querySelector("#collection-session-detail-title"),
  collectionSessionActions: document.querySelector("#collection-session-actions"),
  ...
  collectionCompleteManifest: document.querySelector("#collection-complete-manifest"),
  collectionCompleteRevision: document.querySelector("#collection-complete-revision"),
...
function normalizedEvaluationTaskOptions(suite) {
  const config = suite?.config_json && typeof suite.config_json === "object" ? suite.config_json : {};
  const hasStructuredOptions = Array.isArray(suite?.task_options) || Array.isArray(config.task_options);
  ...
  return source.flatMap((task) => {
    ...
    seen.add(id);
    const metadata = structured && task.metadata && typeof task.metadata === "object" && !Array.isArray(task.metadata)
      ? task.metadata
      : {};
    return [{
      id,
      label: String(structured ? task.label || id : id),
      description: structured && task.description ? String(task.description) : "",
      metadata,
...
function evaluationTaskProfileText(option) {
  const profile = option?.metadata?.profile ?? option?.metadata?.profile_id ?? option?.metadata?.profile_name;
...
function evaluationTaskSelectionPolicy(suite, count) {
  const config = suite?.config_json && typeof suite.config_json === "object" ? suite.config_json : {};
  const declaration = suite?.task_selection && typeof suite.task_selection === "object"
    ? suite.task_selection
    : config.task_selection && typeof config.task_selection === "object"
      ? config.task_selection
      : {};
  const declaredMode = suite?.task_selection_mode ?? config.task_selection_mode ?? declaration.mode ?? "subset";
  const mode = ["single", "subset", "all_only"].includes(String(declaredMode))
    ? String(declaredMode)
    : "invalid";
  const reason = suite?.task_selection_reason
...
function applyEvaluationTaskSelectionPolicy(changedInput = null) {
  ...
  const invalidSingle = policy.mode === "single" && inputs.length > 1 && checked.length !== 1;
  const invalidAllOnly = policy.mode === "all_only" && checked.length > 0;
  const invalidPolicy = policy.mode === "invalid";
  const unavailableSelection = elements.evaluationSuite.dataset.taskSelectionError || "";
  const invalid = invalidSingle || invalidAllOnly || invalidPolicy || Boolean(unavailableSelection);
  inputs.forEach((input, index) => {
    input.disabled = policy.mode === "all_only" && !invalidAllOnly;
    input.setCustomValidity(index === 0 && invalid
      ? unavailableSelection
        || (invalidSingle ? policy.reason || "Choose exactly one task for this suite." : "")
        || (invalidAllOnly ? "This suite only permits its complete default task set; clear individual selections." : "")
        || policy.reason
      : "");
  });
  elements.evaluationTasksFilter.classList.toggle("is-disabled", !inputs.length || (policy.mode === "all_only" && !invalidAllOnly));
  elements.evaluationTasksFilter.setAttribute("aria-disabled", String(!inputs.length || (policy.mode === "all_only" && !invalidAllOnly)));
  ...
  const defaults = selectedEvaluationSuite()?.default_tasks || selectedEvaluationSuite()?.config_json?.default_tasks || [];
  elements.evaluationTasksClear.hidden = policy.mode === "single" && inputs.length > 1 && defaults.length !== 1;
  ...
  const modeStatus = invalidPolicy
    ...
    : policy.mode === "single"
    ? inputs.length > 1
      ? invalidSingle ? "Choose exactly one task." : "One task selected."
...
function installEvaluationCreateValidityGuard() {
  evaluationCreateButton = elements.evaluationForm.querySelector('button[type="submit"], input[type="submit"]');
  const prototype = evaluationCreateButton instanceof HTMLButtonElement
    ? HTMLButtonElement.prototype
    : evaluationCreateButton instanceof HTMLInputElement
      ? HTMLInputElement.prototype
      : null;
  if (!prototype) return;
  evaluationCreateDisabledDescriptor = Object.getOwnPropertyDescriptor(prototype, "disabled");
  if (!evaluationCreateDisabledDescriptor?.get || !evaluationCreateDisabledDescriptor?.set) return;
  evaluationCreateRequestedDisabled = evaluationCreateDisabledDescriptor.get.call(evaluationCreateButton);
  Object.defineProperty(evaluationCreateButton, "disabled", {
    configurable: true,
    get() { return evaluationCreateDisabledDescriptor.get.call(this); },
    set(value) {
      evaluationCreateRequestedDisabled = Boolean(value);
      evaluationCreateDisabledDescriptor.set.call(this, evaluationCreateRequestedDisabled || !evaluationTaskSelectionLocallyValid);
    },
  });
}
...
function installStructuredEvaluationTaskOptions() {
  ...
  populateEvaluationTasks = (suite, options = {}) => {
    const renderOptions = Array.isArray(options) ? { preferredTasks: options } : options || {};
    ...
    renderedEvaluationTaskPolicy = evaluationTaskSelectionPolicy(suite, taskOptions.length);
    const currentSelection = preserve && suiteId && suiteId === renderedEvaluationTaskSuiteId
    ...
    const normalizedSuite = suite ? {
      ...
      config_json: {
        ...(suite.config_json && typeof suite.config_json === "object" ? suite.config_json : {}),
        task_options: undefined,
        tasks: taskOptions.map((option) => option.id),
      },
    } : suite;
    ...
    elements.evaluationTasksOptions.querySelectorAll("input").forEach((input) => {
      input.type = renderedEvaluationTaskPolicy.mode === "single" ? "radio" : "checkbox";
      ...
      const helpText = [option.description, profile ? `Profile: ${profile}` : ""].filter(Boolean).join(" · ");
      if (helpText) {
...
function positionViewportFilterMenu(details) {
  ...
  const heightCap = Math.min(evaluationMenu ? 420 : 300, Math.floor(viewportHeight * 0.72));
  const opensUpward = availableBelow < Math.min(heightCap, 220) && availableAbove > availableBelow;
...
function scheduleViewportFilterMenus() {
  ...
  viewportFilterMenuFrame = window.requestAnimationFrame(() => {
    document.querySelectorAll("details.partition-filter[open]").forEach(positionViewportFilterMenu);
  });
}
...
function installViewportFilterMenus() {
  ...
  document.addEventListener("keydown", (event) => {
    if (event.key !== "Escape" || event.defaultPrevented || SkynetDialog.fullscreenOwnsEscape()) return;
...
function stableRefreshValue(value, seen = new WeakSet()) {
  ...
  const normalized = Array.isArray(value)
    ...
    : Object.fromEntries(Object.keys(value).sort().map((key) => [key, stableRefreshValue(value[key], seen)]));
  seen.delete(value);
  return normalized;
}
...
function captureBackgroundRefreshState(panel) {
  const scrollNodes = [panel, ...panel.querySelectorAll(".table-scroll, .filter-options, textarea, pre, [data-preserve-scroll]")]
  ...
  return {
    ...
    scrollNodes,
    details: [...panel.querySelectorAll("details")].map((node) => ({ node, open: node.open })),
  };
}
...
function commitPanelRefresh(panel, channel, payload, mutation, { background = false } = {}) {
...
function patchTableRow(row, cells) {
  while (row.cells.length < cells.length) row.append(document.createElement("td"));
...
let evaluationTargetValidationState = { pending: false, valid: false, planValid: false, signature: "" };
...
let adapterEditorState = { mode: "view", id: null, adapter: null, versions: [] };
...
async function sourceMetadataRequest(path, { forceRefresh = false } = {}) {
  ...
  const request = api(requestPath).then((payload) => ({
    payload,
    fromCache: payload?._cache?.backend === "database" && payload._cache.hit === true,
  }));
  ...
  try {
    ...
    if (sourceMetadataRequests.get(path) === request) sourceMetadataRequests.delete(path);
  }
}
...
function rememberSourceSelection(repository, saved) {
  ...
  const selection = { branch: String(saved.branch || ""), commits: { ...commits } };
...
function saveSourceSelection(repository, branch, commit = "") {
  ...
  const write = previous
    .catch(() => undefined)
    .then(() => api(`/api/source/selection?${query.toString()}`, { method: "PUT" }))
    .then((result) => rememberSourceSelection(repository, result.selection));
  sourceSelectionWrites.set(repository, write);
  write.catch((error) => {
    setSourceRefStatus(`Could not save repository selection in the database: ${error.message}`, "error");
  }).finally(() => {
    if (sourceSelectionWrites.get(repository) === write) sourceSelectionWrites.delete(repository);
  });
}
...
function listFrom(payload, keys) {
  ...
  if (!payload || typeof payload !== "object" || Array.isArray(payload)) {
    throw new Error("List API response must be an array or an object containing a list.");
  }
  for (const key of [...keys, "items"]) {
    if (Array.isArray(payload[key])) return payload[key];
  }
  throw new Error(`List API response did not contain any expected array: ${[...keys, "items"].join(", ")}.`);
}
...
function clearNotificationScope(scope) {
  ...
  document.querySelectorAll("[data-notification-scope]").forEach((item) => {
    ...
    else if (item.classList.contains("notice-item")) dismissNoticeItem(item.parentElement, item);
  });
}
...
function showToast(message, isError = false, { scope = "" } = {}) {
  if (scope) {
    ...
    else elements.toast.querySelectorAll(".toast").forEach((item) => {
...
function showNotice(element, message, { title = "", scope = "" } = {}) {
  if (scope) element.querySelectorAll(".notice-item").forEach((item) => {
    if (item.dataset.notificationScope === scope) dismissNoticeItem(element, item);
  });
  const normalizedMessage = String(message);
  const duplicate = [...element.querySelectorAll(".notice-item")].some((item) => (
    item.dataset.message === normalizedMessage && item.dataset.title === title
...
function stateClass(state) {
  ...
  if (/fail|error|cancel|unavailable|missing|invalid|incomplete|not completed|attention|blocked/.test(normalized)) return "is-failed";
...
function numberOrNull(element) {
  const label = element.labels?.[0]?.textContent?.trim() || element.name || element.id || "Numeric value";
...
function quotaCell(metric) {
  ...
  const hasLimit = rawLimit !== null && rawLimit !== undefined && rawLimit !== "" && Number.isFinite(Number(rawLimit));
  const limit = hasLimit ? Number(rawLimit) : null;
  const ratio = hasLimit && limit > 0 ? Math.min(100, Math.round((usage / limit) * 100)) : 0;
...
const allocationColors = ["#386cb0", "#1f8a5b", "#cb5a30", "#8065a5", "#c84662", "#277b88", "#80731f"];
...
function gpuAllocationCell(metric) {
  ...
  if (other) {
    segments.push(`<span class="allocation-segment is-other" style="width:${(other / units) * 100}%" title="Other or snapshot delta: ${other} GPUs">other<b>${other}</b></span>`);
  }
  if (free) {
...
function renderAccountUsage(rows) {
  ...
  elements.usageBody.innerHTML = rows.map((row) => `
...
function updateFilterLabel(key) {
  ...
  else if (filter.selected.size === 1) filter.label.textContent = [...filter.selected][0];
  else filter.label.textContent = `${filter.selected.size} ${filter.countSuffix}`;
...
function renderFilterOptions(key) {
  ...
  filter.options.innerHTML = `
    ...
    ${filter.available.map((partition) => `
  ...
  filter.options.querySelector('[data-action="all"]').addEventListener("click", () => {
  ...
  filter.options.querySelector('[data-action="none"]').addEventListener("click", () => {
    filter.selectionError = "";
    filter.all = false;
    filter.selected.clear();
    renderFilterOptions(key);
  ...
  filter.options.querySelectorAll('input[type="checkbox"]').forEach((checkbox) => {
...
function syncFilterOptions(key, items, field) {
  const filter = queueFilters[key];
  if (!filter) return;
  filter.available = [...new Set(items.flatMap((item) => itemPartitions(item, field)))].sort();
  if (!filter.all) {
    const unavailable = [...filter.selected].filter((value) => !filter.available.includes(value));
    filter.selectionError = unavailable.length
      ...
      : "";
    filter.selected = new Set([...filter.selected].filter((value) => filter.available.includes(value)));
  }
  renderFilterOptions(key);
}
...
function matchesFilter(key, item, field) {
  ...
  return filter.all || itemPartitions(item, field).some((value) => filter.selected.has(value));
}
...
function applyPartitionFilters() {
  ...
  const jobs = pendingJobs.filter((job) => (
...
function renderJobs(jobs, totalJobs = jobs.length) {
  ...
  if (!jobs.length) {
    ...
    elements.jobSummary.textContent = totalJobs ? `Showing 0 of ${totalJobs} pending jobs.` : "No pending jobs in the Slurm queue.";
    return;
  }

  elements.jobSummary.textContent = jobs.length === totalJobs
...
function renderSnapshot(snapshot, { background = false } = {}) {
  ...
  const panel = elements.jobsBody.closest('[data-tab-panel="cluster"]') || elements.jobsBody.closest(".panel") || elements.jobsBody;
  commitPanelRefresh(panel, "cluster-snapshot", {
    ...
    setTextIfChanged(elements.lastUpdated, `Updated ${new Intl.DateTimeFormat(undefined, {
      hour: "numeric",
      minute: "2-digit",
      second: "2-digit",
    }).format(new Date())}`);
...
function scheduleClusterAutoRefresh() {
  ...
  refreshTimer = window.setTimeout(() => refreshCluster({ background: true }), 15000);
}
...
async function refreshCluster({ force = false, background = false } = {}) {
  ...
  try {
    ...
    const panel = elements.jobsBody.closest('[data-tab-panel="cluster"]') || elements.jobsBody.closest(".panel") || elements.jobsBody;
    commitPanelRefresh(panel, "cluster-snapshot", { error: error.message }, () => {
      setConnection("offline", "Cluster connection failed");
      showNotice(elements.errorBanner, error.message, { title: "Cluster unavailable" });
    }, { background });
  } finally {
...
function adapterVersion(adapter) {
  return adapter?.selected_version?.version_number
...
function adapterManifest(adapter) {
  const raw = adapter?.selected_version?.manifest ?? adapter?.latest_version?.manifest ?? adapter?.manifest;
  ...
  if (typeof raw === "string") {
    try {
      ...
      return { __parse_error: `Invalid adapter manifest JSON: ${error.message}` };
    }
  }
...
function adapterArchived(adapter) {
  return Boolean(adapter?.archived || adapter?.is_archived || adapter?.status === "archived" || adapter?.archived_at);
}

function adapterAvailableForExperiment(adapter) {
  const manifest = adapterManifest(adapter);
  return !adapterArchived(adapter)
...
function repositoryDefaults(manifest, adapter = {}) {
  ...
  const repositoryObject = repository && typeof repository === "object" ? repository : {};
...
function manifestDefault(manifest, section, key) {
  ...
  if (descriptor && typeof descriptor === "object" && !Array.isArray(descriptor) && descriptor.default !== undefined) {
...
function manifestCapabilityLabel(manifest) {
  ...
  if (capabilities && typeof capabilities === "object") {
    const labels = [
      capabilities.supports_multi_gpu_single_node ? "single-node multi-GPU" : "single GPU",
      capabilities.supports_resume ? "resume" : "no resume",
      capabilities.supports_evaluation_resume ? "evaluation resume" : null,
      Array.isArray(capabilities.evaluation_adapters) && capabilities.evaluation_adapters.length
        ? `eval: ${capabilities.evaluation_adapters.join(", ")}`
        : null,
    ].filter(Boolean);
    if (labels.length) return labels.join(" / ");
  }
  return [manifest.train ? "train" : null, manifest.evaluation ? "evaluation" : null]
    .filter(Boolean)
    .join(", ") || "No capabilities declared";
}

function adapterRuntimeDetection(manifest) {
  const detection = manifest.runtime_detection ?? manifest.runtime?.detection ?? manifest.runtime;
  ...
  if (detection && typeof detection === "object") {
    const allowed = Array.isArray(detection.allowed_backends)
      ...
      : detection.allowed_backends instanceof Set ? [...detection.allowed_backends] : [];
    if (allowed.length) {
      return `${detection.recommended_backend ? `recommended ${detection.recommended_backend}; ` : ""}allowed ${allowed.join(", ")}`;
    }
    return firstValue(detection.mode, detection.strategy, detection.type, Object.keys(detection).join(", ")) || "configured";
  }
  return "not declared";
}
...
function selectedAdapter() {
  if (
    ...
    && adapterOptionId(loadedExperimentAdapterSnapshot) === elements.experimentAdapter.value
  ) return loadedExperimentAdapterSnapshot;
  return adapterRows.find(
    (adapter) => adapterOptionId(adapter) === elements.experimentAdapter.value,
  ) || null;
}
...
function selectedBatchCompatibility() {
  const manifest = selectedAdapter() ? adapterManifest(selectedAdapter()) : null;
...
function currentAdapterConditionValue(path) {
  const field = adapterInputFields().find((candidate) => candidate.path === path);
  if (field) {
  ...
  const commonValues = {
    ...
    "source.project_subdirectory": elements.experimentWorkdir.value.trim() || ".",
    "train.learning_rate": numberOrNull(elements.hpLearningRate),
    "train.batch.declared_semantics": elements.hpBatchSemantics.value || "per_device",
    "train.batch.value": numberOrNull(elements.hpBatchSize),
    "train.batch.gradient_accumulation_steps": numberOrNull(elements.hpGradAcc) ?? 1,
    "train.num_workers_per_rank": numberOrNull(elements.hpNumWorkers),
    "train.max_steps": numberOrNull(elements.hpMaxSteps),
    "train.precision": elements.hpPrecision.value === "adapter-default" ? null : elements.hpPrecision.value,
    "resources.gpu.mode": elements.gpuMode.value === "manual" ? "explicit" : "auto",
    "resources.gpu.count": elements.gpuMode.value === "manual" ? numberOrNull(elements.experimentGpuCount) : null,
    "resources.gpu.gpu_type": elements.experimentGpuType.value === "auto" ? "any" : elements.experimentGpuType.value,
  };
...
function matchingGpuRecommendation(manifest) {
  ...
  return recommendations.find((recommendation) => {
    ...
    return conditions && typeof conditions === "object" && !Array.isArray(conditions)
      && Object.entries(conditions).every(([path, choices]) => (
        Array.isArray(choices)
        && choices.some((choice) => adapterConditionValuesEqual(currentAdapterConditionValue(path), choice))
      ));
  }) || null;
}
...
function resolvedExperimentGpuCount() {
  ...
  const capabilities = matchingGpuRecommendation(manifest) || manifest.capabilities || {};
...
function updateBatchCompatibility() {
  ...
  [...elements.hpBatchSemantics.options].forEach((option) => {
    if (option.value && !Object.hasOwn(BATCH_SEMANTIC_LABELS, option.value)) return;
    option.disabled = Boolean(
      compatibility
      && batchExplicit
      && (option.value ? !allowedSet.has(option.value) : !allowedSet.has(defaultSemantic)),
    );
  });
  ...
  if (accumulationExplicit && (!Number.isInteger(accumulation) || accumulation < 1)) {
    accumulationErrors.push("Gradient accumulation must be a positive whole number.");
  }

  if (compatibility && batchExplicit && Number.isInteger(batchSize) && batchSize > 0) {
    const allowedLabels = allowed.map((semantic) => BATCH_SEMANTIC_LABELS[semantic]).join(" or ");
    if (!gpuCount && compatibility.batch_size_divisible_by === "resolved_gpu_count") {
      batchErrors.push("Enter a valid GPU allocation so batch divisibility can be checked.");
    }
    ...
    if (
      ...
      const lower = Math.max(gpuCount, Math.floor(batchSize / gpuCount) * gpuCount);
      const upper = Math.ceil(batchSize / gpuCount) * gpuCount;
      const suggestions = lower === upper ? String(lower) : `${lower} or ${upper}`;
      batchErrors.push(`Batch size ${batchSize} must be divisible by ${gpuCount} resolved GPUs; use ${suggestions}, or another multiple of ${gpuCount}.`);
    }
  }
  if (
    compatibility
    ...
    accumulationErrors.push("This adapter does not support gradient accumulation; leave it blank for the repository default or set it to 1.");
  }
  ...
  elements.hpBatchCompatibility.classList.toggle("is-invalid", errors.length > 0);
  elements.hpBatchCompatibility.classList.toggle("is-valid", errors.length === 0 && (batchExplicit || accumulationExplicit));
  elements.hpBatchCompatibility.classList.toggle("is-pending", errors.length === 0 && !batchExplicit && !accumulationExplicit);
  if (errors.length) {
    elements.hpBatchCompatibility.textContent = errors.join(" ");
  } else if (!batchExplicit && !accumulationExplicit) {
    elements.hpBatchCompatibility.textContent = "Leave batch fields blank to preserve the displayed defaults.";
    ...
    const divisor = compatibility.batch_size_divisible_by === "resolved_gpu_count" && gpuCount
      ? ` Batch size ${batchSize} is divisible across ${gpuCount} resolved GPU${gpuCount === 1 ? "" : "s"}.`
      : "";
    const accumulationStatus = compatibility.supports_gradient_accumulation === false
      ? " Gradient accumulation is fixed at 1."
      : accumulationExplicit ? ` Gradient accumulation is ${accumulation}.` : "";
...
function setManifestDefault(element, value) {
  if (!canonicalControlValues.has(element)) canonicalControlValues.set(element, element.value);
  element.querySelectorAll?.("option[data-invalid-adapter-default]").forEach((option) => option.remove());
  element.setCustomValidity("");
  ...
  if (element instanceof HTMLSelectElement && ![...element.options].some((option) => option.value === normalized)) {
    const label = element.labels?.[0]?.textContent?.trim() || element.name || element.id || "field";
    const message = `Adapter default "${normalized}" is unavailable for ${label}.`;
    element.dataset.adapterDefaultError = message;
    element.setCustomValidity(message);
    element.insertAdjacentHTML("afterbegin", `<option value="${escapeHtml(normalized)}" data-invalid-adapter-default disabled>${escapeHtml(message)}</option>`);
...
function setManifestCheckbox(element, value) {
  if (!canonicalCheckboxValues.has(element)) canonicalCheckboxValues.set(element, element.checked);
  element.checked = typeof value === "boolean" ? value : canonicalCheckboxValues.get(element);
}
...
function supportedCanonicalFields(manifest) {
  ...
  const mapped = bindings && typeof bindings === "object" && !Array.isArray(bindings)
...
function canonicalFieldIsSupported(path, supported) {
  return [...supported].some((item) => path === item || path.startsWith(`${item}.`));
}
...
function precisionSupportFromManifest(manifest) {
  ...
  if (!binding) {
    ...
    return canonicalFieldIsSupported("train.precision", declared)
      ? { bindingDeclared: true, supported: new Set(Object.keys(canonicalPrecisionLabels)) }
      : { bindingDeclared: false, supported: new Set() };
  }
  const valueMap = binding.value_map;
  if (!valueMap || typeof valueMap !== "object" || Array.isArray(valueMap) || Object.keys(valueMap).length === 0) {
    return { bindingDeclared: true, supported: new Set(Object.keys(canonicalPrecisionLabels)) };
  }
  return {
    bindingDeclared: true,
    supported: new Set(Object.keys(valueMap).filter((value) => value in canonicalPrecisionLabels)),
  };
}
...
function updatePrecisionStatus(resetValue = "") {
  ...
  if (!activePrecisionBindingDeclared) {
    elements.hpPrecisionStatus.textContent = "This adapter does not declare canonical precision overrides; leave Default selected to preserve the displayed value.";
    return;
  }
...
function configurePrecisionField(manifest) {
  ...
  [...elements.hpPrecision.options].forEach((option) => {
    ...
    option.textContent = option.disabled ? `${label} (unsupported by adapter)` : label;
  });

  const declaredDefault = manifestDefault(manifest, "hyperparameters", "precision");
...
function nativeDefaultsText(value) {
  ...
  if (value && typeof value === "object") {
    return Object.entries(value).map(([key, nested]) => `${key}=${JSON.stringify(nested)}`).join("\n");
  }
...
function declaredAdapterInputFields(adapter = selectedAdapter()) {
  ...
  return Array.isArray(fields) ? fields.filter((field) => field && typeof field.path === "string") : [];
}

function adapterInputOptionsScopeKey(adapter, repository, commit, projectSubdirectory) {
...
function normalizeRepositoryInputOptions(payload) {
  ...
  if (!rawOptions || typeof rawOptions !== "object" || Array.isArray(rawOptions)) return normalized;
  Object.entries(rawOptions).forEach(([path, raw]) => {
    ...
    normalized.set(path, {
      ...
      warnings: Array.isArray(raw.warnings)
        ...
        : raw.warning ? [String(raw.warning)] : [],
    });
  });
  return normalized;
}
...
const COMMON_HYPERPARAMETER_DEFAULT_FIELDS = Object.freeze([
  { path: "train.learning_rate", control: "hpLearningRate", status: "hpLearningRateDefault", manifestKeys: ["learning_rate"] },
  { path: "train.batch.value", control: "hpBatchSize", status: "hpBatchSizeDefault", manifestKeys: ["batch_size"] },
  { path: "train.batch.declared_semantics", control: "hpBatchSemantics", status: "hpBatchSemanticsDefault", manifestKeys: ["batch_semantics"], defaultOption: "" },
  { path: "train.batch.gradient_accumulation_steps", control: "hpGradAcc", status: "hpGradAccDefault", manifestKeys: ["gradient_accumulation_steps", "gradient_accumulation"] },
  { path: "train.num_workers_per_rank", control: "hpNumWorkers", status: "hpNumWorkersDefault", manifestKeys: ["num_workers_per_rank", "num_workers"] },
  { path: "train.precision", control: "hpPrecision", status: "hpPrecisionDefault", manifestKeys: ["precision"], defaultOption: "adapter-default" },
  { path: "train.max_steps", control: "hpMaxSteps", status: "hpMaxStepsDefault", manifestKeys: ["max_steps"] },
  {
...
function selectedRepositoryHyperparameterDefaults(adapter = selectedAdapter()) {
  ...
  adapterInputFields(adapter).forEach((field) => {
    ...
    if (!option?.complete || !metadata || typeof metadata !== "object" || Array.isArray(metadata)) return;
...
function manifestHyperparameterDefault(manifest, keys, section = "hyperparameters") {
...
function repositoryDefaultProvenance(record) {
  ...
  const commit = source.commit ? ` at commit ${shortId(source.commit, 12)}` : "";
  ...
  COMMON_HYPERPARAMETER_DEFAULT_FIELDS.forEach((definition) => {
    ...
    if (definition.path === "train.max_steps" && !record) {
      ...
      if (maxEpochs) {
        ...
        const provenance = maxEpochs.origin === "repository"
    ...
    if (definition.defaultOption !== undefined) {
      const option = [...control.options].find((candidate) => candidate.value === definition.defaultOption);
...
function resetCommonHyperparameterOverrides() {
  [elements.hpLearningRate, elements.hpBatchSize, elements.hpGradAcc, elements.hpNumWorkers, elements.hpMaxSteps, elements.checkpointSaveSteps].forEach((control) => {
    control.value = "";
...
function clearRepositoryInputOptions({ render = false } = {}) {
  ...
  if (render && elements.adapterDeclaredFieldsGrid) renderAdapterDeclaredFields();
}
...
function adapterInputFields(adapter = selectedAdapter()) {
  ...
  return fields.map((field) => {
    ...
    if (!field.choice_source && !discovered && !field.data_binding) return field;
...
function selectedExperimentDataBundle() {
  const id = elements.experimentDataBundle?.value;
...
function resolveAdapterDataBinding(field) {
  ...
  if (!bundle) {
    return { value: null, state: "empty", message: "Choose a registered bundle to derive this value, or enter it manually." };
  }
  const matches = (Array.isArray(bundle.assignments) ? bundle.assignments : [])
    .filter((assignment) => String(assignment?.role || "") === String(binding.role || ""))
    .sort((left, right) => Number(left.position || 0) - Number(right.position || 0));
  const assignment = matches.find((item) => Number(item.position || 0) === Number(binding.position || 0));
  if (!assignment) {
    return { value: null, state: "error", message: `Selected bundle has no ${binding.role} role at position ${Number(binding.position || 0)}.` };
  }
  const format = String(assignment.version?.format || "");
  const formats = Array.isArray(binding.formats) ? binding.formats.map(String) : [];
  if (formats.length && !formats.some((candidate) => candidate.toLowerCase() === format.toLowerCase())) {
    return {
      value: null,
      state: "error",
...
function adapterDeclaredScope(adapter) {
  ...
  const versionId = String(firstValue(
    version.id,
    adapter.selected_version_id,
    adapter.latest_version_id,
...
function reconcileAdapterDeclaredScope(scope) {
  ...
  if (previousHash && previousHash !== scope.manifestHash) {
    for (const key of adapterDeclaredValueState.keys()) {
      if (key.startsWith(`${scope.base}\u001f`)) adapterDeclaredValueState.delete(key);
    }
  }
  adapterDeclaredScopeHashes.set(scope.base, scope.manifestHash);
}

function adapterDeclaredScopeValues(scope = renderedAdapterDeclaredScope, create = false) {
...
function setAdapterFieldControlValue(control, field, value) {
  ...
  } else if (field.choices?.length && control.dataset.adapterInputAllowCustom !== "true") {
...
function captureAdapterDeclaredValues() {
  ...
  if (!values) return;
  elements.adapterDeclaredFieldsGrid.querySelectorAll("[data-adapter-input-path]").forEach((control) => {
...
function renderAdapterDeclaredFields(adapter = selectedAdapter()) {
  ...
  fields.forEach((field) => {
    ...
    if (field.sensitive) {
      ...
      control = document.createElement("input");
      control.type = ["integer", "number"].includes(field.kind) ? "number" : "text";
      if (control.type === "number") control.step = field.kind === "integer" ? "1" : "any";
      ...
      (field.choices || []).forEach((choice) => {
        ...
        option.value = typeof choice === "string" ? choice : JSON.stringify(choice);
      ...
      control.placeholder = field.kind === "json" ? "Valid JSON" : "One value per line";
    } else {
      control = document.createElement("input");
    ...
    control.dataset.adapterInputAllowCustom = String(field.choice_source?.allow_custom === true);
    ...
    const saved = field.sensitive ? null : adapterDeclaredScopeValues(scope)?.get(field.path);
    if (saved?.kind === field.kind && saved.touched) {
      if (control.type === "checkbox") control.checked = Boolean(saved.raw);
      else if (control instanceof HTMLSelectElement) {
        const savedValue = String(saved.raw ?? "");
        control.value = [...control.options].some((option) => option.value === savedValue) ? savedValue : "";
      } else control.value = String(saved.raw ?? "");
    } else if (!field.sensitive && field._dataBindingResolution?.value) {
      setAdapterFieldControlValue(control, field, field._dataBindingResolution.value);
    } else if (!field.sensitive && field.default !== null && field.default !== undefined) {
...
function parseAdapterDeclaredValue(control, field) {
  if (field.kind === "boolean" && control.type === "checkbox") return { present: true, value: Boolean(control.checked) };
  const raw = control.value.trim();
  if (!raw) return { present: false, value: null };
  try {
    let value;
    if (field.choices?.length && control.dataset.adapterInputAllowCustom !== "true") value = JSON.parse(raw);
    else if (field.kind === "boolean") {
      if (!["true", "false"].includes(raw.toLowerCase())) throw new Error("must be true or false");
      value = raw.toLowerCase() === "true";
    }
    else if (field.kind === "integer" || field.kind === "number") value = Number(raw);
    else if (field.kind === "json") value = JSON.parse(raw);
    else if (field.kind === "string_list") value = raw.split(/\r?\n/).map((item) => item.trim()).filter(Boolean);
    else value = raw;
...
function adapterOverrideDescriptor(path) {
  ...
  if (path === "native.resume_argv") return { key: "resume_argv", namespace: "reserved" };
  if (path.startsWith("native.config.")) {
    const suffix = path.slice("native.config.".length);
    const segments = suffix.split(".");
    if (!suffix || segments.some((segment) => !/^[a-z][a-z0-9_]*$/.test(segment) || ["__proto__", "prototype", "constructor"].includes(segment.toLowerCase()))) {
  ...
  if (path.startsWith("native.overrides.")) {
    ...
    const segments = suffix.split(".");
    if (!suffix || segments.some((segment) => !/^[A-Za-z_][A-Za-z0-9_-]*$/.test(segment) || ["__proto__", "prototype", "constructor"].includes(segment.toLowerCase()))) {
      return { error: `Unsupported canonical path “${path}”.` };
    }
...
function collectAdapterDeclaredOverrides() {
  ...
  adapterInputFields().forEach((field) => {
    const control = document.getElementById(adapterFieldControlId(field.path));
    if (!control) {
      if (field.required) errors.push(`${field.label} is required but is not available.`);
      return;
    }
    control.setCustomValidity("");
    if (field.sensitive && (field.choices?.length || field.default !== null && field.default !== undefined || field.tutorial_value !== null && field.tutorial_value !== undefined)) {
    ...
    const collision = declaredDescriptors.find((existing) => adapterOverrideKeysCollide(existing, descriptor));
    if (collision) {
  ...
  const advancedLines = elements.nativeOverrides.value.split("\n").map((line) => line.trim()).filter(Boolean);
  const advancedDescriptors = [];
  advancedLines.forEach((line) => {
    const separator = line.indexOf("=");
    const key = (separator < 0 ? line : line.slice(0, separator)).trim();
    const descriptor = { key, namespace: key.startsWith("config.") ? "config" : "advanced" };
    const declaredCollision = declaredDescriptors.find((existing) => adapterOverrideKeysCollide(existing, descriptor));
    const advancedCollision = advancedDescriptors.find((existing) => adapterOverrideKeysCollide(existing, descriptor));
    if (!key) errors.push("Advanced native values must use a nonempty key before '='.");
    if (declaredCollision) errors.push(`Advanced native key “${key}” conflicts with declared field “${declaredCollision.key}”.`);
    if (advancedCollision) errors.push(`Advanced native key “${key}” conflicts with earlier key “${advancedCollision.key}”.`);
    advancedDescriptors.push(descriptor);
  });
  const advancedError = errors.find((message) => message.startsWith("Advanced")) || "";
...
function tutorialApplyAdapterDeclaredValues() {
  ...
  adapterInputFields().forEach((field) => {
    const control = document.getElementById(adapterFieldControlId(field.path));
    if (!control) return;
    if (!field.sensitive && field.tutorial_value !== null && field.tutorial_value !== undefined) {
      setAdapterFieldControlValue(control, field, field.tutorial_value);
      adapterDeclaredScopeValues(renderedAdapterDeclaredScope, true)?.set(field.path, {
        kind: field.kind,
        raw: adapterFieldRawValue(control),
        touched: true,
      });
    ...
    } else if (field.required && !parseAdapterDeclaredValue(control, field).present) {
      firstMissing ||= control;
    }
  });
  if (firstMissing) tutorialSetError("This adapter does not declare a tutorial value for every required field. Enter or choose the missing value yourself.");
...
function experimentPreviewShapeErrors(payload) {
  ...
  else if (payload.blockers.some((blocker) => !blocker || typeof blocker.variant !== "string" || !blocker.variant.trim() || !Array.isArray(blocker.reasons) || blocker.reasons.some((reason) => typeof reason !== "string" || !reason.trim()))) {
    errors.push("each blocker must have a variant and nonempty reason strings");
  }
  if (!Array.isArray(payload.scripts) || payload.scripts.some((script) => typeof script !== "string" || !script.trim())) errors.push("scripts must be a nonempty-string array");
  if (typeof payload.script !== "string" || !payload.script.trim()) errors.push("script must be a nonempty string");
  if (!Number.isInteger(payload.variant_count) || payload.variant_count <= 0) errors.push("variant_count must be a positive integer");
  if (Array.isArray(payload.scripts) && Number.isInteger(payload.variant_count) && payload.scripts.length !== payload.variant_count) errors.push("variant_count must equal scripts.length");
  if (Array.isArray(payload.scripts) && typeof payload.script === "string" && payload.script !== payload.scripts.join("\n\n")) errors.push("script must be the canonical joined scripts value");
  if (!Array.isArray(payload.warnings) || payload.warnings.some((warning) => typeof warning !== "string")) errors.push("warnings must be a string array");
  if (typeof payload.resolved_revision !== "string" || !payload.resolved_revision.trim()) errors.push("resolved_revision must be a nonempty string");
  return errors;
}

function experimentPreviewScriptIsRunnable(script) {
  return typeof script === "string" && Boolean(script.trim()) && !script.includes("# BLOCKED");
}
...
function applyEvaluationSuiteDefaults(suiteIds) {
  ...
  const available = new Set([...elements.experimentEvaluationSuites.options].map((option) => option.value));
  const unavailable = pendingEvaluationSuiteDefaults.filter((suiteId) => !available.has(suiteId));
  ...
  if (message) {
    ...
    if (!adapterDefaultErrors.includes(message)) adapterDefaultErrors.push(message);
    showNotice(elements.experimentsError, `Adapter manifest defaults are invalid: ${adapterDefaultErrors.join(" ")}`);
  } else {
...
function applySelectedAdapter({ loadSource = true } = {}) {
  ...
  renderCommonHyperparameterDefaults(adapter);
  setManifestDefault(elements.resourceCpus, manifestDefault(manifest, "resources", "cpus_per_task"));
  ...
  setManifestDefault(elements.experimentGpuType, manifestDefault(manifest, "resources", "gpu_type"));
  setManifestDefault(elements.resourceNodes, manifestDefault(manifest, "resources", "nodes"));
  setManifestDefault(elements.checkpointMode, manifestDefault(manifest, "checkpoint", "mode"));
  setManifestDefault(elements.checkpointPath, manifestDefault(manifest, "checkpoint", "path"));
  setManifestDefault(elements.checkpointMaxAttempts, manifestDefault(manifest, "checkpoint", "max_attempts"));
  document.querySelector("#checkpoint-warning-seconds").value = manifestDefault(manifest, "checkpoint", "save_before_timeout_seconds") ?? 300;
  configureCanonicalHyperparameterFields(manifest);
  setManifestCheckbox(elements.checkpointAutoResume, manifestDefault(manifest, "checkpoint", "auto_resume"));
  setManifestCheckbox(elements.mlflowEnabled, manifestDefault(manifest, "tracking", "enabled"));
  setManifestDefault(elements.mlflowExperiment, firstValue(
    manifestDefault(manifest, "tracking", "mlflow_experiment"),
    manifestDefault(manifest, "tracking", "experiment"),
  ));
  setManifestDefault(elements.mlflowRunName, manifestDefault(manifest, "tracking", "run_name_template"));
  setManifestCheckbox(elements.evaluationEnabled, manifestDefault(manifest, "evaluation", "enabled"));
  applyEvaluationSuiteDefaults(manifestDefault(manifest, "evaluation", "suite_ids"));
  const nativeDefaults = firstValue(manifest.defaults?.native_overrides, manifest.defaults?.native?.overrides);
  setManifestDefault(
  ...
  if (capabilities.supports_resume === false) elements.checkpointAutoResume.checked = false;
...
function renderAdapters() {
  if (!adapterRows.length) {
    elements.adaptersBody.innerHTML = emptyRow(7, "No adapters are registered.");
    elements.adapterCount.textContent = "0 adapters";
    return;
  }
  const activeCount = adapterRows.filter((adapter) => !adapterArchived(adapter)).length;
  elements.adapterCount.textContent = `${activeCount} active / ${adapterRows.length} total`;
  elements.adaptersBody.innerHTML = adapterRows.map((adapter) => {
    const id = adapterId(adapter);
    const manifest = adapterManifest(adapter);
    const source = manifest.__parse_error || repositoryDefaults(manifest, adapter).url || "-";
    const archived = adapterArchived(adapter);
    const version = adapterVersion(adapter);
    const hash = adapter.selected_version?.manifest_sha256 || adapter.latest_version?.manifest_sha256 || adapter.manifest_sha256 || "";
    return `
      <tr>
        ...
        <td><span class="job-id">v${escapeHtml(version)}</span>${hash ? `<span class="secondary">${escapeHtml(shortId(hash, 10))}</span>` : ""}</td>
...
function populateExperimentAdapters(preserveId = "") {
  ...
  if (!available.length) {
    elements.experimentAdapter.innerHTML = '<option value="">No active adapters</option>';
    elements.experimentAdapter.disabled = true;
    elements.adapterStatus.textContent = "No active adapters registered";
    elements.adapterCapabilities.textContent = "Create or restore an adapter in the Adapter Registry.";
    return;
  }
  elements.experimentAdapter.innerHTML = available.map((adapter) => {
  ...
  if (preserveId && available.some((adapter) => adapterOptionId(adapter) === preserveId)) {
    ...
    elements.experimentAdapter.insertAdjacentHTML("afterbegin", `<option value="${escapeHtml(preserveId)}" disabled>${escapeHtml(message)}</option>`);
    elements.experimentAdapter.value = preserveId;
  ...
  const pinnedIsHistorical = pinned
    && !active.some((adapter) => adapterOptionId(adapter) === adapterOptionId(pinned));
  const pinnedIsSelected = pinnedIsHistorical
...
async function loadAdapters(force = false) {
  ...
  try {
    ...
    if (!selected || selected !== elements.experimentAdapter.value || !selectedAdapter()) {
      applySelectedAdapter();
    }
  } catch (error) {
    adapterRows = [];
    elements.experimentAdapter.innerHTML = '<option value="">Adapter API unavailable</option>';
    elements.experimentAdapter.disabled = true;
    elements.adapterStatus.textContent = `Adapter API unavailable: ${error.message}`;
    showNotice(elements.adaptersError, `Adapter registry unavailable: ${error.message}`);
  } finally {
...
function normalizedEditorManifest() {
  ...
  manifest.slug = adapterEditorState.mode === "create"
    ? identitySlug
    : String(adapterManifest(adapterEditorState.adapter).slug || identitySlug);
...
function setAdapterEditorMode(mode) {
  ...
  elements.adapterEditorMode.textContent = creating ? "NEW ADAPTER" : editing ? "NEW IMMUTABLE VERSION" : "ADAPTER DETAIL";
...
function unmountRowDisclosure(panel) {
  ...
  if (!detached && (!companion || companion.dataset.disclosurePanel !== (panel.id || "row-disclosure"))) return false;
...
function mountRowDisclosure(panel, launcher) {
  ...
  detailRow.className = "run-detail-row row-disclosure-row row-disclosure-companion";
...
function remountActiveRunAttemptDisclosure() {
  ...
  const launcher = [...elements.attemptsBody.querySelectorAll('[data-attempt-action="view"]')]
    .find((candidate) => String(candidate.dataset.attemptKey || candidate.closest("[data-attempt-key]")?.dataset.attemptKey || "") === attemptKey);
  if (!launcher) {
...
function revealPanel(panel, { focusTarget = null, launcher = null, scroll = true } = {}) {
  ...
  window.requestAnimationFrame(() => {
    ...
    if ((scroll || detachedRowDetail) && !modal) {
      ...
      panel.scrollIntoView({ behavior: reducedMotion ? "auto" : "smooth", block: detachedRowDetail ? "start" : "nearest", inline: "nearest" });
    }
...
function hideRevealedPanel(panel, fallbackLauncher = null, { restoreFocus = true, fromDisclosure = false } = {}) {
  if (!panel) return;
  closedPanelGenerations.set(panel, (closedPanelGenerations.get(panel) || 0) + 1);
  ...
  const launcher = recordedLauncher?.isConnected ? recordedLauncher : fallbackLauncher;
  revealedPanelLaunchers.delete(panel);
  if (!restoreFocus) return;
  const closedGeneration = revealedPanelGenerations.get(panel);
  window.requestAnimationFrame(() => {
    if (!panel.hidden || revealedPanelGenerations.get(panel) !== closedGeneration) return;
    if (launcher?.isConnected) {
      if (detachedRowDetail) launcher.scrollIntoView({ behavior: "auto", block: "center", inline: "nearest" });
...
function disclosureRevealIsCurrent(panel, launcher = null) {
  if (!panel || panel.dataset.disclosureManaged !== "true" || !launcher) return true;
  return Boolean(
    activeDisclosure
    && activeDisclosure.panel === panel
    && String(activeDisclosure.token) === String(panel.dataset.disclosureToken || ""),
  );
}

function disclosureToken(panel, launcher = null) {
  if (!activeDisclosure || activeDisclosure.panel !== panel || (launcher && activeDisclosure.launcher !== launcher))
...
function setDisclosureLauncherActive(launcher, panel, token) {
  ...
  queueMicrotask(() => {
    if (activeDisclosure?.launcher !== launcher || activeDisclosure.token !== token) return;
...
function closeActiveDisclosure({ restoreFocus = true } = {}) {
  ...
  if (closing.panel === elements.evaluationDetail) stopEvaluationDetailPolling();
  restoreDisclosureLauncher(closing.launcher, closing.panel);
  delete closing.panel.dataset.disclosureToken;
  hideRevealedPanel(closing.panel, closing.launcher, { restoreFocus, fromDisclosure: true });
  return true;
}
...
function disclosureIntentForLauncher(launcher) {
  ...
  const fixed = {
    ...
    "add-collection-adapter": [elements.collectionAdapterForm, "collection-adapter:new"],
  ...
  if (launcher.closest("#experiments-body") && launcher.dataset.experimentAction === "view") {
    return { panel: elements.experimentDetail, revealKey: `experiment:${id}`, rowOwned: true };
  }
  if (launcher.closest("#runs-body") && launcher.dataset.runAction === "view") {
    return { panel: elements.runDetail, revealKey: `run:${id}`, rowOwned: true };
  }
  if (launcher.closest("#evaluations-body") && launcher.dataset.evaluationAction === "view") {
    return { panel: elements.evaluationDetail, revealKey: `evaluation:${id}`, rowOwned: true };
  }
  if (launcher.closest("#collection-sessions-body") && launcher.dataset.collectionSessionAction === "view") {
    return { panel: elements.collectionSessionDetail, revealKey: `collection-session:${id}`, rowOwned: true };
  }
  if (launcher.closest("#data-bundles-body") && launcher.dataset.bundleAction === "preview") {
    return { panel: elements.dataBundlePreview, revealKey: `data-bundle:preview:${id}`, rowOwned: true };
  }

  if (launcher.closest("#data-resources-body")) {
    const action = launcher.dataset.resourceAction;
    if (action === "edit") return { panel: elements.dataResourceForm, revealKey: `data-resource:edit:${id}`, rowOwned: true };
    if (action === "version") return { panel: elements.dataVersionForm, revealKey: `data-resource:version:${id}`, rowOwned: true };
  }
  if (launcher.closest("#collection-adapters-body")) {
    const action = launcher.dataset.collectionAdapterAction;
    if (action === "edit") return { panel: elements.collectionAdapterForm, revealKey: `collection-adapter:edit:${id}`, rowOwned: true };
    if (action === "session") return { panel: elements.collectionSessionForm, revealKey: `collection-session:new:${id}`, rowOwned: true };
  }
  if (launcher.closest("#adapters-body")) {
    const action = launcher.dataset.adapterAction;
    if (action === "view" || action === "edit") {
      return { panel: elements.adapterEditor, revealKey: `adapter:${action}:${id}`, rowOwned: true };
    }
  }
  return null;
}
...
function synchronizeDisclosureLaunchers(root = document) {
  ...
  setDisclosureLauncherActive(replacement, activeDisclosure.panel, activeDisclosure.token);
  revealedPanelLaunchers.set(activeDisclosure.panel, replacement);
  if (activeDisclosure.rowOwned) mountRowDisclosure(activeDisclosure.panel, replacement);
}
...
function installDisclosureBehavior() {
  ...
  const closeTargets = {
    ...
    "close-data-bundle-preview": elements.dataBundlePreview,
    "close-data-bundle-form": elements.dataBundleForm,
    "close-collection-adapter": elements.collectionAdapterForm,
    "close-adapter-editor": elements.adapterEditor,
  };
  const closeSelector = Object.keys(closeTargets).map((id) => `#${id}`).join(", ");
  document.addEventListener("click", (event) => {
    ...
    initializeDisclosureLauncher(launcher, intent);
    const result = toggleDisclosure(intent.panel, intent.revealKey, launcher, { rowOwned: intent.rowOwned === true });
    if (!result.opened) {
      event.preventDefault();
      event.stopImmediatePropagation();
    }
  ...
  const disclosureObserver = new MutationObserver((records) => {
    for (const record of records) {
      ...
      if (record.type === "childList") {
        ...
        if (activeRunAttemptDisclosure) queueMicrotask(remountActiveRunAttemptDisclosure);
      }
    }
  });
...
function startAdapterCreate(launcher = null) {
  ...
  revealPanel(elements.adapterEditor, { focusTarget: elements.adapterEditorSlug, launcher });
}
...
async function openAdapter(id, editable = false, launcher = null) {
  ...
  try {
    ...
    adapterEditorState = { mode: editable ? "edit" : "view", id: adapterId(adapter) || id, adapter, versions };
    const manifest = adapterManifest(adapter);
    const defaults = repositoryDefaults(manifest, adapter);
    elements.adapterEditorSlug.value = manifest.slug || adapter.seed_key || adapter.slug || adapterId(adapter) || id;
    elements.adapterEditorName.value = adapter.name || adapter.label || id;
    elements.adapterManifest.value = formatManifest(manifest);
    elements.adapterDescription.value = adapter.description || manifest.description || "";
    ...
    if (adapterEditorState.mode === "create") {
      result = await api("/api/adapters", {
        ...
        body: JSON.stringify({
          ...
          repository_url: elements.adapterValidationRepository.value.trim() || null,
          change_note: elements.adapterChangeNote.value.trim() || null,
        }),
      });
    } else {
      result = await api(`/api/adapters/${encodeURIComponent(adapterEditorState.id)}`, {
        method: "PUT",
        body: JSON.stringify({
          manifest,
          name: elements.adapterEditorName.value.trim(),
          description: elements.adapterDescription.value.trim(),
          repository_url: elements.adapterValidationRepository.value.trim() || null,
          expected_latest_version: Number(adapterVersion(adapterEditorState.adapter)),
          change_note: elements.adapterChangeNote.value.trim() || null,
        }),
      });
    }
    const saved = entityFrom(result, "adapter");
    const id = adapterId(saved) || adapterEditorState.id || elements.adapterEditorSlug.value.trim();
    showToast(adapterEditorState.mode === "create" ? "Adapter created." : "Immutable adapter version created.");
...
async function validateAdapterManifest() {
  ...
  elements.adapterValidationReport.textContent = "Validating manifest against repository...";
  try {
    const isSavedView = adapterEditorState.mode === "view" && adapterEditorState.id;
    ...
    const result = await api(
      ...
      {
        method: "POST",
        body: JSON.stringify(isSavedView
          ? {
    ...
    elements.adapterValidationReport.textContent = JSON.stringify(result, null, 2);
    const failed = result.valid === false
      || ["INVALID", "ERROR"].includes(String(result.status || "").toUpperCase())
      || (Array.isArray(result.errors) && result.errors.length > 0);
    elements.adapterValidationReport.classList.add(failed ? "is-error" : "is-success");
  } catch (error) {
...
async function cloneAdapter(id) {
  ...
  try {
    ...
    showToast("Adapter cloned as an independent version lineage.");
    await loadAdapters(true);
    await openAdapter(clonedId, true);
  } catch (error) {
    showToast(`Adapter clone failed: ${error.message}`, true);
  }
}
...
function selectedEvaluationSuite() {
  return evaluationSuites.find((suite) => evaluationSuiteId(suite) === elements.evaluationSuite.value) || null;
}
...
function populateEvaluationSuites(preferredSuiteId = "", { runId = "" } = {}) {
  ...
  const selectedSuite = evaluationSuites.find((suite) => evaluationSuiteId(suite) === selectedSuiteId);
  const selectionMessage = runId && selectedSuiteId && !desiredExists
    ? desiredSuiteId
...
async function loadEvaluationSuites(force = false, explicitRunId = undefined) {
  ...
  if (!requestPromise) {
    ...
    requestPromise.finally(() => {
      if (evaluationSuitesPromises.get(scope) === requestPromise) evaluationSuitesPromises.delete(scope);
    });
  }
...
function resetRuntimeInspection(message = "Select a commit to inspect its runtime.", state = "empty") {
  ...
  elements.experimentRuntimeProfileSelect.innerHTML = '<option value="">Choose a runtime backend first</option>';
  ...
  elements.runtimeProfileHelp.textContent = "A detected runtime fills this from repository evidence. Manual choices may require an explicit value.";
...
function normalizeRuntimeProfiles(payload) {
  const rows = Array.isArray(payload?.runtime_profiles) ? payload.runtime_profiles : [];
  return rows.map((row) => ({
    ...
    resolvedLocation: row.resolved_location || row.environment_path || row.container_image || row.lock_file || null,
...
function runtimeEvidenceItems(candidate) {
  ...
  return evidence.map((item) => typeof item === "string" ? item : compactJson(item, 180));
}

function normalizeRuntimeCandidates(payload) {
  const rawRows = listFrom(payload, ["runtime_candidates", "candidates", "runtimes"]);
  const merged = new Map();
  rawRows.forEach((raw, index) => {
    const row = typeof raw === "string" ? { type: raw } : raw || {};
    const value = String(row.type || row.runtime || row.id || row.name || "").trim();
    if (!value) return;
    const status = String(row.status || "").toLowerCase();
    const runnable = row.runnable !== false && !["blocked", "invalid", "unavailable", "unsupported"].includes(status);
    const confidence = String(row.confidence || row.strength || (row.strong ? "strong" : "unknown")).toLowerCase();
    const candidate = {
      value,
    ...
    if (!merged.has(value)) merged.set(value, candidate);
      ...
      if (candidate.confidence === "strong" || candidate.confidence === "high") current.confidence = candidate.confidence;
    }
  });
...
function adapterAllowedRuntimeBackends(adapter = selectedAdapter()) {
  ...
  const raw = sources.find((value) => Array.isArray(value) || value instanceof Set || typeof value === "string");
...
function manualRuntimeCandidate(backend, rejectedCandidate = null) {
  const evidence = ["Allowed by the selected adapter manifest; not automatically detected"];
  if (rejectedCandidate?.evidence?.length) {
    evidence.push(`Automatic evidence was not runnable: ${rejectedCandidate.evidence.join(" / ")}`);
  }
  return {
    value: backend,
...
function prepareRuntimeChoices(candidates) {
  ...
  runtimeProfiles.forEach((profile) => {
    ...
    const index = candidates.findIndex((candidate) => candidate.value === profile.backend);
    if (index < 0) candidates.push(manualRuntimeCandidate(profile.backend));
    else if (!candidates[index].runnable) {
      candidates.splice(index, 1, manualRuntimeCandidate(profile.backend, candidates[index]));
    }
  });
  const strong = candidates.filter((candidate) => candidate.runnable && isStrongRuntimeCandidate(candidate));
  if (strong.length) return candidates;

  allowed.forEach((backend) => {
    const index = candidates.findIndex((candidate) => candidate.value === backend);
    if (index < 0) candidates.push(manualRuntimeCandidate(backend));
    else if (!candidates[index].runnable) candidates.splice(index, 1, manualRuntimeCandidate(backend, candidates[index]));
  });
  return candidates;
}
...
function populateRuntimeProfileSelect(backend) {
  const matching = runtimeProfiles.filter((profile) => profile.backend === backend);
  elements.experimentRuntimeProfileSelect.innerHTML = [
    '<option value="">Custom or repository-detected configuration</option>',
    ...matching.map((profile) => `<option value="${escapeHtml(profile.id)}">${escapeHtml(profile.label)} / ${escapeHtml(profile.status.replaceAll("_", " "))}</option>`),
  ].join("");
  elements.experimentRuntimeProfileSelect.value = "";
...
function isStrongRuntimeCandidate(candidate) {
  return ["strong", "high", "exact", "locked"].includes(candidate.confidence)
...
function renderRuntimeEvidence() {
  ...
  elements.runtimeEvidence.innerHTML = runtimeCandidates.map((candidate) => {
    const evidence = candidate.evidence.length ? candidate.evidence.join(" / ") : candidate.reason || "No evidence detail returned";
    ...
    return `
      <div class="runtime-candidate ${selected ? "is-selected" : ""} ${candidate.runnable ? "" : "is-blocked"}">
        ...
        <span>${candidate.manual
          ? `manual / ${candidate.requiresProfile ? "configuration required" : "explicit selection"}`
          : `${escapeHtml(candidate.confidence)} / detected ${candidate.runnable ? "runnable" : "blocked"}`}</span>
...
function applyRuntimeSelection(explicit = true) {
  const candidate = runtimeCandidates.find((row) => row.value === elements.experimentRuntime.value);
  if (!candidate) return;
...
function applyRuntimeProfileSelection(explicit = true) {
  ...
  if (namedProfile) {
    ...
    elements.experimentRuntimeProfile.value = namedProfile.resolvedLocation || "Resolved by operator profile";
    ...
    elements.experimentRuntimeProfile.disabled = false;
    elements.experimentRuntimeProfile.required = Boolean(candidate.requiresProfile);
    elements.experimentRuntimeProfile.value = "";
    if (candidate.value === "conda") {
      elements.experimentRuntimeProfile.placeholder = "/path/to/conda/environment";
      elements.runtimeProfileHelp.textContent = "Required: provide an existing Conda environment path/profile.";
    } else if (candidate.value === "apptainer") {
      elements.experimentRuntimeProfile.placeholder = "/path/to/image.sif or immutable image reference";
      elements.runtimeProfileHelp.textContent = "Required: provide an Apptainer image path or immutable reference.";
    } else if (candidate.value === "existing") {
      elements.experimentRuntimeProfile.placeholder = "Optional environment detail";
      elements.runtimeProfileHelp.textContent = "No path is required. This explicit choice uses the compute node's existing environment.";
    } else {
      elements.experimentRuntimeProfile.placeholder = "Path to the pinned runtime input";
      elements.runtimeProfileHelp.textContent = "Required: provide the pinned runtime input for this manual choice.";
    }
  } else {
    elements.experimentRuntimeProfile.disabled = false;
    elements.experimentRuntimeProfile.required = false;
    elements.experimentRuntimeProfile.placeholder = "Resolved from repository evidence";
    elements.runtimeProfileHelp.textContent = "Resolved from dependency files at the selected exact commit.";
    if (candidate.profile) elements.experimentRuntimeProfile.value = candidate.profile;
  }
...
function repositoryInspectionKey(repository, revision, projectSubdirectory, adapter) {
  return [
    repository,
...
async function inspectRepositoryRuntime(forceRefresh = false) {
  ...
  if (!forceRefresh && runtimeInspectionKey === key && repositoryInputOptionsState?.scopeKey === adapterInputOptionsScopeKey(adapter, repository, revision, projectSubdirectory)) {
  ...
  try {
    ...
    const { payload, fromCache } = await sourceMetadataRequest(`/api/source/inspect?${query.toString()}`, { forceRefresh });
    ...
    if (!resolvedRevision) {
      throw new Error("Repository inspection did not return a resolved commit.");
    }
    ...
    repositoryInputOptionsState = {
      ...
      adapterVersionId: adapterScope?.versionId || "",
      manifestHash: adapterScope?.manifestHash || "",
      scopeKey: adapterInputOptionsScopeKey(adapter, repository, resolvedCommit, projectSubdirectory),
    ...
    runtimeCandidates = prepareRuntimeChoices(normalizeRuntimeCandidates(payload));
    const runnable = runtimeCandidates.filter((candidate) => candidate.runnable);
    elements.experimentRuntime.innerHTML = [
      '<option value="">Choose a runtime...</option>',
      ...runtimeCandidates.map((candidate) => `<option value="${escapeHtml(candidate.value)}" ${candidate.runnable ? "" : "disabled"}>${escapeHtml(candidate.label)}${candidate.manual ? "" : ` / detected ${escapeHtml(candidate.confidence)}`}${candidate.runnable ? "" : " / unavailable"}</option>`),
    ].join("");
    ...
    if (strong.length === 1) {
      ...
      setRuntimeStatus("No runnable runtime candidate was returned. Add detection rules to the adapter or repository manifest.", "error");
    } else {
      if (!strong.length) {
        const manualNames = runnable.filter((candidate) => candidate.manual).map((candidate) => candidate.label).join(", ");
        setRuntimeStatus(
        ...
        setRuntimeStatus(`${strong.length} strong detected candidates found. Choose one explicitly; there is no silent fallback.`, "warning");
      }
      renderRuntimeEvidence();
    }
    if (fromCache) {
      elements.runtimeInspectionStatus.textContent += " Database inspection reused; Refresh refs to query the repository again.";
    }
  } catch (error) {
    if (request !== runtimeInspectionRequest) return;
    resetRuntimeInspection(`Runtime inspection failed: ${error.message}`, "error");
  }
}
...
function updateSourceCommitMeta() {
  ...
  const details = [commit.sha, commit.author, commit.timestamp ? formatDate(commit.timestamp) : null].filter(Boolean);
...
async function loadSourceCommits(preferredSha = "", owningBranchRequest = sourceBranchRequest, forceRefresh = false) {
  const repository = elements.experimentSource.value.trim();
  ...
  if (!forceRefresh && sourceCommitsKey === cacheKey && sourceCommits.length) {
    ...
    if (!selectedSha || !sourceCommits.some((commit) => commit.sha === selectedSha)) {
      elements.experimentRevision.value = "";
      updateSourceCommitMeta();
      resetRuntimeInspection("Choose an exact commit; no commit was selected automatically.", "empty");
      setSourceRefStatus(`${sourceCommits.length} commits are cached for ${branch}. Choose an exact commit.`, "warning");
      return;
    }
    ...
    setSourceRefStatus(`${sourceBranches.length} branch${sourceBranches.length === 1 ? "" : "es"} / ${sourceCommits.length} recent commits restored from cache.`);
    return;
  }
  ...
  resetSourceSelect(
    ...
    branch ? (forceRefresh ? "Refreshing commits..." : "Restoring saved commits...") : "Choose a branch first",
  );
  updateSourceCommitMeta();
  if (!repository || !branch) return;

  setSourceRefStatus(
    forceRefresh ? `Refreshing commits from ${branch}...` : `Restoring cached commits for ${branch}...`,
    "loading",
  );
  try {
    const path = `/api/source/commits?repo_url=${encodeURIComponent(repository)}&branch=${encodeURIComponent(branch)}&limit=50`;
    const { payload, fromCache } = await sourceMetadataRequest(path, { forceRefresh });
    if (request !== sourceCommitRequest || owningBranchRequest !== sourceBranchRequest) return;
    ...
    elements.experimentRevision.innerHTML = ['<option value="">Choose a commit...</option>', ...sourceCommits.map((commit) => {
    ...
    if (preferredSha) {
      if (!sourceCommits.some((commit) => commit.sha === preferredSha)) {
        elements.experimentRevision.value = "";
        updateSourceCommitMeta();
        resetRuntimeInspection(`Requested commit ${preferredSha.slice(0, 12)} is unavailable on ${branch}. Choose an available commit.`, "error");
        setSourceRefStatus(`Requested commit ${preferredSha} is unavailable on ${branch}. No replacement was selected.`, "error");
        return;
      }
      ...
      updateSourceCommitMeta();
      resetRuntimeInspection("Choose an exact commit; no commit was selected automatically.", "empty");
      setSourceRefStatus(`${sourceCommits.length} commits loaded from ${branch}. Choose an exact commit.`, "warning");
      return;
    }
    updateSourceCommitMeta();
    saveSourceSelection(repository, branch, preferredSha);
    await inspectRepositoryRuntime(forceRefresh);
    setSourceRefStatus(`${sourceBranches.length} branch${sourceBranches.length === 1 ? "" : "es"} / ${sourceCommits.length} recent commits loaded from ${branch}.${fromCache ? " Database commit metadata reused; Refresh refs to query again." : ""}`);
  } catch (error) {
    if (request !== sourceCommitRequest || owningBranchRequest !== sourceBranchRequest) return;
    resetSourceSelect(elements.experimentRevision, "Commits unavailable");
    updateSourceCommitMeta();
    setSourceRefStatus(`Could not load commits for ${branch}: ${error.message}`, "error");
  }
}

async function loadSourceBranches(preserveSelection = false, forceRefresh = false) {
  window.clearTimeout(sourceUrlTimer);
  const repository = elements.experimentSource.value.trim();
  if (!forceRefresh && sourceBranchesKey === repository && sourceBranches.length) {
    const savedSelection = savedSourceSelection(repository);
    const selectedBranch = elements.experimentBranch.value || savedSelection.branch;
    if (!selectedBranch || !sourceBranches.some((branch) => branch.name === selectedBranch)) {
      elements.experimentBranch.value = "";
      setSourceRefStatus("Cached branches are available. Choose a branch explicitly.", "warning");
      return;
    }
    elements.experimentBranch.value = selectedBranch;
    const branchTip = sourceBranches.find((branch) => branch.name === selectedBranch)?.sha || "";
    const selectedCommit = elements.experimentRevision.value
      || savedSelection.commits?.[selectedBranch]
      || branchTip;
    await loadSourceCommits(selectedCommit, sourceBranchRequest);
    return;
  }
  const previousBranch = preserveSelection ? elements.experimentBranch.value : "";
  const previousSha = preserveSelection ? elements.experimentRevision.value : "";
  const request = ++sourceBranchRequest;
  ++sourceCommitRequest;
  sourceBranches = [];
  sourceCommits = [];
  resetRuntimeInspection(repository ? "Choose a branch and commit." : "Enter a repository URL.");
  resetSourceSelect(
    elements.experimentBranch,
    repository ? (forceRefresh ? "Refreshing branches..." : "Restoring saved branches...") : "Enter a repository URL",
  );
  resetSourceSelect(elements.experimentRevision, "Choose a branch first");
  updateSourceCommitMeta();

  if (!repository) {
    setSourceRefStatus("Enter a repository URL to load branches and commits.", "empty");
    return;
  }

  elements.sourceRefRefresh.disabled = true;
  setSourceRefStatus(
    forceRefresh ? "Refreshing repository metadata through the selected SSH gateway..." : "Restoring repository metadata from the database cache...",
    "loading",
  );
  try {
    ...
    if (!sourceBranches.length) {
      ...
      setSourceRefStatus("No branches were returned for this repository.", "empty");
      return;
    }

    elements.experimentBranch.innerHTML = ['<option value="">Choose a branch...</option>', ...sourceBranches.map((branch) => {
    ...
    rememberSourceSelection(repository, payload.selection || { branch: "", commits: {} });
    const savedSelection = savedSourceSelection(repository);
    const selectedBranch = previousBranch || savedSelection.branch || defaultBranch;
    if (!selectedBranch) {
      elements.experimentBranch.value = "";
      setSourceRefStatus("Branches loaded, but the repository declared no default branch. Choose one explicitly.", "warning");
      return;
    }
    if (!sourceBranches.some((branch) => branch.name === selectedBranch)) {
      elements.experimentBranch.value = "";
      setSourceRefStatus(`Requested branch "${selectedBranch}" is unavailable. No replacement was selected.`, "error");
      return;
    }
    elements.experimentBranch.value = selectedBranch;
    const branchTip = sourceBranches.find((branch) => branch.name === selectedBranch)?.sha || "";
    const selectedCommit = previousSha || savedSelection.commits?.[selectedBranch] || branchTip;
    ...
    resetSourceSelect(elements.experimentRevision, "Choose a branch first");
    updateSourceCommitMeta();
    setSourceRefStatus(`Could not load repository branches: ${error.message}`, "error");
  } finally {
    if (request === sourceBranchRequest) elements.sourceRefRefresh.disabled = false;
  }
}
...
function scheduleSourceBranchLoad() {
  ...
  setSourceRefStatus("Repository changed. Database metadata will be reused when the value is committed; Refresh refs forces a repository query.", "warning");
}

function experimentPayload() {
  const declaredOverrides = collectAdapterDeclaredOverrides();
  const overrides = [...declaredOverrides.declaredLines, ...declaredOverrides.advancedLines];
  const adapter = selectedAdapter();
  const runtimeCandidate = runtimeCandidates.find((candidate) => candidate.value === elements.experimentRuntime.value);
  ...
  if (!namedRuntimeProfile && runtimeProfile && runtime.type === "uv") runtime.lock_file = runtimeProfile;
  if (!namedRuntimeProfile && runtimeProfile && ["conda", "existing"].includes(runtime.type)) runtime.environment_path = runtimeProfile;
  if (!namedRuntimeProfile && runtimeProfile && runtime.type === "apptainer") runtime.container_image = runtimeProfile;
  ...
  const preservedProviders = Array.isArray(preservedTracking.providers) ? preservedTracking.providers : [];
  const preservedWandb = preservedProviders.find((provider) => String(provider?.provider || provider?.type || "").toLowerCase() === "wandb") || {};
  const preservedMlflow = preservedProviders.find((provider) => String(provider?.provider || provider?.type || "").toLowerCase() === "mlflow") || {};
  ...
  if (elements.mlflowEnabled.checked) {
    trackingProviders.push({
      provider: "mlflow",
      enabled: true,
      tracking_uri: elements.mlflowUri.value.trim() || preservedMlflow.tracking_uri || mlflowConnection.tracking_uri || mlflowConnection.base_url || null,
  ...
  const preserveLoadedEvaluation = Boolean(
    ...
    && JSON.stringify([...selectedEvaluationSuiteIds].sort()) === JSON.stringify([...loadedEvaluation.suiteIds].sort())
  );
  const preservedCheckpoint = loadedExperimentCanonicalContext?.checkpoint || {};
  ...
  return {
    ...
    data_bundle_id: elements.experimentDataBundle.value || null,
    runtime,
    hyperparameters,
    ...
    checkpoint: {
      ...
      path: elements.checkpointMode.value === "none" ? null : elements.checkpointPath.value.trim(),
    },
    checkpoint_save_steps: elements.checkpointSaveSteps.disabled
      ? null
      : numberOrNull(elements.checkpointSaveSteps),
    checkpoint_warning_seconds: numberOrNull(document.querySelector("#checkpoint-warning-seconds")),
    checkpoint_keep_last: preservedCheckpoint.keep_last ?? null,
    checkpoint_final_selector: preservedCheckpoint.final_selector ?? null,
    remove_training_state_after_success: preservedCheckpoint.remove_training_state_after_success ?? null,
    ...
    tracking: {
      ...
      provider: trackingProviders.length === 1 ? trackingProviders[0].provider : null,
      enabled: trackingProviders.length > 0,
      uri: elements.mlflowEnabled.checked ? mlflowConnection.tracking_uri || mlflowConnection.base_url || null : null,
      experiment: elements.mlflowEnabled.checked ? elements.mlflowExperiment.value.trim() || experimentName : null,
      run_name_template: trackingProviders.length === 1 ? trackingProviders[0].run_name_template : null,
    },
    evaluation: {
      enabled: elements.evaluationEnabled.checked,
      suite_ids: preserveLoadedEvaluation ? [] : selectedEvaluationSuiteIds,
      ...(preserveLoadedEvaluation ? { canonical_specs: loadedEvaluation.specs } : {}),
    },
  };
}
...
function validateExperiment({ notify = true, batchValidation = null } = {}) {
  ...
  elements.hpLearningRate.setCustomValidity(!elements.hpLearningRate.disabled && elements.hpLearningRate.value !== "" && Number(elements.hpLearningRate.value) <= 0 ? "Learning rate must be greater than zero." : "");
  ...
  if (!elements.experimentForm.checkValidity()) {
    const invalid = [...elements.experimentForm.elements]
      .find((control) => control.willValidate && !control.validity.valid);
    const label = invalid?.labels?.[0]?.textContent?.trim()
      || invalid?.name
      || invalid?.id
      || "Experiment field";
    return reject(`${label}: ${invalid?.validationMessage || "Enter a valid value."}`);
  }
  const selectedRevision = elements.experimentRevision.value.trim();
  if (!selectedRevision || !sourceCommits.some((commit) => commit.sha === selectedRevision)) {
  ...
  const runtime = runtimeCandidates.find((candidate) => candidate.value === elements.experimentRuntime.value);
  if (runtimeInspectionKey !== inspectionKey || !runtime || !runtime.runnable) {
    return reject("Inspect the selected commit and explicitly choose a runnable runtime.");
  }
  if (!selectedRuntimeProfile() && runtime.manual && runtime.requiresProfile && !elements.experimentRuntimeProfile.value.trim()) {
    const requirement = runtime.value === "conda"
  ...
  for (const provider of selectedTrackingProviders()) {
    ...
    if (!connection || connection.connected !== true) {
      return reject(["error", "unknown", "unavailable"].includes(connection?.status)
    ...
    if (provider === "wandb" && !connection.entity) {
      return reject("The W&B connection did not return a verified entity. Reconnect it in Settings.");
    }
  }
  if (elements.evaluationEnabled.checked && !selectedValues(elements.experimentEvaluationSuites).length) {
...
function updateExperimentSubmitState() {
  ...
  if (existingExperiment) {
    const revisionLabel = nextRevision === null ? "a new revision" : `revision ${nextRevision}`;
    ...
    const origin = loadedExperimentOrigin?.id === String(existingExperiment.id || existingExperiment.experiment_id) ? `Loaded revision ${loadedExperimentOrigin.revision}. ` : "";
    ...
    elements.experimentRevisionIntent.textContent = "Submitted specifications are immutable. Changes create a new experiment revision.";
  }
  elements.experimentPreviewButton.disabled = experimentBusy || !batchValidation.valid;
  elements.saveExperimentButton.disabled = experimentBusy || !batchValidation.valid;
...
async function previewExperiment() {
  ...
  try {
    ...
    blockers.forEach((blocker) => {
      const item = document.createElement("li");
      const reasons = Array.isArray(blocker?.reasons) ? blocker.reasons.join("; ") : "No reason returned.";
    ...
    elements.experimentPreviewBlockers.hidden = blockers.length === 0 && shapeErrors.length === 0;
    elements.experimentPreviewEmpty.hidden = true;
    elements.experimentPreviewPanel.hidden = false;
  } catch (error) {
    if (signature === JSON.stringify(experimentPayload())) showToast(`Preview failed: ${error.message}`, true, { scope });
  } finally {
...
function createdExperimentId(payload) {
  ...
  return experiment.id || experiment.experiment_id || payload.id || payload.experiment_id;
}
...
function submittedTrainingRunRecords(...payloads) {
  ...
  payloads.filter(Boolean).forEach((payload) => {
    [payload.run, payload.submission?.run, payload.experiment?.run, payload.revision?.run].forEach(append);
    [payload.runs, payload.run_ids, payload.submission?.runs, payload.experiment?.runs, payload.revision?.runs]
      .filter(Array.isArray)
      .forEach((items) => items.forEach(append));
    const variants = [payload.variants, payload.experiment?.variants, payload.revision?.variants]
      .find(Array.isArray) || [];
    variants.forEach((variant) => {
      append(variant?.run);
      if (Array.isArray(variant?.runs)) variant.runs.forEach(append);
      if (variant?.run_id) append({ id: variant.run_id, experiment_revision_number: variant.experiment_revision_number });
    });
  });
  ...
  records.forEach((record) => {
    ...
    unique.set(id, existing ? { ...existing, ...record, id } : { ...record, id });
  });
...
function explicitlySubmittedTrainingRunRecords(...payloads) {
  ...
  payloads.filter(Boolean).forEach((payload) => {
    ...
    if (payload.primary_run_id) exactPayloads.push({ run: { id: payload.primary_run_id, primary: true } });
    if (payload.submission?.run_id) exactPayloads.push({ run: { id: payload.submission.run_id } });
    if (payload.submission?.primary_run_id) {
      exactPayloads.push({ run: { id: payload.submission.primary_run_id, primary: true } });
    }
  });
...
async function openSubmittedTrainingRun({ experimentId, revisionNumber = null, responses = [] }) {
  ...
  if (!records.length && experimentId) {
    ...
    try {
      const detail = await api(`/api/experiments/${encodeURIComponent(experimentId)}`);
      records = submittedTrainingRunRecords(detail).filter((record) => (
        Number(record.experiment_revision_number ?? record.revision_number) === normalizedRevision
        && String(record.experiment_id || record.experiment?.id || experimentId) === String(experimentId)
      ));
  ...
  const selectedRecords = primaryRecords.length === 1 ? primaryRecords : records;
  if (selectedRecords.length !== 1) {
    showNotice(elements.runsError, `Training submission created ${records.length} Training Runs, but ${resolution} did not identify one primary run. Choose the intended run explicitly.`);
    return;
  }
  ...
  const launcher = [...elements.runsBody.querySelectorAll("[data-run-action='view']")]
    .find((candidate) => String(candidate.dataset.id) === runId);
  if (!created || !launcher) {
    showNotice(elements.runsError, `Training Run ${runId} was created but is not present in the Training Run list response.`);
    return;
  }
...
function normalizeExperimentRepository(value) {
  return normalizeExperimentIdentityPart(value).replace(/\/+$/, "").replace(/\.git$/, "");
}
...
function experimentProjectIdentity(experiment) {
  ...
  const repository = source.repository
    ...
    || "";
  const projectSubdirectory = source.project_subdirectory
...
function matchingExperimentForPayload(payload) {
  ...
  const matches = experimentRows.filter((experiment) => (
    normalizeExperimentIdentityPart(experiment.name) === name
    && experimentProjectIdentity(experiment) === project
  ));
  return matches.sort(
    (left, right) => Number(right.latest_revision_number || 0) - Number(left.latest_revision_number || 0),
  )[0] || null;
}
...
function experimentLifecycle(experiment) {
  ...
  ].map(explicitBoolean).filter((value) => value !== null);
  const submittedDeclaration = explicitBoolean(experiment?.submitted);
  const explicitlyUnsubmitted = lockDeclarations.includes(false)
    || submittedDeclaration === false
    || lifecycleStates.some((state) => ["draft", "unsubmitted", "not submitted"].includes(state));
  const explicitlyLocked = lockDeclarations.includes(true)
    || submittedDeclaration === true
    || lifecycleStates.some((state) => ["submitted", "locked", "submitted locked"].includes(state));
  ...
  const locked = !explicitlyUnsubmitted && (explicitlyLocked || Boolean(submittedAt));
  return {
    locked,
...
function runAttemptRecords(run) {
  const attempts = Array.isArray(run?.attempts)
    ? run.attempts.filter((attempt) => attempt && typeof attempt === "object" && !Array.isArray(attempt))
    : [];
...
function runHasExplicitPreflightFailure(run, attempts) {
  if (["PREFLIGHT_FAILED", "SUBMISSION_FAILED"].includes(normalizedRunState(run?.status || run?.state))) {
    return true;
  }
  if (explicitBoolean(run?.preflight_failed) === true || explicitBoolean(run?.submission_failed) === true) {
    return true;
  }
  ...
  if (declaredFailure !== null && declaredFailure !== undefined && declaredFailure !== "") return true;
  return attempts.some((attempt) => (
    ["PREFLIGHT_FAILED", "SUBMISSION_FAILED"].includes(normalizedRunState(attempt.status || attempt.state))
    && !attempt.slurm_job_id
    && !attempt.slurm_array_job_id
    && !attempt.job_id
  ));
...
function variantRunDisplayState(run) {
  ...
  const hasAttemptEvidence = !explicitlyZeroAttempts && (
    (attemptCount !== null && attemptCount > 0)
    || attempts.length > 0
    || Boolean(run?.slurm_job_id || run?.slurm_array_job_id || run?.job_id)
  );
  const hasSubmittedAttempt = !explicitlyZeroAttempts && (
    attempts.some(attemptHasSlurmSubmission)
    || Boolean(run?.slurm_job_id || run?.slurm_array_job_id || run?.job_id || run?.submitted_at)
    || (attemptCount !== null && attemptCount > 0 && ["PENDING", "SUBMITTED"].includes(state))
  );
...
async function createExperiment(shouldSubmit) {
  ...
  try {
    const result = existingId
      ? await api(`/api/experiments/${encodeURIComponent(existingId)}/revisions`, {
          method: "POST",
          body: JSON.stringify({
            spec: payload,
            submit: shouldSubmit,
    ...
    if (existingId) {
      const returnedRevision = result.revision_number
...
async function submitDraftExperiment(id, launcher = null) {
  const experiment = experimentRows.find((candidate) => String(candidate.id || candidate.experiment_id) === String(id));
...
function loadedCanonicalPathIsExplicit(spec, path) {
  const explicitParameters = Array.isArray(spec?.intent?.explicit_parameters)
    ...
    : [];
  return explicitParameters.some((requestedPath) => (
    requestedPath === path
...
function setLoadedSelectValue(control, value, label, aliases = {}) {
  ...
  const option = [...control.options].find((candidate) => candidate.value === desired);
  if (!option || option.disabled) {
    throw new Error(`${label} value “${raw}” is not available in the current form.`);
  }
  control.value = desired;
}

function requestedExperimentRevision(experiment, requestedNumber) {
  const revisions = Array.isArray(experiment.revisions) ? experiment.revisions : [];
  const wanted = requestedNumber === null || requestedNumber === undefined || requestedNumber === ""
    ? null
    : Number(requestedNumber);
  let revision = null;
  if (wanted !== null) {
    revision = revisions.find((candidate) => Number(candidate.revision_number ?? candidate.number) === wanted) || null;
    if (!revision && Number(experiment.latest_revision?.revision_number ?? experiment.latest_revision_number) === wanted) {
      revision = experiment.latest_revision;
    }
    if (!revision) throw new Error(`Experiment revision ${wanted} was not returned by the API.`);
  } else {
    revision = experiment.latest_revision || revisions[0] || experiment;
  }
  const rawSpec = revision?.requested_spec_json ?? revision?.requested_spec ?? experiment.requested_spec_json;
  return {
    revision,
    spec: loadedCanonicalObject(rawSpec, "The experiment requested specification"),
    revisionNumber: revision?.revision_number ?? experiment.latest_revision_number ?? wanted,
  };
}
...
function pinnedAdapterFromExperiment(source) {
  ...
  if (typeof manifest === "string") {
    try {
      ...
      throw new Error(`The pinned adapter manifest is invalid JSON: ${error.message}`);
    }
  }
  if (!manifest || typeof manifest !== "object" || Array.isArray(manifest)) {
    throw new Error("This experiment revision has no pinned adapter manifest; loading it would silently use a different adapter version.");
  }
  const liveAdapter = adapterRows.find((adapter) => (
    adapterId(adapter) === String(source.adapter_id || "")
    || String(adapter?.slug || adapter?.seed_key || "") === String(source.adapter || "")
  ));
  const stableId = String(source.adapter_id || adapterId(liveAdapter) || source.adapter || manifest.slug || "").trim();
  const versionNumber = source.adapter_version;
  const versionId = String(source.adapter_version_id || "").trim();
  if (!stableId || versionNumber === null || versionNumber === undefined || versionNumber === "" || !versionId) {
    throw new Error("The experiment revision does not identify an exact adapter ID and version.");
  }
  return {
    id: stableId,
    slug: source.adapter || manifest.slug || liveAdapter?.slug || stableId,
    name: manifest.display_name || liveAdapter?.name || source.adapter || stableId,
    label: manifest.display_name || liveAdapter?.label || source.adapter || stableId,
    status: "active",
    manifest_valid: true,
...
function installPinnedSourceRevision(source, origin = "experiment") {
  ...
  elements.experimentBranch.innerHTML = '<option value="__pinned_experiment_commit__">Pinned commit (branch not recorded)</option>';
...
function loadedSweepDefinition(sweep) {
  ...
  if (strategy !== "grid") throw new Error(`Sweep strategy “${strategy}” cannot be represented by this configuration form.`);
  if (Array.isArray(sweep.variants) && sweep.variants.length) {
    throw new Error("An explicit sweep variant list cannot be represented by this configuration form.");
  }
  if (sweep.max_parallel !== null && sweep.max_parallel !== undefined && Number(sweep.max_parallel) !== 2) {
    throw new Error(`Sweep max_parallel=${sweep.max_parallel} cannot be represented by this configuration form.`);
  }
  if (
    sweep.confirmation_threshold !== null
    && sweep.confirmation_threshold !== undefined
    && Number(sweep.confirmation_threshold) !== 20
  ) throw new Error(`Sweep confirmation_threshold=${sweep.confirmation_threshold} cannot be represented by this configuration form.`);
  const axes = sweep.axes && typeof sweep.axes === "object" && !Array.isArray(sweep.axes) ? sweep.axes : {};
  Object.entries(axes).forEach(([name, values]) => {
    if (!Array.isArray(values)) throw new Error(`Sweep axis “${name}” is not an array.`);
  });
  const definition = { ...axes };
  const seeds = Array.isArray(sweep.seeds) ? sweep.seeds : [];
  if (seeds.length && !(seeds.length === 1 && Number(seeds[0]) === 42)) definition.seeds = seeds;
  return Object.keys(definition).length ? JSON.stringify(definition, null, 2) : "";
}

function loadedNativeFieldValue(nativeSpec, path) {
  if (path === "native.argv") return { present: Array.isArray(nativeSpec.argv), value: nativeSpec.argv };
  if (path === "native.resume_argv") return { present: Array.isArray(nativeSpec.resume_argv), value: nativeSpec.resume_argv };
  if (path.startsWith("native.config.")) {
    return loadedCanonicalPath(nativeSpec.config || {}, path.slice("native.config.".length));
  }
  if (path.startsWith("native.overrides.")) {
    const suffix = path.slice("native.overrides.".length);
    const overrides = nativeSpec.overrides || {};
    if (Object.prototype.hasOwnProperty.call(overrides, suffix)) return { present: true, value: overrides[suffix] };
...
function flattenLoadedNativeConfig(prefix, value, output) {
  if (value && typeof value === "object" && !Array.isArray(value)) {
    ...
    if (entries.length) {
      entries.forEach(([key, nested]) => flattenLoadedNativeConfig(`${prefix}.${key}`, nested, output));
      return;
    }
  }
...
function hydrateLoadedNativeSpec(nativeSpec = {}) {
  ...
  const claimedKeys = new Set(["config.initial_checkpoint", "config.initial_checkpoint_mode"]);
  for (const field of fields) {
    ...
    if (field.sensitive) throw new Error(`${field.label} is sensitive and cannot be restored into the browser.`);
    const control = document.getElementById(adapterFieldControlId(field.path));
    if (!control) throw new Error(`${field.label} could not be rendered for the pinned adapter.`);
    setAdapterFieldControlValue(control, field, loaded.value);
    if (control.tagName === "SELECT" && control.value === "" && loaded.value !== "") {
      throw new Error(`${field.label} value ${JSON.stringify(loaded.value)} is unavailable at the pinned commit.`);
    }
  ...
  const collidesWithClaimed = (key) => [...claimedKeys].some((claimed) => (
    claimed === key || claimed.startsWith(`${key}.`) || key.startsWith(`${claimed}.`)
  ));
  flattenedConfig.forEach(([key, value]) => {
    if (!collidesWithClaimed(key)) advanced.push(`${key}=${JSON.stringify(value)}`);
  });
  Object.entries(nativeSpec.overrides || {}).forEach(([key, value]) => {
    if (!collidesWithClaimed(key)) advanced.push(`${key}=${JSON.stringify(value)}`);
  });
  if (Array.isArray(nativeSpec.argv) && !claimedKeys.has("argv")) advanced.push(`argv=${JSON.stringify(nativeSpec.argv)}`);
  if (Array.isArray(nativeSpec.resume_argv) && !claimedKeys.has("resume_argv")) advanced.push(`resume_argv=${JSON.stringify(nativeSpec.resume_argv)}`);
  elements.nativeOverrides.value = advanced.join("\n");
  const validation = validateAdapterDeclaredFields({ focus: false, notify: false });
  if (validation === false) throw new Error("The pinned adapter-native values are not valid in the current form.");
  renderCommonHyperparameterDefaults();
}

function loadedEvaluationSuiteIds(specs) {
  if (!specs.length) return [];
  const optionIds = new Set([...elements.experimentEvaluationSuites.options].map((option) => option.value));
  return specs.map((evaluation) => {
    const requestedNames = [evaluation.suite, evaluation.suite_id, evaluation.name]
      .flatMap((value) => value && typeof value === "object" ? [value.id, value.slug, value.name] : [value])
      .filter(Boolean)
      .map(String);
    const requestedVersion = firstValue(evaluation.suite_version, evaluation.version);
    const matches = evaluationSuites.filter((suite) => {
      const names = [suite.id, suite.slug, suite.name, suite.label, suite.suite].filter(Boolean).map(String);
      if (!requestedNames.some((name) => names.includes(name))) return false;
      if (requestedVersion === null || requestedVersion === undefined || requestedVersion === "") return true;
      const version = firstValue(suite.suite_version, suite.version);
      return version !== null && version !== undefined && String(version) === String(requestedVersion);
    });
    if (matches.length !== 1) {
    ...
    if (!optionIds.has(id)) throw new Error(`Evaluation suite “${id}” is not available in the configuration selector.`);
    return id;
  });
}
...
async function hydrateExperimentConfiguration(spec, request) {
  ...
  const train = loadedCanonicalObject(spec.train, "Experiment training configuration");
  const resources = loadedCanonicalObject(spec.resources, "Experiment resources");
  const nativeSpec = spec.native && typeof spec.native === "object" ? spec.native : {};
  const checkpoint = train.checkpoint && typeof train.checkpoint === "object" ? train.checkpoint : {};
  ...
  const pinnedAdapterOptionId = adapterOptionId(loadedExperimentAdapterSnapshot);
  ...
  const bundleId = firstValue(spec.data?.bundle?.id, spec.data?.bundle?.bundle_id);
  populateExperimentDataBundles();
  if (bundleId) {
    const bundleOption = [...elements.experimentDataBundle.options].find((option) => option.value === String(bundleId));
    if (!bundleOption || bundleOption.disabled) {
      throw new Error(`Dataset bundle “${bundleId}” is missing or incompatible with the pinned adapter.`);
    }
    elements.experimentDataBundle.value = String(bundleId);
  } else {
  ...
  setLoadedSelectValue(elements.hpBatchSemantics, batch.declared_semantics, "Batch semantics");
  ...
  const precision = train.precision === null || train.precision === undefined ? "adapter-default" : String(train.precision).toLowerCase();
  setLoadedSelectValue(elements.hpPrecision, precision, "Precision", { bfloat16: "bf16", float32: "fp32", float16: "fp16" });
  ...
  setLoadedSelectValue(elements.experimentGpuType, gpuType === "any" ? "auto" : gpuType, "GPU type");
  ...
  setLoadedControlValue(document.querySelector("#checkpoint-warning-seconds"), checkpoint.save_before_timeout_seconds ?? 300);
  setLoadedControlValue(elements.checkpointMaxAttempts, checkpoint.max_attempts);
  ...
  const initialMode = nativeSpec.config?.initial_checkpoint_mode || (initialCheckpoint ? "weights" : "none");
  setLoadedSelectValue(elements.checkpointMode, initialMode, "Initial checkpoint", { fresh: "none" });
  ...
  const unsupportedProviders = enabledProviders.filter((provider) => !["wandb", "mlflow"].includes(String(provider?.provider || provider?.type || "").toLowerCase()));
  if (unsupportedProviders.length) {
    throw new Error(`Tracking provider “${unsupportedProviders[0].provider || unsupportedProviders[0].type}” cannot be represented by this form.`);
  }
  const wandbProviders = enabledProviders.filter((provider) => String(provider?.provider || provider?.type || "").toLowerCase() === "wandb");
  const mlflowProviders = enabledProviders.filter((provider) => String(provider?.provider || provider?.type || "").toLowerCase() === "mlflow");
  if (wandbProviders.length > 1 || mlflowProviders.length > 1) throw new Error("Duplicate tracking providers cannot be represented by this form.");
  ...
  setLoadedControlValue(elements.sweepDefinition, loadedSweepDefinition(spec.sweep));
  ...
  const backend = String(runtime.backend || runtime.type || "").toLowerCase().replace("container", "apptainer");
  const runtimeCandidate = runtimeCandidates.find((candidate) => candidate.value === backend && candidate.runnable);
  if (!runtimeCandidate) throw new Error(`Pinned runtime backend “${backend || "missing"}” is not runnable for this adapter and commit.`);
  elements.experimentRuntime.value = backend;
  applyRuntimeSelection(true);
  const profileId = firstValue(runtime.profile_id, runtime.profile_snapshot?.id);
  if (profileId) {
    const profile = runtimeProfiles.find((candidate) => candidate.id === String(profileId) && candidate.backend === backend);
    if (!profile) throw new Error(`Pinned runtime profile “${profileId}” is not available from the cached repository inspection.`);
    elements.experimentRuntimeProfileSelect.value = profile.id;
    applyRuntimeProfileSelection(true);
  } else {
    const customProfile = firstValue(runtime.lock_file, runtime.environment_path, runtime.container_image, runtime.profile);
    if (customProfile !== null && customProfile !== undefined) elements.experimentRuntimeProfile.value = String(customProfile);
    if (runtimeCandidate.manual && runtimeCandidate.requiresProfile && !elements.experimentRuntimeProfile.value.trim()) {
      throw new Error(`Pinned runtime backend “${backend}” requires a runtime profile or path.`);
    }
  }
...
async function loadExperimentConfiguration(id, revisionNumber, launcher = null) {
  ...
  try {
    ...
    loadedExperimentOrigin = { id: String(id), revision: loaded.revisionNumber || "latest" };
    updateExperimentSubmitState();
    ...
    showToast(`Loaded ${loaded.spec.name || experiment.name || id}, revision ${loaded.revisionNumber || "latest"}.`, false, { scope });
  } catch (error) {
    if (request !== experimentConfigurationLoadRequest) return;
    loadedExperimentCanonicalContext = null;
    showNotice(elements.experimentsError, `Experiment configuration could not be loaded: ${error.message}`, { scope });
    showToast(`Experiment configuration load failed: ${error.message}`, true, { scope });
  } finally {
    if (launcher?.isConnected) {
...
function renderExperiments() {
  elements.experimentCount.textContent = `${experimentRows.length} experiment${experimentRows.length === 1 ? "" : "s"}`;
  if (!experimentRows.length) {
    elements.experimentsBody.innerHTML = emptyRow(8, "No experiments yet. Create a draft above.");
    return;
  }
    elements.experimentsBody.innerHTML = experimentRows.map((experiment) => {
      const id = experiment.id || experiment.experiment_id;
      const source = experiment.source || {};
      const revision = experiment.revision || source.revision || experiment.git_revision || "-";
      const adapter = experiment.adapter?.id || experiment.adapter_id || experiment.adapter || "-";
      const variantCount = experiment.variant_count ?? experiment.variants?.length ?? 0;
      const runs = experiment.run_count ?? experiment.runs?.length ?? 0;
      const lifecycle = experimentLifecycle(experiment);
      const revisionNumber = experiment.latest_revision_number;
      const secondaryIdentity = [id, revisionNumber ? `Revision ${revisionNumber}` : ""].filter(Boolean).join(" / ");
      return `
        <tr>
...
async function loadExperiments(force = false) {
  ...
  try {
    ...
    experimentRows = [];
    elements.experimentsBody.innerHTML = emptyRow(8, "Experiment data could not be loaded.");
    elements.experimentCount.textContent = "Unavailable";
    showNotice(elements.experimentsError, `Experiment API unavailable: ${error.message}`);
  } finally {
...
function renderVariants(payload, launcher = null) {
  ...
  const addRun = (variantId, run) => {
    ...
    if (!runId || !grouped.some((candidate) => String(candidate.id || candidate.run_id) === String(runId))) {
      grouped.push(run);
    }
  ...
  elements.experimentDetailTitle.textContent = experiment.name || "Experiment variants";
  const lifecycle = experimentLifecycle(experiment);
  elements.experimentDetailMeta.textContent = [
    experiment.id || experiment.experiment_id || "",
    experiment.latest_revision_number ? `Revision ${experiment.latest_revision_number}` : "",
    lifecycle.label,
  ].filter(Boolean).join(" / ");
  renderTrackingDetail(elements.experimentDetailTracking, experiment);
  revealPanel(elements.experimentDetail, { focusTarget: elements.experimentDetailTitle, launcher });
  if (!variants.length) {
    elements.variantsBody.innerHTML = emptyRow(5, "No expanded variants were returned.");
    return;
  }
  elements.variantsBody.innerHTML = variants.map((variant, index) => {
    const variantId = variant.id || "";
    const variantRuns = [...(runsByVariant.get(String(variantId)) || [])];
    (Array.isArray(variant.runs) ? variant.runs : []).forEach((run) => addRun(variantId, run));
    if (variant.run) addRun(variantId, variant.run);
    if (variant.run_id) addRun(variantId, {
      ...variant,
      id: variant.run_id,
      status: variant.status || variant.state,
    });
    const orderedRuns = [...(runsByVariant.get(String(variantId)) || variantRuns)].sort((left, right) => (
    ...
    const result = variant.result || variant.primary_result || latestRun?.result;
    const runList = orderedRuns.length
      ? orderedRuns.map((run) => {
          const runId = run.id || run.run_id || "-";
          const runNumber = run.run_number;
          const label = runNumber ? `Training Run ${runNumber}` : shortId(runId, 18);
...
async function viewExperiment(id, launcher = null) {
  const revealLauncher = launcher || currentRevealLauncher();
  const requestToken = disclosureToken(elements.experimentDetail, revealLauncher);
  try {
    const payload = await api(`/api/experiments/${encodeURIComponent(id)}`);
    if (!disclosureTokenIsCurrent(elements.experimentDetail, requestToken)) return;
...
function progressCell(progress, label) {
  ...
  if (percent === null) return `<span class="secondary">${escapeHtml(label || "Unknown")}</span>`;
  return `
...
function progressSummaryLabel(summary) {
  ...
  const completed = summary.completed === null || summary.completed === undefined
    ? Number.NaN
    : Number(summary.completed);
  const total = summary.total === null || summary.total === undefined
    ? Number.NaN
...
function etaReasonLabel(reason) {
  return ({
    ...
    current_attempt_timing_unavailable: "Current-attempt timing is unavailable",
...
function etaPresentation(summary) {
  ...
  if (state === "estimating" && duration !== null) {
    return { state, label: `~${duration}`, detail: `~${duration} remaining`, reason: etaReasonLabel(summary.eta_reason) };
  }
  if (state === "complete") {
    return { state, label: "Complete", detail: "Complete", reason: etaReasonLabel(summary?.eta_reason) };
  }
  if (state === "waiting") {
    return { state, label: "Waiting", detail: `Waiting - ${etaReasonLabel(summary?.eta_reason)}`, reason: etaReasonLabel(summary?.eta_reason) };
  }
  if (state === "not_applicable") {
    return { state, label: "Not applicable", detail: `Not applicable - ${etaReasonLabel(summary?.eta_reason)}`, reason: etaReasonLabel(summary?.eta_reason) };
  }
  return { state: "unknown", label: "Unknown", detail: `Unknown - ${etaReasonLabel(summary?.eta_reason)}`, reason: etaReasonLabel(summary?.eta_reason) };
}
...
function runRowDescriptor(run) {
  ...
  const progressLabel = progressSummaryLabel(progressSummary) || run.progress_label || run.current_step;
  const eta = String(state).toUpperCase() === "RUNNING"
    ? `<div class="progress-eta">ETA ${etaCell(progressSummary)}</div>`
    : "";
  const runLabel = run.run_number ? `Training Run ${run.run_number}` : shortId(id, 18);
  const runSecondary = [run.run_number ? shortId(id, 18) : "", run.kind || run.stage || "train"].filter(Boolean).join(" / ");
  const experimentRevision = run.experiment_revision_number ? `Revision ${run.experiment_revision_number}` : "";
  const variantLabel = run.variant_name || run.variant_id || "-";
  const active = activeDisclosure?.panel === elements.runDetail && activeRunDetailId === id;
  return {
    id,
    cells: [
...
function renderRuns({ background = false } = {}) {
  ...
  const countLabel = rows.length === runRows.length
  ...
  commitPanelRefresh(panel, "runs-list", {
    countLabel,
    rows: descriptors.map(({ id, cells }) => ({ id, cells: cells.map(({ html, className }) => ({ html, className })) })),
  }, () => {
    setTextIfChanged(elements.runCount, countLabel);
    const existingRows = new Map(
      [...elements.runsBody.querySelectorAll(":scope > tr[data-run-row][data-run-id]")]
        .map((row) => [String(row.dataset.runId), row]),
    );
    const visibleIds = new Set(descriptors.map(({ id }) => id));
    if (activeDisclosure?.panel === elements.runDetail && !visibleIds.has(String(activeRunDetailId))) {
      closeActiveDisclosure({ restoreFocus: false });
    }
    ...
    elements.runsBody.querySelectorAll(":scope > tr:not([data-run-row]):not(.row-disclosure-companion)").forEach((row) => row.remove());
    if (!orderedRows.length) {
      const row = document.createElement("tr");
      row.className = "empty-row";
      patchTableRow(row, [{
        colSpan: 11,
        html: escapeHtml(runRows.length ? "No Training Runs match the filters." : "No Training Runs have been created."),
      }]);
...
async function loadRuns(force = false, { background = false, progressOnly = false } = {}) {
  ...
  if (loadedTabs.has("runs") && !force) { scheduleRunProgressRefresh(); return; }
  if (!background) {
    elements.refreshRuns.disabled = true;
  }
  try {
    const payload = await api(progressOnly ? "/api/runs?refresh_progress=false" : "/api/runs");
    ...
    if (background) {
      showNotice(elements.runsError, `Training Run refresh failed: ${error.message}`, { scope });
      throw error;
    }
    runRows = [];
    elements.runsBody.innerHTML = emptyRow(11, "Training Run data could not be loaded.");
    elements.runCount.textContent = "Unavailable";
    showNotice(elements.runsError, `Training Run API unavailable: ${error.message}`, { scope });
  } finally {
...
function runAttemptDurationLabel(attempt) {
  const persisted = runAttemptValue(attempt, "duration_seconds", "elapsed_seconds", "duration", "elapsed");
  if (persisted !== null) {
  ...
  const started = new Date(runAttemptValue(attempt, "started_at", "created_at") || "").getTime();
  const ended = new Date(runAttemptValue(attempt, "ended_at", "finished_at") || "").getTime();
  if (!Number.isFinite(started) || !Number.isFinite(ended) || ended < started) return "-";
  return runAttemptDurationLabel({ duration_seconds: (ended - started) / 1000 });
}
...
function runAttemptResourceLabel(attempt) {
  ...
  const gpuCount = runAttemptNestedValue(attempt, "resources", "gpus_per_node", "gpu_count", "gpus")
    ?? runAttemptValue(attempt, "gpus_per_node", "gpu_count", "gpus");
  const gpuType = runAttemptNestedValue(attempt, "resources", "gpu_type", "gres")
    ?? runAttemptValue(attempt, "gpu_type", "gres");
  const cpuCount = runAttemptNestedValue(attempt, "resources", "cpus_per_task", "cpu_count", "cpus")
    ?? runAttemptValue(attempt, "cpus_per_task", "cpu_count", "cpus");
  const memoryGb = runAttemptNestedValue(attempt, "resources", "memory_gb", "mem_gb")
    ?? runAttemptValue(attempt, "memory_gb", "mem_gb");
  const nodeCount = runAttemptNestedValue(attempt, "resources", "nodes", "node_count")
  ...
  if (nodeCount !== null) parts.push(`${nodeCount} node${Number(nodeCount) === 1 ? "" : "s"}`);
  return parts.join(" / ") || "-";
}
...
function runAttemptPath(attempt, ...keys) {
  ...
  return logs && typeof logs === "object" && !Array.isArray(logs) ? runAttemptValue(logs, ...keys) : null;
}
...
function commonHyperparameterSourceLabel(source, legacyValue) {
  ...
  const sourceValue = source && typeof source === "object"
    ...
    : source;
  const normalized = String(sourceValue).trim().toLowerCase().replace(/[\s-]+/g, "_");
  const aliases = {
  ...
  return commonHyperparameterSourceLabels[canonical] || `unknown source: ${String(sourceValue)}`;
}
...
function commonHyperparameter(payload, provenancePayload, ...keys) {
  ...
  for (const key of keys) {
    ...
    const provenanceRecord = provenance && typeof provenance === "object" && !Array.isArray(provenance)
      ? provenance
      : {};
    const provenanceSource = provenanceRecord.status === "not_applicable"
      ? "not_applicable"
      : provenanceRecord.status === "unresolved"
        ? "unresolved"
        : provenanceRecord.source;
    const structured = raw && typeof raw === "object" && !Array.isArray(raw)
      && ["value", "effective_value", "resolved_value", "source", "provenance", "origin"]
...
function commonHyperparameterResolutionLabel(resolution) {
  ...
  const labels = {
    enriched_receipt: "Actual values were recovered from stored repository evidence.",
    available_from_cache: "Actual values are available from the repository-inspection cache.",
    requires_explicit_fetch: "Actual values require network inspection of the pinned repository.",
    unavailable: "Actual values cannot be resolved from the stored evidence.",
  };
  return labels[status] || `Actual-value resolution status is unknown: ${status || "missing"}.`;
}

function activeRunAttemptMatches(runId, attemptId) {
  return String(activeRunDetailId || "") === runId
...
function setCommonHyperparameterResolutionError(key, message) {
  ...
  const status = controls.querySelector("[data-common-hyperparameter-resolution-status]");
  const button = controls.querySelector("[data-resolve-common-hyperparameters]");
  if (status) {
...
async function resolveRunAttemptCommonHyperparameters(record, action) {
  ...
  if (!runId || !attemptId || !activeRunAttemptMatches(runId, attemptId)) {
    showNotice(elements.runsError, "Cannot resolve values because the selected run attempt is no longer open.", { scope });
    return;
  }
  if (!action || typeof action !== "object" || String(action.method).toUpperCase() !== "POST" || !action.path) {
    const message = "The server returned an invalid common-hyperparameter resolution action.";
  ...
  const button = controls?.querySelector("[data-resolve-common-hyperparameters]");
  if (status) {
    status.textContent = body.allow_network === true
  ...
  try {
    ...
    const detail = renderRunDetail(detailPayload, runId, { preserveAttempt: true });
    if (!activeRunAttemptMatches(runId, attemptId)) {
      throw new Error("The resolved attempt could not be restored after refresh.");
    }
    startRunDetailPolling(runId, detail.state);
    window.scrollTo(scrollPosition.left, scrollPosition.top);
    showToast("Actual common hyperparameter values resolved.", false, { scope });
  } catch (error) {
    pendingCommonHyperparameterResolutions.delete(key);
    const message = error instanceof Error ? error.message : String(error);
    setCommonHyperparameterResolutionError(key, message);
    showNotice(elements.runsError, `Common hyperparameter resolution failed: ${message}`, { scope });
    showToast(`Common hyperparameter resolution failed: ${message}`, true, { scope });
  } finally {
    pendingCommonHyperparameterResolutions.delete(key);
  }
}
...
function renderCommonHyperparameterResolution(record) {
  ...
  const runId = String(activeRunAttemptDisclosure?.runId || activeRunDetailId || "");
  const attemptId = String(
  ...
  if (action && typeof action === "object") {
    ...
    button.addEventListener("click", () => resolveRunAttemptCommonHyperparameters(record, action));
...
function renderRunAttemptMetadata(record) {
  ...
  const hyperparameters = attempt.common_hyperparameters && typeof attempt.common_hyperparameters === "object"
    ...
    : {};
  const hyperparameterProvenance = attempt.common_hyperparameter_provenance
  ...
  elements.runAttemptDetailMeta.innerHTML = keyValueHtml([
    ...
    ["Partition", runAttemptValue(attempt, "partition") ?? runAttemptNestedValue(attempt, "resources", "partition")],
    ["QoS", runAttemptValue(attempt, "qos") ?? runAttemptNestedValue(attempt, "resources", "qos")],
  ...
  const commonHyperparameters = [
    ["Learning rate", commonHyperparameter(hyperparameters, hyperparameterProvenance, "learning_rate", "train.learning_rate")],
    ["Batch size", commonHyperparameter(hyperparameters, hyperparameterProvenance, "batch_size", "batch_value", "train.batch.value")],
    ["Batch semantics", commonHyperparameter(hyperparameters, hyperparameterProvenance, "batch_semantics", "declared_semantics", "train.batch.declared_semantics")],
    ["Gradient accumulation", commonHyperparameter(hyperparameters, hyperparameterProvenance, "gradient_accumulation", "gradient_accumulation_steps", "train.batch.gradient_accumulation_steps")],
    ["Data workers", commonHyperparameter(hyperparameters, hyperparameterProvenance, "num_workers", "num_workers_per_rank", "train.num_workers_per_rank")],
    ["Precision", commonHyperparameter(hyperparameters, hyperparameterProvenance, "precision", "train.precision")],
    ["Max steps / iterations", commonHyperparameter(hyperparameters, hyperparameterProvenance, "max_steps", "max_iterations", "train.max_steps")],
    ...(
      ["max_epochs", "epochs", "train.max_epochs"].some((key) => (
        Object.prototype.hasOwnProperty.call(commonHyperparameterEntries(hyperparameters), key)
        || Object.prototype.hasOwnProperty.call(commonHyperparameterEntries(hyperparameterProvenance), key)
      ))
        ? [["Max epochs", commonHyperparameter(hyperparameters, hyperparameterProvenance, "max_epochs", "epochs", "train.max_epochs")]]
        : []
    ),
  ].filter(([, entry]) => String(entry.source || "").trim().toLowerCase().replace(/[\s-]+/g, "_") !== "not_applicable");
  const commonHyperparameterSection = elements.runAttemptHyperparameters.closest(".attempt-hyperparameters");
  if (commonHyperparameterSection) commonHyperparameterSection.hidden = commonHyperparameters.length === 0;
...
function closeRunAttemptDisclosure({ restoreFocus = true, markDismissed = false } = {}) {
  ...
  if (elements.runAttemptDetail && !elements.runAttemptDetail.hidden) {
    hideRevealedPanel(elements.runAttemptDetail, closing?.launcher || null, { restoreFocus });
  ...
  updateLogView(elements.runAttemptStdoutLog, "Select an attempt to load stdout.");
  updateLogView(elements.runAttemptStderrLog, "Select an attempt to load stderr.");
...
function resetRunAttemptContext(runId = null) {
  ...
  activeRunDetailId = runId === null || runId === undefined ? null : String(runId);
...
function runAttemptRecordById(attemptId) {
  return [...runDetailAttemptRecords.values()].find(
...
function logStreamStatus(content, loadedLabel = "loaded") {
  ...
  if (/^No (stdout|stderr) log file was produced/.test(content)) return "not produced";
  return loadedLabel;
}

function logViewViewport(element) {
  return element.closest(".log-view, .log-output, .preview-code, .code-block, [data-log-viewport]") || element;
}
...
function updateLogView(element, content, { generation = null } = {}) {
  ...
  const bottomDistance = Math.max(0, viewport.scrollHeight - viewport.clientHeight - top);
  const followBottom = bottomDistance <= 24;

  element.textContent = next;
  if (!logViewUpdateIsCurrent(element, writeGeneration) || !element.isConnected) return false;
  const maxTop = Math.max(0, viewport.scrollHeight - viewport.clientHeight);
  const maxLeft = Math.max(0, viewport.scrollWidth - viewport.clientWidth);
  viewport.scrollTop = followBottom
    ? maxTop
    : Math.min(maxTop, top <= maxTop ? top : Math.max(0, maxTop - bottomDistance));
  viewport.scrollLeft = Math.min(maxLeft, left);
  return true;
}

async function loadRunAttemptLogs(record, token, { showLoading = true, retainOnError = false, pollGeneration = null } = {}) {
  ...
  if (showLoading) {
    ...
    updateLogView(elements.runAttemptStdoutLog, "Loading stdout...", { generation: stdoutGeneration });
    updateLogView(elements.runAttemptStderrLog, "Loading stderr...", { generation: stderrGeneration });
  }
  ...
  if (pollGeneration !== null && pollGeneration !== runDetailPollGeneration) return false;
  if (stdoutResult.status === "fulfilled") {
    const content = logContent(stdoutResult.value);
    if (updateLogView(elements.runAttemptStdoutLog, content || "No stdout output.", { generation: stdoutGeneration })) {
      setTextIfChanged(elements.runAttemptStdoutStatus, logStreamStatus(content, "stdout loaded"));
    }
  } else {
    if (!retainOnError) {
      if (updateLogView(elements.runAttemptStdoutLog, `Unable to load stdout: ${stdoutResult.reason.message}`, { generation: stdoutGeneration })) {
        setTextIfChanged(elements.runAttemptStdoutStatus, "refresh failed; retrying");
      }
    } else if (logViewUpdateIsCurrent(elements.runAttemptStdoutLog, stdoutGeneration)) {
      setTextIfChanged(elements.runAttemptStdoutStatus, "refresh failed; retrying");
    }
  }
  if (stderrResult.status === "fulfilled") {
    const content = logContent(stderrResult.value);
    if (updateLogView(elements.runAttemptStderrLog, content || "No stderr output.", { generation: stderrGeneration })) {
      setTextIfChanged(elements.runAttemptStderrStatus, logStreamStatus(content, "stderr loaded"));
    }
  } else {
    if (!retainOnError) {
      if (updateLogView(elements.runAttemptStderrLog, `Unable to load stderr: ${stderrResult.reason.message}`, { generation: stderrGeneration })) {
        setTextIfChanged(elements.runAttemptStderrStatus, "refresh failed; retrying");
      }
    } else if (logViewUpdateIsCurrent(elements.runAttemptStderrLog, stderrGeneration)) {
      setTextIfChanged(elements.runAttemptStderrStatus, "refresh failed; retrying");
    }
  }
  return stdoutResult.status === "fulfilled" && stderrResult.status === "fulfilled";
}

async function openRunAttemptDetail(attemptKey, launcher, {
  focus = true,
  loadLogs = true,
  showLoading = true,
  followLatest = null,
  ...
  const runId = activeRunDetailId;
  activeRunAttemptDisclosure = { token, runId, attemptKey, attemptId: String(record.attemptId), launcher };
  runDetailAttemptDismissed = false;
  runDetailFollowLatest = followLatest === null
...
function renderRunDetailContent(payload, id, { preserveAttempt = false } = {}) {
  ...
  setTextIfChanged(elements.runDetailTitle, run.name || (run.run_number ? `Training Run ${run.run_number}` : run.id || id));
  ...
  const manualActions = run.manual_actions && typeof run.manual_actions === "object"
    ? run.manual_actions
    : {};
    const trackingActions = run.tracking_actions && typeof run.tracking_actions === "object"
    ...
    const trackingActionButtons = trackingActions
      ...
      .map((action) => {
        ...
        const label = action.label || `Connect ${trackingProviderLabel(provider)}`;
  ...
  const existingAttemptRows = new Map(
    [...elements.attemptsBody.querySelectorAll(":scope > tr[data-attempt-row][data-attempt-key]")]
  ...
  attempts.forEach((attempt, index) => {
      const attemptNumber = attempt.attempt_number ?? attempt.number ?? attempt.attempt ?? index + 1;
      ...
      const row = existingAttemptRows.get(attemptKey) || document.createElement("tr");
  ...
  elements.attemptsBody.querySelectorAll(":scope > tr.empty-row").forEach((row) => row.remove());
  if (orderedAttemptRows.length) {
    const companion = elements.runAttemptDetail.closest("tr.row-disclosure-companion");
    const activeRow = activeRunAttemptDisclosure
      ? orderedAttemptRows.find((row) => row.dataset.attemptKey === activeRunAttemptDisclosure.attemptKey)
      : null;
    reconcileTableSequence(
      elements.attemptsBody,
      orderedAttemptRows.flatMap((row) => row === activeRow && companion ? [row, companion] : [row]),
    );
  } else {
  ...
  const latestRecord = attempts.length
    ...
    : null;
  runDetailLatestAttemptId = latestRecord ? String(latestRecord.attemptId) : null;
  if (preserveAttempt && activeRunAttemptDisclosure) {
    const selectedRecord = runAttemptRecordById(selectedAttemptId);
    if (selectedRecord) {
      const launcher = elements.attemptsBody.querySelector(`[data-attempt-key="${CSS.escape(selectedRecord.attemptKey)}"] [data-attempt-action="view"]`);
      if (launcher) {
  ...
  if (preserveAttempt && activeRunAttemptDisclosure) remountActiveRunAttemptDisclosure();
  elements.runDetail.hidden = false;
  return { run, state: String(state).toUpperCase(), latestRecord };
}

function updateRunSummary(run, id) {
  const index = runRows.findIndex((item) => String(item.id || item.run_id) === String(id));
  if (index < 0) return;
  runRows[index] = { ...runRows[index], ...run };
  const summaryRow = elements.runsBody.querySelector(`:scope > tr[data-run-id="${CSS.escape(String(id))}"]`);
  if (summaryRow) patchTableRow(summaryRow, runRowDescriptor(runRows[index]).cells);
}
...
function renderRunDetail(payload, id, { preserveAttempt = false, background = false } = {}) {
  ...
  return {
    ...
    latestRecord: runDetailLatestAttemptId ? runAttemptRecordById(runDetailLatestAttemptId) : null,
  };
}
...
function logContent(payload) {
  ...
  if (!payload || typeof payload !== "object") return "";
  return payload.stderr || payload.log || payload.content || payload.text || JSON.stringify(payload, null, 2);
}
...
async function viewRun(id, launcher = null) {
  ...
  elements.runDetailMeta.innerHTML = keyValueHtml([["Status", "Loading run..."]]);
  elements.attemptsBody.innerHTML = emptyRow(8, "Loading attempts...");
  revealPanel(elements.runDetail, { focusTarget: elements.runDetailTitle, launcher: revealLauncher, scroll: false });
  const detailResult = await Promise.resolve(api(`/api/runs/${encodeURIComponent(id)}`))
  ...
  if (detailResult.status === "fulfilled") {
    try {
      ...
      elements.runDetailMeta.innerHTML = keyValueHtml([["Detail error", error.message]]);
      elements.attemptsBody.innerHTML = emptyRow(8, "Training Run detail could not be rendered.");
      showToast(`Training Run detail failed: ${error.message}`, true, { scope });
    }
  } else {
    elements.runDetailMeta.innerHTML = keyValueHtml([["Detail error", detailResult.reason.message]]);
    elements.attemptsBody.innerHTML = emptyRow(8, "Training Run detail unavailable.");
    startRunDetailPolling(id, null, { initialDelay: RUN_DETAIL_POLL_INTERVAL_MS });
  }
}
...
async function attachRunTracking(id, provider, actionPath, button) {
  ...
  if (!id || !provider || !actionPath) {
    showToast("Tracking attachment action is incomplete; refresh the Training Run detail.", true, { scope });
    return;
  }
  const expectedPrefix = `/api/runs/${encodeURIComponent(id)}/tracking/`;
  if (!actionPath.startsWith(expectedPrefix) || !actionPath.endsWith("/attach")) {
    showToast("Tracking attachment action was rejected because its server path is invalid.", true, { scope });
    return;
  }
  ...
  try {
    ...
    showToast(`${trackingProviderLabel(provider)} connected to Training Run ${shortId(id)}.`, false, { scope });
  } catch (error) {
...
function scheduleRunDetailPoll(delay, { finalCycle = false, includeList = true } = {}) {
  window.clearTimeout(runDetailPollTimer);
...
function startRunDetailPolling(runId, state = null, { initialDelay = null, includeList = true } = {}) {
  runDetailPollGeneration += 1;
  window.clearTimeout(runDetailPollTimer);
  runDetailPollTimer = null;
  runDetailPollInFlight = null;
  runDetailPollRunId = String(runId);
  const active = state === null || RUN_DETAIL_ACTIVE_STATES.has(String(state).toUpperCase());
  const delay = initialDelay ?? (active ? RUN_DETAIL_POLL_INTERVAL_MS : RUN_DETAIL_FINAL_POLL_DELAY_MS);
  scheduleRunDetailPoll(delay, { finalCycle: !active, includeList });
}

async function pollRunDetail(generation, runId, { finalCycle = false, includeList = true } = {}) {
  ...
  try {
    const detailResult = await Promise.resolve(api(`/api/runs/${encodeURIComponent(runId)}`))
      .then((value) => ({ status: "fulfilled", value }))
      .catch((reason) => ({ status: "rejected", reason }));
    if (generation !== runDetailPollGeneration || !runDetailPollEligible(runId)) return;
    if (detailResult.status === "rejected") {
      showNotice(elements.runsError, `Live run update failed; displayed data may be stale: ${detailResult.reason.message}. Retrying automatically.`, { scope });
    ...
    if (!detail.latestRecord) {
      ...
      let selectedRecord = activeRunAttemptDisclosure
        ...
        : null;
      if (!selectedRecord || (runDetailFollowLatest && String(selectedRecord.attemptId) !== String(detail.latestRecord.attemptId))) {
        const launcher = elements.attemptsBody.querySelector(`[data-attempt-key="${CSS.escape(detail.latestRecord.attemptKey)}"] [data-attempt-action="view"]`);
        if (launcher) {
      ...
      if (selectedRecord && activeRunAttemptDisclosure) {
        await loadRunAttemptLogs(selectedRecord, activeRunAttemptDisclosure.token, {
          showLoading: false,
          retainOnError: true,
    ...
    if (active) {
      ...
      scheduleRunDetailPoll(RUN_DETAIL_FINAL_POLL_DELAY_MS, { finalCycle: true, includeList: true });
    } else {
      runDetailPollRunId = null;
      runDetailPollTimer = null;
    }
...
async function refreshRunsPage() {
  ...
  if (activeRunDetailId && !elements.runDetail.hidden && activeTab === "runs") {
    startRunDetailPolling(activeRunDetailId, null, { initialDelay: 0, includeList: false });
  }
}
...
function evaluationScalarValues(value, output = []) {
  if (typeof value === "string" || typeof value === "number") {
    ...
    Object.values(value).forEach((item) => evaluationScalarValues(item, output));
  }
  return output;
}

function evaluationValuesForKeys(value, keyPattern, output = [], seen = new Set()) {
...
function evaluationMetadataIncludes(metadata, value) {
  ...
  return needle.length >= 3 && normalizedEvaluationValue(metadata).includes(needle);
}

function evaluationSuiteConfig(suite) {
  return suite?.config_json && typeof suite.config_json === "object" && !Array.isArray(suite.config_json)
    ? suite.config_json
    : {};
}
...
function evaluationSuitePreference(run, suite) {
  ...
  const canonicalDefault = suite?.is_default === true
    || suite?.default === true
    || suite?.canonical === true
    || config.is_default === true
    || config.default === true
    || config.canonical === true;
  if (evaluationScalarValues(suiteIdentity).some((value) => evaluationMetadataIncludes(runMetadata, value))) return 3;
  if (evaluationScalarValues(compatibility).some((value) => evaluationMetadataIncludes(runMetadata, value))) return 2;
  return canonicalDefault ? 1 : 0;
}

function preferredEvaluationSuite(run) {
  return evaluationSuites
    .map((suite, index) => ({ suite, index }))
    .filter(({ suite }) => evaluationSuiteIsRunnable(suite))
    .sort((left, right) => evaluationSuitePreference(run, right.suite) - evaluationSuitePreference(run, left.suite) || left.index - right.index)[0]?.suite || null;
}
...
function evaluationCheckpointForRun(run) {
  ...
  const available = [...checkpoints].reverse().filter((checkpoint) => {
    ...
    const registeredAvailable = status === "AVAILABLE"
      || (!status && checkpoint.available === true);
    return Boolean(path)
      && registeredAvailable
      && checkpoint.available !== false
      && !checkpoint.pruned_at;
  });
  const selectedInference = available.find((checkpoint) => {
    const kind = String(checkpoint.checkpoint_type || checkpoint.type || "").toUpperCase();
    return checkpoint.is_selected_for_inference === true && (!kind || kind === "INFERENCE");
  }) || available.find((checkpoint) => checkpoint.is_selected_for_inference === true)
    || available.find((checkpoint) => String(checkpoint.checkpoint_type || checkpoint.type || "").toUpperCase() === "INFERENCE");
...
function runEvaluationAction(run) {
  ...
  return checkpointPath
    ...
    : { enabled: false, reason: RUN_EVALUATION_CHECKPOINT_REQUIRED, checkpointPath: "" };
}
...
function evaluationSuiteTasks(suite) {
  const config = evaluationSuiteConfig(suite);
  const declared = Array.isArray(suite?.tasks) && suite.tasks.length
    ? suite.tasks
    : Array.isArray(config.tasks) ? config.tasks : [];
  const seen = new Set();
  return declared.flatMap((task) => {
    const id = typeof task === "string"
      ? task.trim()
      : String(firstValue(task?.id, task?.task_id, task?.slug, task?.name, "")).trim();
    if (!id || seen.has(id)) return [];
    seen.add(id);
...
function checkedEvaluationTaskIds() {
  return [...elements.evaluationTasksOptions.querySelectorAll("input:checked")]
    .map((input) => input.value);
}

function updateEvaluationTaskLabel() {
  const total = elements.evaluationTasksOptions.querySelectorAll("input").length;
  ...
  elements.evaluationTasksFilterLabel.textContent = selected
    ...
    : renderedEvaluationTaskPolicy.mode === "single" && total > 1 ? "Choose one task" : "Suite default";
}

function populateEvaluationTasks(suite, { preserve = false } = {}) {
  const suiteId = evaluationSuiteId(suite);
  const selected = preserve && suiteId === renderedEvaluationTaskSuiteId
    ? new Set(checkedEvaluationTaskIds())
    : new Set();
  const tasks = evaluationSuiteTasks(suite);
  renderedEvaluationTaskSuiteId = suiteId;
  elements.evaluationTasksOptions.innerHTML = tasks.map((task) => `
    <label class="filter-option">
  ...
  elements.evaluationTasksFilter.setAttribute("aria-disabled", String(disabled));
...
function validateEvaluationResources() {
  ...
  const seconds = match ? Number(match[1] || 0) * 86400 + Number(match[2]) * 3600 + Number(match[3]) * 60 + Number(match[4]) : 0;
  const valid = Boolean(match && Number(match[3]) < 60 && Number(match[4]) < 60 && seconds > 0);
  time.setCustomValidity(valid ? "" : "Enter a positive wall time as HH:MM:SS or D-HH:MM:SS.");
...
async function validateEvaluationTarget(request, signature) {
  ...
  if (!validateEvaluationResources()) {
    evaluationTargetValidationState = { pending: false, valid: false, planValid: false, signature };
  ...
  try {
    ...
    if (request !== evaluationTargetValidationRequest || signature !== evaluationTargetSignature()) return false;
    setEvaluationFieldValidation(elements.evaluationPlanStatus, elements.evaluationPlanStatus, "invalid", error.message);
    evaluationTargetValidationState = { pending: false, valid: false, planValid: false, signature };
    updateEvaluationSubmitState();
    return false;
  }
  try {
    ...
    if (!checkpointPath && result.resolved_checkpoint_path) {
      elements.evaluationCheckpoint.value = String(result.resolved_checkpoint_path);
    }
    ...
    const valid = result.valid === true && runValid && checkpointValid && suiteValid && planValid;
    ...
    const evaluatorLabel = evaluator
      ...
      : null;
    const blockers = Array.isArray(result.plan_blockers) ? result.plan_blockers.filter(Boolean) : [];
    ...
    if (request !== evaluationTargetValidationRequest || signature !== evaluationTargetSignature()) return false;
    setEvaluationFieldValidation(elements.evaluationRunId, elements.evaluationRunValidation, "", "Run validation could not be completed.");
    setEvaluationFieldValidation(elements.evaluationCheckpoint, elements.evaluationCheckpointValidation, "", "Checkpoint validation could not be completed.");
    setEvaluationFieldValidation(elements.evaluationPlanStatus, elements.evaluationPlanStatus, "invalid", `Validation failed: ${error.message}`);
    evaluationTargetValidationState = { pending: false, valid: false, planValid: false, signature };
    updateEvaluationSubmitState();
    return false;
  }
...
function scheduleEvaluationTargetValidation({ immediate = false } = {}) {
  ...
  if (!runId) {
    ...
    setEvaluationFieldValidation(elements.evaluationCheckpoint, elements.evaluationCheckpointValidation, "", "A registered checkpoint will be resolved from the run.");
    setEvaluationFieldValidation(elements.evaluationPlanStatus, elements.evaluationPlanStatus, "", elements.evaluationSuite.value
  ...
  setEvaluationFieldValidation(elements.evaluationRunId, elements.evaluationRunValidation, "pending", "Checking run...");
  setEvaluationFieldValidation(elements.evaluationCheckpoint, elements.evaluationCheckpointValidation, "pending", "Checking checkpoint...");
  setEvaluationFieldValidation(elements.evaluationPlanStatus, elements.evaluationPlanStatus, "pending", elements.evaluationSuite.value
    ? "Resolving evaluator implementation..."
    : "Choose a suite to resolve its evaluator implementation.");
  evaluationTargetValidationState = { pending: true, valid: false, planValid: false, signature };
  updateEvaluationSubmitState();
...
async function startEvaluationForRun(id) {
  ...
  let loadError = null;
  try {
    const payload = await api(`/api/runs/${encodeURIComponent(requestedRunId)}`);
    run = entityFrom(payload, "run");
    const returnedRunId = String(run?.id || run?.run_id || "").trim();
    if (returnedRunId !== requestedRunId) throw new Error("Run detail did not match the selected run.");
  } catch (error) {
    loadError = error;
  }
...
async function recoverRunSubmission(id, button) {
  ...
  try {
    ...
    showToast(`Submission recovered: Slurm job ${result.slurm_job_id}.`, false, { scope });
  } catch (error) { showNotice(elements.runsError, `Submission recovery failed: ${error.message}`, { scope }); }
  finally {
...
async function requestCancellation(kind, id, button, reason = "") {
  ...
  try {
    ...
    showToast(`Cancellation requested for ${subject} ${id}.`, false, { scope: notificationScope });
    if (kind === "run") {
      const returnedRun = payload?.run;
      if (returnedRun && typeof returnedRun === "object") {
        const index = runRows.findIndex((run) => String(run.id || run.run_id) === String(id));
        if (index >= 0) {
      ...
      if (activeRunDetailId === String(id) && !elements.runDetail.hidden) {
        startRunDetailPolling(id, returnedRun?.status || returnedRun?.state || "CANCELLING", { initialDelay: 0 });
      }
      return;
    }
    ...
    if (activeEvaluationDetailId === String(id) && !elements.evaluationDetail.hidden) {
      const launcher = activeDisclosure?.panel === elements.evaluationDetail ? activeDisclosure.launcher : null;
      await viewEvaluation(id, launcher, { polling: true });
    }
  } catch (error) {
    cancellationRequests.delete(key);
    restoreCancellationButton(kind, id);
    showToast(`Cancellation request failed: ${error.message}`, true, { scope: notificationScope });
  }
}
...
async function rerunRun(id, reason = "") {
  ...
  try {
    ...
    showToast(`New Training Run${newRunId ? ` ${newRunId}` : ""} created from the pinned variant of ${id}.`, false, { scope });
    await loadRuns(true);
    if (newRunId) {
      const launcher = [...elements.runsBody.querySelectorAll("[data-run-action='view']")]
...
function evaluationRowCells(evaluation) {
  ...
  const completed = Number(progressSummary?.completed ?? evaluation.progress_completed ?? evaluation.completed_episodes);
  const total = Number(progressSummary?.total ?? evaluation.progress_total ?? evaluation.total_episodes);
  const progress = progressSummary || (Number.isFinite(completed) && Number.isFinite(total) && total > 0
    ? completed / total
    : evaluation.progress ?? evaluation.completed_episodes_ratio);
  const progressLabel = progressSummaryLabel(progressSummary) || evaluation.progress_label
    || (Number.isFinite(completed) && Number.isFinite(total)
      ? `${completed}/${total}`
      : null);
  return [
    `<span class="node-name">${escapeHtml(shortId(id, 18))}</span>`,
...
function renderEvaluations({ background = false } = {}) {
  ...
  commitPanelRefresh(panel, "evaluations-list", {
    ...
    const existingRows = new Map(
      [...elements.evaluationsBody.querySelectorAll(":scope > tr[data-evaluation-id]")]
        .map((row) => [String(row.dataset.evaluationId), row]),
    );
    const visibleIds = new Set(descriptors.map(({ id }) => id));
    if (activeDisclosure?.panel === elements.evaluationDetail && !visibleIds.has(String(activeEvaluationDetailId))) {
      closeActiveDisclosure({ restoreFocus: false });
    }
    const orderedRows = descriptors.map((descriptor) => {
      const row = existingRows.get(descriptor.id) || document.createElement("tr");
    ...
    existingRows.forEach((row) => row.remove());
    elements.evaluationsBody.querySelectorAll(":scope > tr:not([data-evaluation-id]):not(.row-disclosure-companion)").forEach((row) => row.remove());
    if (!orderedRows.length) {
      const row = document.createElement("tr");
      row.className = "empty-row";
    ...
    const companion = elements.evaluationDetail.closest("tr.row-disclosure-companion");
    const activeRow = activeEvaluationDetailId
      ? orderedRows.find((row) => row.dataset.evaluationId === String(activeEvaluationDetailId))
      : null;
    reconcileTableSequence(
...
function updateEvaluationRow(evaluation, { background = false } = {}) {
  ...
  const panel = elements.evaluationsBody.closest(".panel") || elements.evaluationsBody;
  commitPanelRefresh(panel, `evaluation-summary:${id}`, evaluationRowCells(evaluationRows[index]), () => {
...
function revalidateFinishedEvaluation(previous, next) {
  const runId = elements.evaluationRunId.value.trim();
  if (previous.some(row => String(row.run_id) === runId && EVALUATION_ACTIVE_STATES.has(String(row.status || row.state).toUpperCase()))
      && !next.some(row => String(row.run_id) === runId && EVALUATION_ACTIVE_STATES.has(String(row.status || row.state).toUpperCase()))) {
    scheduleEvaluationTargetValidation({ immediate: true });
  }
}
...
function scheduleEvaluationListPolling(delay = EVALUATION_LIST_POLL_INTERVAL_MS) {
  ...
  evaluationListPollTimer = window.setTimeout(async () => {
    ...
    if (!evaluationListPollInFlight) {
      evaluationListPollInFlight = api(evaluationProgressRefreshPending ? "/api/evaluations?refresh_progress=false" : "/api/evaluations")
        .then((payload) => {
          evaluationProgressRefreshPending = payload.progress_refresh_pending === true;
...
async function loadEvaluations(force = false) {
  ...
  try {
    ...
    evaluationRows = [];
    elements.evaluationsBody.innerHTML = emptyRow(9, "Evaluation data could not be loaded.");
    elements.evaluationCount.textContent = "Unavailable";
    showNotice(elements.evaluationsError, `Evaluation API unavailable: ${error.message}`);
  } finally {
...
function evaluationCommandOverrides() {
  ...
  if (elements.evaluationResumeArgv.value.trim()) {
    ...
    if (!Array.isArray(resumeArgv) || resumeArgv.some((item) => typeof item !== "string")) {
...
async function createEvaluation(event) {
  ...
  if (evaluationTargetValidationState.pending
      || !evaluationTargetValidationState.valid
      || evaluationTargetValidationState.signature !== evaluationTargetSignature()) {
    scheduleEvaluationTargetValidation({ immediate: true });
    showToast("Wait for a valid training run and checkpoint before creating the evaluation.", true);
    return;
  }
  let payload;
  try {
  ...
  if (!payload.run_id) {
    showToast("Provide a training run ID. External checkpoints must first be registered as a run.", true);
...
function renderEvaluationRolloutModal(evaluation, episode) {
  ...
  empty.textContent = !EVALUATION_ACTIVE_STATES.has(String(evaluation.status || evaluation.state).toUpperCase())
...
function dataResourceIdentity(resource) {
  ...
  return [resource.provider, [resource.namespace, resource.name].filter(Boolean).join("/")]
    .filter(Boolean)
    .join(":") || resource.id || resource.resource_id || "unknown resource";
}

function dataVersionResource(version) {
  if (version?.resource) return version.resource;
  return version?._resource || dataResourceRows.find((resource) =>
    String(resource.id || resource.resource_id) === String(version?.resource_id));
}
...
function populateExperimentDataBundles() {
  const previous = elements.experimentDataBundle.value;
  const adapter = selectedAdapter();
  const hasBindings = declaredAdapterInputFields(adapter).some((field) => field.data_binding);
  const compatibility = new Map(dataBundleRows.map((bundle) => [
    String(bundle.id || bundle.bundle_id),
    experimentBundleCompatibility(bundle, adapter),
  ]));
  const compatibleBundles = dataBundleRows.filter((bundle) => (
    compatibility.get(String(bundle.id || bundle.bundle_id))?.compatible !== false
  ));
  const previousWasRemoved = Boolean(
    previous && compatibility.get(String(previous))?.compatible === false
  );
  ...
  elements.experimentDataBundle.innerHTML = [
    ...
    ...compatibleBundles.map((bundle) => {
      ...
      return `<option value="${escapeHtml(bundle.id || bundle.bundle_id)}">${escapeHtml(label)}</option>`;
    }),
  ].join("");
  elements.experimentDataBundle.disabled = false;
  if (invalidPrevious) {
    elements.experimentDataBundle.value = previous;
  } else if ([...elements.experimentDataBundle.options].some((option) => option.value === previous)) {
    elements.experimentDataBundle.value = previous;
  } else {
    elements.experimentDataBundle.value = "";
  }
...
function experimentBundleCompatibility(bundle, adapter = selectedAdapter()) {
...
async function loadDataBundles(force = false) {
  ...
  elements.experimentDataBundleStatus.textContent = "Loading registered data bundles...";
  try {
    const payload = await api("/api/data/bundles");
    dataBundleRows = listFrom(payload, ["bundles"]);
...
function dataVersionPath(version) {
  ...
  const available = locations.filter(location => location.status === "AVAILABLE" && location.path);
  const location = available.find(location => location.kind === "cluster") || available[0];
  ...
  elements.dataResourcesBody.innerHTML = dataResourceRows.length
    ? dataResourceRows.map((resource) => {
      ...
      return `<tr data-resource-id="${escapeHtml(id)}">
        ...
        <td>${resource.archived_at ? statusPill("ARCHIVED") : latest ? statusPill(dataVersionStatus(latest)) : '<span class="secondary">-</span>'}</td>
...
function renderDataImports() {
  elements.dataImportCount.textContent = `${dataImportRows.length} import job${dataImportRows.length === 1 ? "" : "s"}`;
  if (!dataImportRows.length) {
    elements.dataImportsBody.innerHTML = emptyRow(7, "No dataset import jobs have been submitted.");
    return;
  }
...
function renderDataImportBudget() {
  document.querySelector("#data-import-budget").textContent = `Allocation: 1 node, ${document.querySelector("#data-import-cpus").value} CPUs, ${document.querySelector("#data-import-memory").value} GB memory, no GPUs; time limit ${document.querySelector("#data-import-time").value}. Queue: ${elements.dataImportQueue.value}. Cancel is available while the import is active.`;
}

function dataImportCanCancel(item) {
  return Boolean(item.slurm_job_id) && ["SUBMITTED", "PENDING", "RUNNING"].includes(item.state);
}

function dataImportCancelButton(item) {
  return dataImportCanCancel(item) ? `<button type="button" class="button button-outline" data-import-action="cancel" data-id="${escapeHtml(item.id)}">Cancel import</button>` : "";
}

async function cancelDataImport(id, button) {
  if (!(await askUserDialog("Cancel this import job? Published versions and existing files are retained."))) return;
  button.disabled = true;
  try {
    await api(`/api/data/imports/${encodeURIComponent(id)}/cancel`, { method: "POST" });
    await loadDataRegistry(true);
    showToast("Import cancellation requested. Refresh to confirm its final state.");
  } catch (error) { showToast(`Import cancellation failed: ${error.message}`, true); }
  finally { if (button.isConnected) button.disabled = false; }
}

function selectDataResourceForImport(id, launcher = null) {
  const resource = dataResourceRows.find((candidate) => String(candidate.id || candidate.resource_id) === String(id));
  ...
  revealPanel(elements.dataImportForm, { focusTarget: elements.dataImportRevision, launcher });
}
...
async function submitDataImport(event) {
  ...
  try {
    const result = await api(`/api/data/resources/${encodeURIComponent(resourceId)}/imports`, {
      method: "POST",
      body: JSON.stringify({
        ...
        bundle_name: elements.dataImportBundleName.value.trim(),
        bundle_version: elements.dataImportBundleVersion.value.trim(),
        ...
        memory_gb: Number(document.querySelector("#data-import-memory").value),
...
function renderDataVersions() {
  elements.dataVersionCount.textContent = `${dataVersionRows.length} immutable version${dataVersionRows.length === 1 ? "" : "s"}`;
  elements.dataVersionsBody.innerHTML = dataVersionRows.length
  ...
  picker.innerHTML = '<option value="">Choose a version</option>' + dataVersionRows.filter(version => !(version._resource || version.resource)?.archived_at && (version.status === "READY" || (version.locations || []).some(location => location.kind === "cluster" && location.status === "AVAILABLE"))).map(version => `<option value="${escapeHtml(version.id || version.version_id)}">${escapeHtml(dataVersionLabel(version))} / ${escapeHtml(version.format)}</option>`).join("");
  ...
  elements.dataDerivationOutput.disabled = !dataVersionRows.length;
  if ([...elements.dataDerivationOutput.options].some((option) => option.value === previousOutput)) {
    elements.dataDerivationOutput.value = previousOutput;
  }
}

function renderDataDerivations() {
  elements.dataDerivationCount.textContent = `${dataDerivationRows.length} derivation${dataDerivationRows.length === 1 ? "" : "s"}`;
  elements.dataDerivationsBody.innerHTML = dataDerivationRows.length
    ? dataDerivationRows.map((derivation) => {
      const output = derivation.output_version || dataVersionRows.find((version) =>
        String(version.id || version.version_id) === String(derivation.output_version_id));
      const inputs = Array.isArray(derivation.inputs) ? derivation.inputs : [];
      const inputHtml = inputs.length
        ? inputs.map((input) => `<div><strong>${escapeHtml(input.role || "input")}</strong>: ${escapeHtml(dataVersionLabel(input.version || dataVersionRows.find((version) => String(version.id || version.version_id) === String(input.version_id))))}</div>`).join("")
...
function renderDataBundles() {
  elements.dataBundleCount.textContent = `${dataBundleRows.length} bundle${dataBundleRows.length === 1 ? "" : "s"}`;
  elements.dataBundlesBody.innerHTML = dataBundleRows.length
    ? dataBundleRows.map((bundle) => {
      const assignments = Array.isArray(bundle.assignments) ? bundle.assignments : [];
      const assignmentsHtml = assignments.length
        ? assignments.map((assignment) => {
          const version = assignment.version || dataVersionRows.find((candidate) =>
            String(candidate.id || candidate.version_id) === String(assignment.version_id));
          const mount = assignment.mount_path ? ` -> ${assignment.mount_path}` : "";
          const optional = assignment.required === false ? " (optional)" : "";
          return `<div><strong>${escapeHtml(assignment.role)}</strong>: ${escapeHtml(dataVersionLabel(version))}${escapeHtml(mount + optional)}</div>`;
        }).join("")
        : '<span class="secondary">No assignments resolved</span>';
      return `<tr>
        <td><span class="node-name">${escapeHtml(bundle.name)}@${escapeHtml(bundle.version)}</span><span class="secondary">${escapeHtml(bundle.id || bundle.bundle_id)}</span></td>
        <td class="wrap-cell">${assignmentsHtml}</td>
        <td><code>${escapeHtml(shortId(bundle.manifest_sha256, 16))}</code></td>
        <td>${escapeHtml(formatDate(bundle.created_at))}</td>
        <td class="row-actions"><button type="button" data-bundle-action="preview" data-id="${escapeHtml(bundle.id || bundle.bundle_id)}">Preview</button></td>
      </tr>`;
    }).join("")
    : emptyRow(5, "No role-based bundles have been created.");
  synchronizeDisclosureLaunchers(elements.dataBundlesBody);
  populateExperimentDataBundles();
}

function dataBundlePreviewRecord(payload) {
  const preview = payload?.preview;
  if (preview && typeof preview === "object" && !Array.isArray(preview)) return preview;
  return payload && typeof payload === "object" && !Array.isArray(payload) ? payload : {};
}

function dataBundlePreviewArray(value) {
  return Array.isArray(value) ? value : [];
}

function dataBundlePreviewDisplay(value) {
  if (value === null || value === undefined || value === "") return "-";
  if (typeof value === "boolean") return value ? "Yes" : "No";
  if (Array.isArray(value)) return value.length ? value.map((item) => dataBundlePreviewDisplay(item)).join(", ") : "-";
  if (typeof value === "object") return compactJson(value, 320);
  return String(value);
}

function dataBundlePreviewKeyValueHtml(entries) {
  return entries
    .filter(([, value]) => value !== null && value !== undefined && value !== "")
    .map(([label, value]) => `<div class="key-value"><span>${escapeHtml(label)}</span><strong>${escapeHtml(dataBundlePreviewDisplay(value))}</strong></div>`)
    .join("");
}

function dataBundlePreviewAssignmentLabel(assignment) {
  return `${assignment?.role || "unassigned"}[${Number(assignment?.position || 0)}]`;
}

function dataBundlePreviewFeatures(dataset) {
...
function dataBundlePreviewEmpty(container, message) {
  container.innerHTML = `<p class="secondary dataset-preview-empty">${escapeHtml(message)}</p>`;
}

function resetDataBundlePreviewMedia() {
  const activeMedia = elements.dataBundlePreviewMediaPlayer?.querySelector("video, audio");
  if (activeMedia) {
    activeMedia.pause();
    activeMedia.removeAttribute("src");
    activeMedia.load();
  }
  elements.dataBundlePreviewMediaPlayer?.replaceChildren();
  if (elements.dataBundlePreviewMediaPlayer) elements.dataBundlePreviewMediaPlayer.hidden = true;
}

function selectedDataBundlePreviewMedia() {
  const key = elements.dataBundlePreviewMediaSelect?.value;
  return dataBundlePreviewMediaItems.find((item) => item._previewKey === key) || null;
}

function updateDataBundlePreviewMediaSelection() {
  resetDataBundlePreviewMedia();
  const item = selectedDataBundlePreviewMedia();
  if (!item) {
    elements.dataBundlePreviewMediaEmpty.textContent = "No playable sample media was returned.";
    elements.dataBundlePreviewMediaEmpty.hidden = false;
    elements.dataBundlePreviewMediaMeta.hidden = true;
    elements.dataBundlePreviewMediaMeta.innerHTML = "";
    return;
  }
  elements.dataBundlePreviewMediaEmpty.textContent = "Loading selected media...";
  elements.dataBundlePreviewMediaEmpty.hidden = false;
  elements.dataBundlePreviewMediaMeta.innerHTML = dataBundlePreviewKeyValueHtml([
    ["Role", item._assignmentLabel],
    ["Path", item.relative_path],
    ["Kind", item.kind || item.mime_type],
    ["MIME type", item.mime_type],
    ["Size", item.size_bytes == null ? undefined : formatDataBytes(item.size_bytes)],
  ]);
  elements.dataBundlePreviewMediaMeta.hidden = false;
  loadSelectedDataBundlePreviewMedia();
}

function loadSelectedDataBundlePreviewMedia() {
  const item = selectedDataBundlePreviewMedia();
  if (!item?.url) return;
  resetDataBundlePreviewMedia();
  let source;
  try {
    source = new URL(String(item.url), window.location.href);
    if (source.origin !== window.location.origin) throw new Error("Media URL must use the Skynet origin.");
  } catch (error) {
    elements.dataBundlePreviewMediaEmpty.textContent = `Unable to load media: ${error.message}`;
    elements.dataBundlePreviewMediaEmpty.hidden = false;
    return;
  }

  const mimeType = String(item.mime_type || "").toLowerCase();
  const kind = String(item.kind || mimeType.split("/")[0] || "file").toLowerCase();
  let media;
  if (kind === "video" || mimeType.startsWith("video/")) {
  ...
  } else if (kind === "audio" || mimeType.startsWith("audio/")) {
    ...
    media.alt = item.relative_path ? `Dataset sample ${item.relative_path}` : "Dataset sample image";
  } else {
    media = document.createElement("a");
    media.className = "button";
    media.textContent = "Open media";
    media.target = "_blank";
    media.rel = "noopener";
  }
  media.addEventListener("error", () => {
    elements.dataBundlePreviewMediaEmpty.textContent = "The selected media could not be loaded.";
    elements.dataBundlePreviewMediaEmpty.hidden = false;
  }, { once: true });
  if (media instanceof HTMLAnchorElement) media.href = source.href;
  else media.src = source.href;
  elements.dataBundlePreviewMediaPlayer.replaceChildren(media);
  elements.dataBundlePreviewMediaPlayer.hidden = false;
  elements.dataBundlePreviewMediaEmpty.hidden = true;
  if (media instanceof HTMLMediaElement) media.load();
}

function renderDataBundlePreviewLoading(bundle, id) {
  const identity = bundle ? `${bundle.name}@${bundle.version}` : id;
  elements.dataBundlePreview.dataset.bundleId = String(id);
  elements.dataBundlePreviewTitle.textContent = `${identity || "Dataset bundle"} preview`;
  elements.dataBundlePreviewStatus.textContent = "Loading immutable dataset metadata...";
  elements.dataBundlePreviewSummary.innerHTML = dataBundlePreviewKeyValueHtml([
    ["Bundle", identity],
    ["Bundle ID", id],
  ]);
  elements.dataBundlePreviewUsage.innerHTML = "";
  elements.dataBundlePreviewRoles.innerHTML = emptyRow(3, "Loading roles...");
  elements.dataBundlePreviewVersions.innerHTML = emptyRow(5, "Loading immutable versions...");
  dataBundlePreviewEmpty(elements.dataBundlePreviewDatasets, "Loading dataset summary...");
  dataBundlePreviewEmpty(elements.dataBundlePreviewTasks, "Loading tasks...");
  dataBundlePreviewEmpty(elements.dataBundlePreviewEpisodes, "Loading episodes...");
  dataBundlePreviewEmpty(elements.dataBundlePreviewFeatures, "Loading features...");
  dataBundlePreviewEmpty(elements.dataBundlePreviewModalities, "Loading modalities...");
  dataBundlePreviewEmpty(elements.dataBundlePreviewSamples, "Loading sample records...");
  elements.dataBundlePreviewWarnings.hidden = true;
  elements.dataBundlePreviewWarnings.innerHTML = "";
  dataBundlePreviewMediaItems = [];
  elements.dataBundlePreviewMediaSelect.innerHTML = '<option value="">Loading media...</option>';
  elements.dataBundlePreviewMediaControls.hidden = true;
  resetDataBundlePreviewMedia();
  elements.dataBundlePreviewMediaEmpty.textContent = "Loading sample media...";
  elements.dataBundlePreviewMediaEmpty.hidden = false;
  elements.dataBundlePreviewMediaMeta.innerHTML = "";
  elements.dataBundlePreviewMediaMeta.hidden = true;
}

function renderDataBundlePreview(payload) {
  const preview = dataBundlePreviewRecord(payload);
  const bundle = preview.bundle && typeof preview.bundle === "object" ? preview.bundle : {};
  const assignments = dataBundlePreviewArray(preview.assignments);
  const identity = [bundle.name, bundle.version].filter(Boolean).join("@");
  elements.dataBundlePreviewTitle.textContent = `${identity || "Dataset bundle"} preview`;
  const inspectionStates = assignments.map((assignment) => assignment.inspection?.status).filter(Boolean);
  const readyCount = inspectionStates.filter((status) => String(status).toLowerCase() === "ready").length;
  elements.dataBundlePreviewStatus.textContent = assignments.length
    ? `${assignments.length} immutable assignment${assignments.length === 1 ? "" : "s"}; ${readyCount} inspected and ready.`
    : "This bundle has no resolved dataset assignments.";
  elements.dataBundlePreviewSummary.innerHTML = dataBundlePreviewKeyValueHtml([
    ["Bundle", identity],
    ["Bundle ID", bundle.id],
    ["Description", bundle.description],
    ["Manifest", bundle.manifest_sha256],
    ["Preview schema", preview.schema_version],
  ]);

  const usage = bundle.usage && typeof bundle.usage === "object" ? bundle.usage : {};
  const training = usage.training && typeof usage.training === "object" ? usage.training : {};
  const evaluation = usage.evaluation && typeof usage.evaluation === "object" ? usage.evaluation : {};
  elements.dataBundlePreviewUsage.innerHTML = dataBundlePreviewKeyValueHtml([
    ["Training data declared", training.declared],
    ["Training assignments", dataBundlePreviewArray(training.assignments).map((item) => `${item.role}[${Number(item.position || 0)}]`)],
    ["Evaluation data declared", evaluation.declared],
    ["Evaluation assignments", dataBundlePreviewArray(evaluation.assignments).map((item) => `${item.role}[${Number(item.position || 0)}]`)],
  ...
  if (!roles.length) {
    ...
    assignments.forEach((assignment) => {
      const role = String(assignment.role || "unassigned");
      counts.set(role, (counts.get(role) || 0) + 1);
    });
    roles = [...counts].map(([role, count]) => ({ role, count }));
  }
  elements.dataBundlePreviewRoles.innerHTML = roles.length
    ? roles.map((role) => `<tr><td><strong>${escapeHtml(role.role || "unassigned")}</strong></td><td>${escapeHtml(role.intended_use || "-")}</td><td>${escapeHtml(role.count ?? "-")}</td></tr>`).join("")
    : emptyRow(3, "No bundle roles were returned.");
  ...
  elements.dataBundlePreviewVersions.innerHTML = assignments.length
    ? assignments.map((assignment) => {
      ...
      return `<tr>
        <td><strong>${escapeHtml(dataBundlePreviewAssignmentLabel(assignment))}</strong><span class="secondary">${escapeHtml(version.id || "-")}</span></td>
        <td><span class="node-name">${escapeHtml(resourceName)}</span><span class="secondary">${escapeHtml(version.revision || "-")}</span></td>
        <td>${escapeHtml(version.format || assignment.dataset?.format || "-")}<span class="secondary">${escapeHtml(version.status || "-")}</span></td>
        <td>${escapeHtml(version.size_bytes == null ? "-" : formatDataBytes(version.size_bytes))}<span class="secondary">${escapeHtml(assignment.mount_path || "No mount override")}</span></td>
        <td>${escapeHtml(assignment.required === false ? "No" : "Yes")}</td>
      </tr>`;
    }).join("")
    : emptyRow(5, "No immutable versions were returned.");

  elements.dataBundlePreviewDatasets.innerHTML = assignments.length
    ? assignments.map((assignment) => {
      const dataset = assignment.dataset && typeof assignment.dataset === "object" ? assignment.dataset : {};
      const summary = dataset.summary && typeof dataset.summary === "object" ? dataset.summary : {};
      const inspection = assignment.inspection && typeof assignment.inspection === "object" ? assignment.inspection : {};
      return `<article class="dataset-preview-summary-card">
        <h4>${escapeHtml(dataBundlePreviewAssignmentLabel(assignment))}</h4>
        <div class="key-value-grid">${dataBundlePreviewKeyValueHtml([
          ["Format", assignment.version?.format],
          ["Robot type", summary.robot_type],
          ["FPS", summary.fps],
          ["Tasks", summary.total_tasks],
          ["Episodes", summary.total_episodes],
          ["Frames", summary.total_frames],
          ["Inspection", inspection.status],
          ["Metadata source", inspection.metadata_source],
        ])}</div>
      </article>`;
    }).join("")
    : '<p class="secondary dataset-preview-empty">No dataset summary was returned.</p>';

  const taskRows = assignments.flatMap((assignment) => dataBundlePreviewArray(assignment.dataset?.tasks).map((task) => ({ assignment, task })));
  elements.dataBundlePreviewTasks.innerHTML = taskRows.length
    ? taskRows.map(({ assignment, task }) => {
      const record = task && typeof task === "object" ? task : { name: task };
      return `<div class="dataset-preview-item"><strong>${escapeHtml(dataBundlePreviewAssignmentLabel(assignment))}</strong><span>${escapeHtml(record.name || record.task || "Unnamed task")}${record.index == null ? "" : ` (#${escapeHtml(record.index)})`}</span></div>`;
    }).join("")
    : '<p class="secondary dataset-preview-empty">No task metadata was returned.</p>';

  const episodeRows = assignments.flatMap((assignment) => dataBundlePreviewArray(assignment.dataset?.episodes).map((episode) => ({ assignment, episode })));
  elements.dataBundlePreviewEpisodes.innerHTML = episodeRows.length
    ? episodeRows.map(({ assignment, episode }) => {
      const record = episode && typeof episode === "object" ? episode : { index: episode };
      const detail = [
  ...
  const featureRows = assignments.flatMap((assignment) => dataBundlePreviewFeatures(assignment.dataset).map((feature) => ({ assignment, feature })));
  elements.dataBundlePreviewFeatures.innerHTML = featureRows.length
    ? featureRows.map(({ assignment, feature }) => {
      const detail = [feature.modality, feature.dtype, feature.shape ? dataBundlePreviewDisplay(feature.shape) : null].filter(Boolean).join(" / ") || dataBundlePreviewDisplay(feature.value);
      return `<div class="dataset-preview-item"><strong>${escapeHtml(feature.name || "Unnamed feature")}</strong><span>${escapeHtml(dataBundlePreviewAssignmentLabel(assignment))} / ${escapeHtml(detail)}</span></div>`;
    }).join("")
    : '<p class="secondary dataset-preview-empty">No feature schema was returned.</p>';

  const modalityRows = assignments.map((assignment) => {
    const dataset = assignment.dataset && typeof assignment.dataset === "object" ? assignment.dataset : {};
    const explicit = Array.isArray(dataset.modalities)
      ? dataset.modalities.map((item) => dataBundlePreviewDisplay(item))
      : dataset.modalities && typeof dataset.modalities === "object"
        ? Object.keys(dataset.modalities)
        : [];
    const derived = dataBundlePreviewFeatures(dataset).map((feature) => feature.modality).filter(Boolean);
    return { assignment, modalities: [...new Set([...explicit, ...derived])] };
  }).filter((item) => item.modalities.length);
  elements.dataBundlePreviewModalities.innerHTML = modalityRows.length
    ? modalityRows.map(({ assignment, modalities }) => `<div class="dataset-preview-item"><strong>${escapeHtml(dataBundlePreviewAssignmentLabel(assignment))}</strong><span>${escapeHtml(modalities.join(", "))}</span></div>`).join("")
    : '<p class="secondary dataset-preview-empty">No modality metadata was returned.</p>';

  const sampleRows = assignments.flatMap((assignment) => {
    const records = dataBundlePreviewArray(assignment.sample_records);
    if (records.length) return records.map((sample) => ({ assignment, sample, record: true }));
    return dataBundlePreviewArray(assignment.sample_files).map((sample) => ({ assignment, sample, record: false }));
  });
  elements.dataBundlePreviewSamples.innerHTML = sampleRows.length
    ? sampleRows.map(({ assignment, sample, record }) => {
      const heading = sample?.relative_path || sample?.path || sample?.id || `${record ? "record" : "file"} sample`;
      return `<article class="dataset-preview-item dataset-preview-record"><strong>${escapeHtml(`${dataBundlePreviewAssignmentLabel(assignment)} / ${heading}`)}</strong><pre class="result-view dataset-preview-json"><code>${escapeHtml(JSON.stringify(sample, null, 2))}</code></pre></article>`;
    }).join("")
    : '<p class="secondary dataset-preview-empty">No sample records or files were returned.</p>';

  const previousMediaSelection = elements.dataBundlePreviewMediaSelect.value;
  dataBundlePreviewMediaItems = assignments.flatMap((assignment) => dataBundlePreviewArray(assignment.sample_media).map((item, index) => ({
    ...item,
    _assignmentLabel: dataBundlePreviewAssignmentLabel(assignment),
    _previewKey: `${dataBundlePreviewAssignmentLabel(assignment)}:${item.relative_path || item.url || index}`,
  }))).filter((item) => item.url);
  elements.dataBundlePreviewMediaSelect.innerHTML = dataBundlePreviewMediaItems
    .map((item) => `<option value="${escapeHtml(item._previewKey)}">${escapeHtml(`${item._assignmentLabel} / ${item.relative_path || item.kind || "media"}`)}</option>`)
    .join("");
  if (dataBundlePreviewMediaItems.some((item) => item._previewKey === previousMediaSelection)) {
    elements.dataBundlePreviewMediaSelect.value = previousMediaSelection;
  } else if (dataBundlePreviewMediaItems.length) {
    elements.dataBundlePreviewMediaSelect.value = dataBundlePreviewMediaItems[0]._previewKey;
  }
  elements.dataBundlePreviewMediaControls.hidden = !dataBundlePreviewMediaItems.length;
  updateDataBundlePreviewMediaSelection();

  const warnings = dataBundlePreviewArray(preview.warnings).map((warning) => dataBundlePreviewDisplay(warning));
  assignments.forEach((assignment) => {
    const inspection = assignment.inspection && typeof assignment.inspection === "object" ? assignment.inspection : {};
    if (inspection.status && String(inspection.status).toLowerCase() !== "ready" && !(inspection.warnings || []).length) {
      warnings.push(`${dataBundlePreviewAssignmentLabel(assignment)} inspection: ${inspection.status}`);
    }
    dataBundlePreviewArray(inspection.warnings).forEach((warning) => {
      warnings.push(`${dataBundlePreviewAssignmentLabel(assignment)}: ${dataBundlePreviewDisplay(warning)}`);
    });
    const dataset = assignment.dataset && typeof assignment.dataset === "object" ? assignment.dataset : {};
    if (dataset.tasks_truncated) {
      const shown = dataBundlePreviewArray(dataset.tasks).length;
      const total = dataset.summary?.total_tasks;
      warnings.push(`${dataBundlePreviewAssignmentLabel(assignment)}: showing ${shown}${total == null ? "" : ` of ${total}`} tasks.`);
    }
    if (dataset.episodes_truncated) {
      const shown = dataBundlePreviewArray(dataset.episodes).length;
      const total = dataset.summary?.total_episodes;
      warnings.push(`${dataBundlePreviewAssignmentLabel(assignment)}: showing ${shown}${total == null ? "" : ` of ${total}`} episodes; the full dataset is unchanged.`);
    }
  });
  elements.dataBundlePreviewWarnings.innerHTML = warnings.length
    ? `<strong>Preview warnings</strong><ul>${[...new Set(warnings)].map((warning) => `<li>${escapeHtml(warning)}</li>`).join("")}</ul>`
    : "";
  elements.dataBundlePreviewWarnings.hidden = !warnings.length;
}

async function viewDataBundlePreview(id, launcher = null) {
  const revealLauncher = launcher || currentRevealLauncher();
  const requestToken = disclosureToken(elements.dataBundlePreview, revealLauncher);
  const bundle = dataBundleRows.find((candidate) => String(candidate.id || candidate.bundle_id) === String(id));
  const cached = dataBundlePreviewCache.get(String(id));
  if (cached) renderDataBundlePreview(cached);
  else renderDataBundlePreviewLoading(bundle, id);
  revealPanel(elements.dataBundlePreview, {
    focusTarget: elements.dataBundlePreviewTitle,
    launcher: revealLauncher,
    scroll: false,
  });
  if (cached) return;
  try {
    const payload = await api(`/api/data/bundles/${encodeURIComponent(id)}/preview`);
    if (!disclosureTokenIsCurrent(elements.dataBundlePreview, requestToken)) return;
    dataBundlePreviewCache.set(String(id), payload);
    renderDataBundlePreview(payload);
  } catch (error) {
    if (!disclosureTokenIsCurrent(elements.dataBundlePreview, requestToken)) return;
    elements.dataBundlePreviewStatus.textContent = `Preview unavailable: ${error.message}`;
    elements.dataBundlePreviewWarnings.innerHTML = `<strong>Preview failed</strong><p>${escapeHtml(error.message)}</p>`;
...
async function loadDataRegistry(force = false) {
  ...
  if (force) dataBundlePreviewCache.clear();
  ...
  try {
    ...
    const details = await Promise.all(resources.map(async (resource) => {
    ...
    elements.dataBundlesBody.innerHTML = emptyRow(5, "Dataset registry could not be loaded.");
    showNotice(elements.dataRegistryError, `Dataset Registry API unavailable: ${error.message}`);
  } finally {
    if (generation === dataRegistryGeneration) elements.refreshDataRegistry.disabled = false;
  }
}
...
function selectDataResourceForVersion(id, launcher = null) {
  ...
  if (!resource) {
    ...
    showToast("The selected resource is not in the current registry snapshot.", true);
    return;
  }
  elements.dataVersionForm.reset();
  elements.dataVersionResourceId.value = id;
  elements.dataVersionResourceLabel.textContent = dataResourceIdentity(resource);
  elements.dataVersionStatus.value = "READY";
  revealPanel(elements.dataVersionForm, { focusTarget: elements.dataVersionRevision, launcher });
}
...
async function createDataVersion(event) {
  ...
  try {
    ...
    await api(`/api/data/resources/${encodeURIComponent(resourceId)}/versions`, {
      method: "POST",
      body: JSON.stringify({
        ...
        manifest_sha256: elements.dataVersionManifest.value.trim().toLowerCase(),
...
async function createDataDerivation(event) {
  ...
  let converterConfig;
  try {
    inputs = parseDataJson(elements.dataDerivationInputs, "Derivation inputs", []);
    converterConfig = parseDataJson(elements.dataConverterConfig, "Converter config", {});
    if (!Array.isArray(inputs) || !inputs.length) throw new Error("Derivation inputs must be a non-empty JSON list.");
    if (!converterConfig || Array.isArray(converterConfig) || typeof converterConfig !== "object") throw new Error("Converter config must be a JSON object.");
  } catch (error) {
    showToast(error.message, true);
    return;
  }
  ...
  try {
    await api("/api/data/derivations", {
      ...
      body: JSON.stringify({
        ...
        runtime_lock_sha256: elements.dataRuntimeLockSha.value.trim().toLowerCase() || null,
      }),
      });
      showToast("Dataset derivation lineage recorded.");
      elements.showDataDerivationForm.textContent = "Record a derivation";
      hideRevealedPanel(elements.dataDerivationForm, elements.showDataDerivationForm);
...
function addDataBundleAssignment() {
  ...
  if (mountPath && (/[\\:\x00-\x1f]/.test(mountPath) || mountPath.split("/").some(part => ["", ".", ".."].includes(part)))) {
    showToast("Mount path must be a relative directory without empty, '.' or '..' components.", true);
    document.querySelector("#data-bundle-mount-picker").focus();
    return;
  }
  try {
    ...
    const version = dataVersionRows.find(item => String(item.id || item.version_id) === versionId);
    const location = (version?.locations || []).find(item => item.kind === "cluster" && item.status === "AVAILABLE");
    assignments.push({ role, version_id: versionId, ...(location ? { config: { location_id: location.id } } : {}), mount_path: mountPath || `data/${role}/${positions.length}`, required: true, position: positions.length ? Math.max(...positions) + 1 : 0 });
...
async function createDataBundle(event) {
  ...
  let assignments;
  try {
    assignments = parseDataJson(elements.dataBundleAssignments, "Bundle assignments", []);
    if (!Array.isArray(assignments) || !assignments.length) throw new Error("Bundle assignments must be a non-empty JSON list.");
  } catch (error) {
    showToast(error.message, true);
    return;
  }
  elements.createDataBundle.disabled = true;
  try {
    await api("/api/data/bundles", {
      method: "POST",
      body: JSON.stringify({
        name: elements.dataBundleName.value.trim(),
        version: elements.dataBundleVersion.value.trim(),
        description: elements.dataBundleDescription.value.trim(),
        assignments,
      }),
      });
      showToast("Immutable data bundle created.");
      elements.showDataBundleForm.textContent = "Create an immutable bundle";
      hideRevealedPanel(elements.dataBundleForm, elements.showDataBundleForm);
      elements.dataBundleForm.reset();
    await loadDataRegistry(true);
  } catch (error) {
    showToast(`Bundle creation failed: ${error.message}`, true);
  } finally {
    elements.createDataBundle.disabled = false;
  }
}

const COLLECTION_ADAPTER_SCHEMA = "skynet.collection-adapter/v1";
const collectionPrepareStates = new Set(["DRAFT", "PREFLIGHTED", "PREFLIGHT_FAILED", "READY"]);
const collectionSubmittedStates = new Set(["SUBMITTED", "PENDING", "RUNNING", "CAPTURED", "COMPLETED", "FAILED", "CANCELLED"]);
...
function collectionAdapterManifest(adapter) {
  ...
  if (typeof raw === "string") {
    try {
      ...
      return { __parse_error: `Invalid collection adapter manifest JSON: ${error.message}` };
    }
  }
  if (!raw || typeof raw !== "object" || Array.isArray(raw)) {
    return { __parse_error: "Collection adapter manifest must be a JSON object." };
  }
  return raw;
}
...
function collectionAdapterIdentity(adapter) {
  ...
  return manifest.display_name || adapter?.display_name || manifest.key || adapter?.adapter_key || "Unnamed adapter";
}
...
function collectionDefaultAdapterManifest() {
  return {
    ...
    runnable: false,
    streams: [
      { name: "action", kind: "action", shape: null, dtype: "float32", units: null, frame: null, rate_hz: null, native_key: "action", required: true, metadata: {} },
      { name: "proprio", kind: "proprio", shape: null, dtype: "float32", units: null, frame: null, rate_hz: null, native_key: "observation.proprio", required: true, metadata: {} },
      { name: "sensor", kind: "sensor", shape: null, dtype: "uint8", units: null, frame: null, rate_hz: null, native_key: "observation.sensor", required: false, metadata: {} },
    ],
    requirements: [],
    launcher: { environment: {}, steps: [] },
    capabilities: [],
    defaults: {},
    todos: ["Resolve native stream shapes, semantics, and launcher before marking this adapter runnable."],
    metadata: {},
  };
}
...
function populateCollectionAdapterSelect(selectedId = "") {
  const active = collectionAdapterRows.filter((adapter) => !adapter.archived_at);
  elements.collectionSessionAdapter.innerHTML = active.length
    ? `<option value="">Select a runnable adapter</option>${active.map((adapter) => {
      const manifest = collectionAdapterManifest(adapter);
  ...
  if (normalizedSelection && active.some((adapter) => String(adapter.id || adapter.adapter_id) === normalizedSelection)) {
    ...
    elements.collectionSessionAdapter.insertAdjacentHTML("afterbegin", `<option value="${escapeHtml(normalizedSelection)}" disabled>${escapeHtml(message)}</option>`);
    elements.collectionSessionAdapter.value = normalizedSelection;
...
function updateCollectionCapabilityEvidence(force = false) {
  ...
  elements.createCollectionSession.disabled = !runnable || elements.collectionSessionForm.dataset.submitting === "true";
...
function renderCollectionAdapters() {
  ...
  elements.collectionAdaptersBody.innerHTML = collectionAdapterRows.length
    ? collectionAdapterRows.map((adapter) => {
      const manifest = collectionAdapterManifest(adapter);
      const streams = Array.isArray(manifest.streams) ? manifest.streams : [];
      const streamSummary = streams.length
        ? streams.map((stream) => `${stream.kind || "stream"}:${stream.name || stream.native_key || "unnamed"}${Array.isArray(stream.shape) ? ` [${stream.shape.join("x")}]` : " [?]"}`).join(", ")
        : "No streams declared";
      const id = adapter.id || adapter.adapter_id;
...
function collectionSessionAdapterName(session) {
  ...
  const match = collectionAdapterRows.find((adapter) => String(adapter.id || adapter.adapter_id) === String(session.adapter_id));
  return snapshot.display_name || snapshot.manifest?.display_name || (match ? collectionAdapterIdentity(match) : session.adapter_id || "-");
}
...
function renderCollectionSessions() {
  ...
  elements.collectionSessionsBody.innerHTML = collectionSessionRows.length
    ? collectionSessionRows.map((session) => {
...
function fillCollectionAdapterForm(adapter = null, launcher = null) {
  ...
  elements.collectionAdapterName.value = manifest.display_name || adapter?.display_name || "";
  ...
  elements.collectionAdapterDescription.value = manifest.description || adapter?.description || "";
  elements.collectionAdapterStreams.value = collectionPretty(manifest.streams || []);
  elements.collectionAdapterRequirements.value = collectionPretty(manifest.requirements || []);
  elements.collectionAdapterLauncher.value = collectionPretty(manifest.launcher || { environment: {}, steps: [] });
  elements.collectionAdapterCapabilities.value = collectionPretty(manifest.capabilities || []);
  elements.collectionAdapterDefaults.value = collectionPretty(manifest.defaults || {});
  elements.collectionAdapterTodos.value = collectionPretty(manifest.todos || []);
  elements.collectionAdapterMetadata.value = collectionPretty(manifest.metadata || {});
  elements.collectionAdapterEditorTitle.textContent = adapter ? `Edit ${collectionAdapterIdentity(adapter)}` : "New collection adapter";
  revealPanel(elements.collectionAdapterForm, { focusTarget: adapter ? elements.collectionAdapterName : elements.collectionAdapterKey, launcher });
}

async function openCollectionAdapter(id, launcher = null) {
  const revealLauncher = launcher || currentRevealLauncher();
  const requestToken = disclosureToken(elements.collectionAdapterForm, revealLauncher);
  try {
    const payload = await api(`/api/collection/adapters/${encodeURIComponent(id)}`);
    if (!disclosureTokenIsCurrent(elements.collectionAdapterForm, requestToken)) return;
...
async function saveCollectionAdapter(event) {
  ...
  try {
    manifest = {
      ...
      streams: collectionParseArray(elements.collectionAdapterStreams, "Streams"),
      requirements: collectionParseArray(elements.collectionAdapterRequirements, "Requirements"),
      launcher: collectionParseObject(elements.collectionAdapterLauncher, "Launcher"),
      capabilities: collectionParseArray(elements.collectionAdapterCapabilities, "Capability declarations"),
      defaults: collectionParseObject(elements.collectionAdapterDefaults, "Defaults"),
      todos: collectionParseArray(elements.collectionAdapterTodos, "TODOs"),
      metadata: collectionParseObject(elements.collectionAdapterMetadata, "Metadata"),
    };
  } catch (error) {
  ...
  try {
    await api(id ? `/api/collection/adapters/${encodeURIComponent(id)}` : "/api/collection/adapters", {
      method: id ? "PUT" : "POST",
      body: JSON.stringify(manifest),
      });
      showToast(`Collection adapter ${id ? "updated" : "created"}.`, false, { scope });
...
async function setCollectionAdapterArchived(id, archived) {
  ...
  try {
    if (archived) {
      ...
      await api(`/api/collection/adapters/${encodeURIComponent(id)}/restore`, { method: "POST" });
    }
    showToast(`Collection adapter ${archived ? "archived" : "restored"}.`);
    loadedTabs.delete("collection");
    await loadCollection(true);
  } catch (error) {
    showToast(`Adapter ${archived ? "archive" : "restore"} failed: ${error.message}`, true);
  }
}

function updateCollectionRegistrationFields() {
  const enabled = elements.collectionRegisterOutput.checked;
  document.querySelectorAll(".collection-registration-field input").forEach((input) => {
...
async function createCollectionSession(event) {
  ...
  let capabilities;
  try {
    config = collectionParseObject(elements.collectionConfig, "Additional config");
    software = collectionParseObject(elements.collectionSoftware, "Software");
    calibrationMetadata = collectionParseObject(elements.collectionCalibrationMetadata, "Calibration metadata");
    storageMetadata = collectionParseObject(elements.collectionStorageMetadata, "Storage metadata");
    captureMetadata = collectionParseObject(elements.collectionCaptureMetadata, "Capture metadata");
    capabilities = collectionParseObject(elements.collectionCapabilities, "Capability evidence");
  } catch (error) {
    showToast(error.message, true);
    return;
  }
  ...
  try {
    const result = await api("/api/collection/sessions", { method: "POST", body: JSON.stringify(payload) });
    ...
    await loadCollection(true);
    const id = session.id || session.session_id;
    const launcher = [...elements.collectionSessionsBody.querySelectorAll("[data-collection-session-action=view]")]
      .find(button => button.dataset.id === id);
    if (launcher) toggleDisclosure(elements.collectionSessionDetail, `collection-session:${id}`, launcher, {rowOwned: true});
...
function renderCollectionLifecycleActions(session) {
  ...
  if (state === "READY") buttons.push(collectionActionButton("submit", "Submit", "button-accent"));
  ...
  if (["SUBMITTED", "PENDING", "RUNNING"].includes(state)) buttons.push(collectionActionButton("cancel", "Cancel"));
  if (!["COMPLETED", "FAILED", "CANCELLED"].includes(state)) buttons.push(collectionActionButton("fail", "Record failure"));
  if (collectionTerminalStates.has(state)) buttons.push(collectionActionButton("restart", "Restart as new"));
...
function renderCollectionSessionDetail(session, launcher = null) {
  ...
  const context = collectionSessionContext(session);
  const storage = session.storage_snapshot || {};
  elements.collectionSessionDetailTitle.textContent = session.name || `Collection ${shortId(id)}`;
  ...
  ].map(([label, value]) => `<div class="key-value"><span>${escapeHtml(label)}</span><strong>${escapeHtml(value)}</strong></div>`).join("");
  renderCollectionLifecycleActions(session);

  const registered = session.registered_resource_id || session.registered_version_id;
  ...
  elements.collectionCompleteForm.querySelector("button[type=submit]").textContent = storage.registration
    ? "Complete and register native data" : "Complete without registration";
  elements.collectionCompleteManifest.value = "";
  elements.collectionCompleteRevision.value = "";
  elements.collectionCompleteSize.value = "";
  elements.collectionLoadStdout.disabled = !collectionSubmittedStates.has(state);
  elements.collectionLoadStderr.disabled = !collectionSubmittedStates.has(state);
  elements.collectionLogStatus.textContent = collectionSubmittedStates.has(state) ? "Select a stream" : "Logs available after submission";
  updateLogView(elements.collectionSessionLog, "No log loaded.");
  updateLogView(elements.collectionSessionError, session.error ? collectionPretty(session.error) : "No error recorded.");
  updateLogView(elements.collectionSessionResult, collectionPretty({
    status: session.status,
  ...
  elements.collectionEventsBody.innerHTML = events.length ? events.map((item) => `<tr>
  ...
  </tr>`).join("") : emptyRow(4, "No lifecycle events recorded.");
  revealPanel(elements.collectionSessionDetail, { focusTarget: elements.collectionSessionDetailTitle, launcher });
}

async function viewCollectionSession(id, launcher = null) {
  const revealLauncher = launcher || currentRevealLauncher();
  const requestToken = disclosureToken(elements.collectionSessionDetail, revealLauncher);
  try {
    const payload = await api(`/api/collection/sessions/${encodeURIComponent(id)}`);
    if (!disclosureTokenIsCurrent(elements.collectionSessionDetail, requestToken)) return;
    renderCollectionSessionDetail(entityFrom(payload, "session"), revealLauncher);
  } catch (error) {
    if (!disclosureTokenIsCurrent(elements.collectionSessionDetail, requestToken)) return;
...
async function runCollectionLifecycleAction(action) {
  ...
  try {
    ...
    if (action === "restart") {
      ...
      updateLogView(elements.collectionSessionResult, typeof result === "string" ? result : collectionPretty(result));
      loadedTabs.delete("collection");
      await loadCollection(true);
    }
...
async function loadCollectionLog(stream) {
  ...
  try {
    const result = await api(`/api/collection/sessions/${encodeURIComponent(id)}/logs?stream=${encodeURIComponent(stream)}&lines=500`);
    if ((activeCollectionSession?.id || activeCollectionSession?.session_id) !== id) return;
    if (!updateLogView(elements.collectionSessionLog, typeof result === "string" ? result : collectionPretty(result), { generation })) return;
    elements.collectionLogStatus.textContent = `${stream}, last 500 lines`;
  } catch (error) {
    if ((activeCollectionSession?.id || activeCollectionSession?.session_id) !== id) return;
    if (!updateLogView(elements.collectionSessionLog, error.message, { generation })) return;
...
async function completeCollectionSession(event) {
  ...
  if (!activeCollectionSession || !elements.collectionCompleteForm.reportValidity()) return;
  const id = activeCollectionSession.id || activeCollectionSession.session_id;
  const button = elements.collectionCompleteForm.querySelector("button[type=submit]");
  elements.collectionCompleteForm.dataset.submitting = "true";
  button.disabled = true;
  try {
    const size = numberOrNull(elements.collectionCompleteSize);
    const result = await api(`/api/collection/sessions/${encodeURIComponent(id)}/complete`, {
      method: "POST",
      body: JSON.stringify({
        manifest_sha256: elements.collectionCompleteManifest.value.trim().toLowerCase(),
    ...
    showToast(result.registered ? "Native capture completed and registered." : "Native capture completed without registration.");
  } catch (error) {
...
const tutorialTours = {
  experiments: {
    title: "Experiments",
    steps: [
      { selector: "#experiments-body", title: "Review existing experiments", instruction: "Start with the saved drafts and submitted experiments. Row actions appear only when records exist; this tour never opens Submit." },
      { selector: "#experiment-name", title: "Name the experiment", instruction: "Use a unique, meaningful name. Naming does not save anything until you choose a save or submit action yourself." },
      { selector: "#experiment-adapter", title: "Choose the code adapter", instruction: "Select only an adapter returned by the registry. It defines repository matching, runtime detection, commands, and parameter mappings." },
      { selector: "#experiment-source", title: "Select the repository", instruction: "Enter the real repository URL or configured source. Do not invent a repository or place credentials in this field." },
      { selector: "#experiment-branch", title: "Choose a returned branch", instruction: "Branches are loaded from the repository. Pick one of the returned values before choosing an exact commit." },
      { selector: "#experiment-revision", title: "Pin the exact commit", instruction: "The revision makes the source reproducible. Use a commit returned by inspection rather than a moving branch name." },
      { selector: "#experiment-runtime", title: "Confirm the detected runtime", instruction: "Choose a runnable runtime candidate based on repository evidence. If none is available, resolve the adapter or runtime profile first." },
      { selector: "#experiment-data-bundle", title: "Pin the data bundle", instruction: "A bundle fixes exact data versions and their roles. Select only a registered bundle compatible with this experiment." },
      { selector: "#hp-learning-rate", title: "Set common hyperparameters", instruction: "Start with small, deliberate values. Nearby fields cover batch size, gradient accumulation, workers, precision, and maximum steps." },
      { selector: "#resource-policy", title: "Choose resource policy", instruction: "Auto mode lets the service select one compatible node and GPU type. Manual choices should reflect current cluster availability." },
      { selector: "#checkpoint-save-steps", title: "Define checkpoint behavior", instruction: "Set a save interval and review auto-resume and retention. A short smoke run should use a small maximum step count and time limit." },
      { selector: "#sweep-definition", title: "Describe variants", instruction: "Leave this blank for one run, or use a small JSON sweep such as a seed list. Large sweeps multiply cluster work." },
      { selector: "#mlflow-enabled", title: "Enable tracking only when configured", instruction: "MLflow is optional. Turn it on only when the tracking URI and experiment are known and accessible." },
      { selector: "#evaluation-enabled", title: "Attach downstream evaluation", instruction: "Enable evaluation only when a compatible registered suite is available. This records intent in the experiment snapshot." },
      { selector: "#experiment-preview-button", title: "Preview before any mutation", instruction: "Preview the canonical spec and sbatch manually, then inspect every path and command. The tutorial stops before Save and Submit; use those controls yourself only after review." },
    ],
  },
  datasets: {
    title: "Datasets",
    steps: [
      { selector: "#data-resources-body", title: "Resources are named data items", instruction: "Browse registered datasets, simulator assets, and other sources here. Exact contents live in immutable versions." },
      { selector: "#data-resource-provider", title: "Describe a missing source", instruction: "Normal imports register resources automatically. This manual form needs the real provider, owner, name, kind, and purpose.", reveal: ["#data-resource-form"] },
      { selector: "#data-versions-body", title: "Versions pin exact contents", instruction: "Each version identifies one unchanged set of files, revision, format, path, and inventory hash." },
      { selector: "#data-version-revision", title: "Publish only verified files", instruction: "Use the actual upstream revision, existing canonical path, computed SHA-256, and READY state only after inventory verification. This form is normally opened from a resource row.", reveal: ["#data-version-form"] },
      { selector: "#data-derivations-body", title: "Read processing receipts", instruction: "Derivation rows show which immutable inputs and converter produced each processed output." },
      { selector: "#data-derivation-inputs", title: "Pin every derivation input", instruction: "List real version IDs and their roles. Conversion workflows normally record this receipt automatically.", reveal: ["#data-derivation-form"] },
      { selector: "#data-converter-commit", title: "Pin the converter", instruction: "Record the exact converter repository and commit so the processed output can be reproduced." },
      { selector: "#data-bundles-body", title: "Bundles are saved job data lists", instruction: "A bundle groups exact versions for a job. Each role explains how that version is used." },
      { selector: "#data-bundle-assignments", title: "Assign exact versions and roles", instruction: "Use actual version IDs, roles, mount paths, and required flags. Bundle identity is immutable once created.", reveal: ["#data-bundle-form"] },
      { selector: "#create-data-bundle", title: "Stop before creating records", instruction: "This button writes a canonical bundle. The tutorial does not press it, or any resource, version, or derivation create button. Exit and create manually only after checking the data." },
    ],
  },
  collection: {
    title: "Collection",
    steps: [
      { selector: "#collection-adapters-body", title: "Start with collection adapters", instruction: "Adapters declare native action, proprioceptive, and sensor streams plus setup and launch requirements. Archived entries remain readable." },
      { selector: "#add-collection-adapter", title: "Open an unsaved adapter", instruction: "This only opens a local editor. The tutorial reveals the same editor without saving, archiving, restoring, or cloning anything." },
      { selector: "#collection-adapter-streams", title: "Declare native streams", instruction: "Describe each source key, kind, shape, data type, units, frame, rate, and whether it is required. Raw capture stays in this representation.", reveal: ["#collection-adapter-form"] },
      { selector: "#collection-adapter-capabilities", title: "Declare external requirements", instruction: "List host, compute, client, network, or operator capabilities. Unknown and administrator-required states should remain explicit." },
      { selector: "#collection-sessions-body", title: "Review immutable sessions", instruction: "Existing sessions preserve their adapter, setup, sbatch, job identity, native output, events, and registration result." },
      { selector: "#collection-session-adapter", title: "Choose a runnable adapter", instruction: "Only runnable adapters returned by the API can start a draft. An unresolved adapter remains visible in the registry but unavailable here." },
      { selector: "#collection-session-operator", title: "Record collection context", instruction: "Enter the real operator. The nearby task and embodiment fields become part of the immutable config snapshot." },
      { selector: "#collection-output-path", title: "Choose native staging storage", instruction: "Use a new path under the collection staging area and state the adapter-native format. Completion registers this exact output without conversion." },
      { selector: "#collection-calibration-sha", title: "Pin real calibration", instruction: "Record the calibration identity and its exact 64-character SHA-256. Never fabricate this digest or paste credentials." },
      { selector: "#collection-capture-schema-name", title: "Describe the capture clock and schema", instruction: "Name and version the native schema, then record its clock, nominal rate, timestamp unit, and whether timestamps are present." },
      { selector: "#collection-alignment", title: "State temporal alignment", instruction: "Say whether actions precede post-state, observations precede actions, streams are synchronous, or the adapter defines alignment." },
      { selector: "#collection-capabilities", title: "Record evidence honestly", instruction: "Leave evidence unknown unless it was independently checked. Verified evidence must include who checked it and when; administrator-required items stay explicit." },
      { selector: "#collection-account", title: "Review Slurm allocation", instruction: "Auto gateway with rl2-lab account and partition is the normal default. Do not pin a node unless there is a specific reason." },
      { selector: "#create-collection-session", title: "Stop before creating the draft", instruction: "This button writes an immutable DRAFT session. The tutorial does not press it and never preflights, prepares, submits, cancels, restarts, fails, completes, or archives anything. Exit and proceed manually." },
    ],
  },
  runs: {
    title: "Training Runs",
    steps: [
      { selector: "#run-search", title: "Find a run", instruction: "Filter by experiment, variant, run ID, or Slurm job without changing any run state." },
      { selector: "#run-status-filter", title: "Narrow by status", instruction: "Use the status filter to focus on failures, running jobs, or completed work. Filtering is local and read-only." },
      { selector: "#runs-body", title: "Read the Training Run ledger", instruction: "Rows summarize state, Slurm identity, allocation, attempts, progress, and update time. View actions appear only when rows exist." },
      { selector: "#run-detail-meta", title: "Inspect the immutable run detail", instruction: "A row's View action normally fills this panel, where Start evaluation opens Evaluations with the run ID prefilled. The tutorial reveals it without selecting a record or calling the API.", reveal: ["#run-detail"] },
      { selector: "#run-attempt-stderr-log", title: "Diagnose before retrying", instruction: "The latest attempt opens automatically. Select another attempt to inspect its stdout and stderr before acting. The tutorial never presses Resume, Retry, Cancel, or any control that can submit Slurm work." },
    ],
  },
  evaluations: {
    title: "Evaluations",
    steps: [
      ...
      { selector: "#evaluation-episodes", title: "Start with a small evaluation", instruction: "Use one episode for a smoke check, then increase episode count only after the evaluator works." },
      { selector: "#evaluation-seeds", title: "Make randomness explicit", instruction: "Enter deliberate seeds, such as 0 for a smoke check, so evaluation can be repeated." },
      { selector: "#evaluation-parallelism", title: "Limit parallel work", instruction: "Start with parallelism 1 and headless mode. Increase only when the environment and cluster allocation support it." },
      { selector: "#evaluation-auto-resume", title: "Plan failure recovery", instruction: "Auto-resume and maximum automatic attempts control recovery. Keep command overrides blank unless the evaluator contract requires them." },
      { selector: "#submit-evaluation", title: "Stop before submission", instruction: "This button creates runnable evaluation state. The tutorial never presses it. Exit, review the complete request, and submit manually only when ready." },
    ],
  },
  adapters: {
    title: "Adapters",
    steps: [
      { selector: "#adapters-body", title: "Review versioned adapters", instruction: "Adapters hold repository matching, runtime detection, commands, mappings, checkpoints, and evaluators. Row actions are record-dependent." },
      { selector: "#add-adapter", title: "Open an unsaved editor", instruction: "This normally starts a local draft. The tutorial reveals the editor without creating, cloning, archiving, or restoring a record." },
      { selector: "#adapter-editor-slug", title: "Set stable adapter identity", instruction: "Use a stable slug and clear name. Existing adapter keys and referenced versions remain immutable.", reveal: ["#adapter-editor"] },
      { selector: "#adapter-manifest", title: "Edit the canonical manifest", instruction: "Keep detection, runtime, launcher, and parameter declarations sourced from the real repository. Never paste secrets or invent executable commands." },
      { selector: "#adapter-validation-repository", title: "Pin validation source", instruction: "Use the actual HTTPS repository and exact commit. Repository inspection is optional and should be run only with explicit consent." },
      { selector: "#validate-adapter", title: "Validation is an explicit action", instruction: "Validation contacts the API and may inspect a remote repository. The tutorial does not press this button." },
      { selector: "#save-adapter", title: "Stop before saving", instruction: "Saving creates a new immutable adapter version. The tutorial stops here and never saves, clones, archives, restores, or deletes anything. Exit and act manually after review." },
    ],
  },
};
...
const interactiveTutorialTours = {
  experiments: {
    title: "Experiments",
    steps: [
      { id: "name", selector: "#experiment-name", gate: "field", title: "Name this tutorial experiment", instruction: "Enter a unique name. Use the generated value if you want a clearly marked tutorial record.", useValue: ({ token }) => `${token}-experiment` },
      { id: "adapter", selector: "#experiment-adapter", gate: "field", title: "Choose a real adapter", instruction: "Change this to an adapter returned by the registry. The tutorial will not invent one.", validate: tutorialNonEmpty },
      { id: "source", selector: "#experiment-source", gate: "field", title: "Use the real repository", instruction: "Enter or confirm the actual repository URL. Credentials do not belong here.", validate: tutorialNonEmpty },
      { id: "branch", selector: "#experiment-branch", gate: "field", title: "Choose a returned branch", instruction: "Select a branch loaded from repository inspection.", validate: tutorialNonEmpty },
      { id: "revision", selector: "#experiment-revision", gate: "field", title: "Pin a returned commit", instruction: "Select the exact commit. A moving branch name is not reproducible.", validate: tutorialNonEmpty },
      { id: "runtime", selector: "#experiment-runtime", gate: "field", title: "Choose a runnable runtime", instruction: "Select a detected runnable candidate; resolve adapter evidence first if none exists.", validate: tutorialNonEmpty },
      { id: "adapter-fields", selector: "#adapter-declared-fields", gate: "field", title: "Set adapter-declared inputs", instruction: "Review the typed values declared by this adapter. Required fields must be valid; Use tutorial values only applies examples explicitly supplied by the manifest. If none is supplied, choose the real value yourself.", validate: tutorialAdapterDeclaredFieldsValid, applyValue: tutorialApplyAdapterDeclaredValues },
      { id: "learning-rate", selector: "#hp-learning-rate", skipIf: () => elements.hpLearningRate.disabled, gate: "field", title: "Set a smoke-test learning rate", instruction: "Enter a deliberate value. The generated value is only a starting point.", useValue: () => "0.0003", validate: tutorialPositiveNumber },
      { id: "max-steps", selector: () => !elements.hpMaxSteps.disabled ? "#hp-max-steps" : '#adapter-declared-fields input[data-adapter-input-path="native.config.epochs"]', skipIf: () => elements.hpMaxSteps.disabled && !document.querySelector('#adapter-declared-fields input[data-adapter-input-path="native.config.epochs"]'), gate: "field", title: "Keep the first run short", instruction: "Use a small step or epoch count supported by this adapter.", useValue: () => elements.hpMaxSteps.disabled ? "1" : "10", validate: tutorialPositiveNumber },
  ...
  datasets: {
    title: "Datasets",
    steps: [
      { id: "open-resource", selector: "#show-data-resource-form", gate: "action", title: "Open a clean resource draft", instruction: "Click until the clean resource form is open. The canonical Show/Hide control resets edit state only when opening and makes no API request.", localPredicate: () => !document.querySelector("#data-resource-form")?.hidden },
      { id: "provider", selector: "#data-resource-provider", gate: "field", title: "Choose the source provider", instruction: "This lifecycle creates a disposable named resource only. Exact file versions remain separate and immutable.", useValue: () => "local", validate: tutorialNonEmpty },
      { id: "namespace", selector: "#data-resource-namespace", gate: "field", title: "Use the tutorial namespace", instruction: "Keep the disposable resource isolated from production names.", useValue: () => "tutorial", validate: tutorialNonEmpty },
      { id: "name", selector: "#data-resource-name", gate: "field", title: "Give the resource a unique name", instruction: "The generated name carries this tutorial session token.", useValue: ({ token }) => `${token}-resource`, validate: tutorialNonEmpty },
      { id: "kind", selector: "#data-resource-kind", gate: "field", title: "Declare the data kind", instruction: "Choose the role that matches the source. This example is only a demonstrations registry record, not uploaded data.", useValue: () => "demonstrations", validate: tutorialNonEmpty },
      { id: "description", selector: "#data-resource-description", gate: "field", title: "Tag ownership", instruction: "The token in this description lets the tutorial verify the exact record before editing or archiving it.", useValue: ({ token }) => `Disposable tutorial resource ${token}` },
        { id: "create", selector: "#create-data-resource", gate: "action", risk: "persistent", confirmVerb: "CREATE", title: "Create the resource", instruction: "Click Register once, type the confirmation, then click it again. Advancement requires a successful POST returning resource.id.", request: { method: "POST", path: "/api/data/resources", bind: "resourceId", entity: "resource", establishBinding: true, identity: tutorialResourceIdentity, preflight: tutorialResourceFormIdentity, record: { kind: "data-resource", cleanup: "archive" }, render: ({ bindings }) => tutorialBoundSelector("resource-id", bindings.resourceId, "[data-resource-action=\"edit\"]") } },
        { id: "read", selector: ({ bindings }) => tutorialBoundSelector("resource-id", bindings.resourceId, "[data-resource-action=\"edit\"]"), gate: "action", waitForTarget: true, title: "Read the exact created resource", instruction: "Click View / edit on the bound row. The exact GET response must match the bound ID and immutable tutorial name.", request: { method: "GET", path: ({ bindings }) => `/api/data/resources/${encodeURIComponent(bindings.resourceId)}`, bind: "resourceId", entity: "resource", identity: tutorialResourceIdentity } },
      { id: "edit-description", selector: "#data-resource-description", reveal: ["#data-resource-form"], gate: "field", title: "Edit the description", instruction: "Change the description while retaining the token so ownership remains verifiable.", useValue: ({ token }) => `Updated disposable tutorial resource ${token}`, validate: tutorialContainsToken },
      { id: "update", selector: "#create-data-resource", gate: "action", risk: "persistent", confirmVerb: "UPDATE", requiresOwned: "resourceId", title: "Save the real update", instruction: "Click Save once, type the confirmation, then click again. Advancement requires a matching PATCH and the same resource ID.", request: { method: "PATCH", path: ({ bindings }) => `/api/data/resources/${encodeURIComponent(bindings.resourceId)}`, bind: "resourceId", entity: "resource", identity: tutorialResourceIdentity } },
        { id: "archive", selector: ({ bindings }) => tutorialBoundSelector("resource-id", bindings.resourceId, "[data-resource-action=\"archive\"]"), gate: "action", risk: "cleanup", confirmVerb: "ARCHIVE", requiresOwned: "resourceId", waitForTarget: true, title: "Archive the tutorial resource", instruction: "Archiving is the supported cleanup; it does not delete payload bytes. Confirm and click the bound Archive control again.", request: { method: "DELETE", path: ({ bindings }) => `/api/data/resources/${encodeURIComponent(bindings.resourceId)}`, bind: "resourceId", entity: "resource", identity: tutorialResourceIdentity, cleanupBinding: "resourceId" } },
    ],
  },
  collection: {
    title: "Collection",
    steps: [
      ...
      { id: "key", selector: "#collection-adapter-key", reveal: ["#collection-adapter-form"], gate: "field", title: "Set a unique adapter key", instruction: "The generated key is isolated to this tutorial session.", useValue: ({ token }) => tutorialAdapterSlug(token, "collection-adapter"), validate: tutorialNonEmpty },
      ...
      { id: "runnable", selector: "#collection-adapter-runnable", gate: "field", title: "Keep it non-runnable", instruction: "This tutorial adapter must remain inert and cannot launch collection work.", useValue: () => false, validate: (target) => !target.checked },
      { id: "streams", selector: "#collection-adapter-streams", gate: "field", title: "Declare one typed native stream", instruction: "This inert declaration demonstrates native sensor semantics without conversion.", useValue: () => JSON.stringify([{ name: "tutorial.marker", kind: "sensor", shape: [1], dtype: "float32", units: null, frame: null, rate_hz: 1, native_key: "tutorial.marker", required: false, metadata: {} }], null, 2), validate: tutorialJsonArray },
      { id: "launcher", selector: "#collection-adapter-launcher", gate: "field", title: "Keep the launcher inert", instruction: "An empty step list makes the non-runnable tutorial adapter incapable of executing a process.", useValue: () => JSON.stringify({ environment: {}, steps: [] }, null, 2), validate: tutorialJsonObject },
      { id: "description", selector: "#collection-adapter-description", gate: "field", title: "Tag the adapter", instruction: "Retain the token so later update and archive steps can verify ownership.", useValue: ({ token }) => `Disposable non-runnable collection adapter ${token}`, validate: tutorialContainsToken },
      { id: "metadata", selector: "#collection-adapter-metadata", gate: "field", title: "Record tutorial metadata", instruction: "Store only the non-secret session token under the exact tutorial_token field.", useValue: ({ token }) => JSON.stringify({ tutorial_token: token }, null, 2), validate: tutorialJsonObject },
      { id: "create", selector: "#save-collection-adapter", gate: "action", risk: "persistent", confirmVerb: "CREATE", title: "Create the inert adapter", instruction: "Confirm, then click Save again. A successful POST must return adapter.id.", request: { method: "POST", path: "/api/collection/adapters", bind: "collectionAdapterId", entity: "adapter", establishBinding: true, identity: tutorialCollectionAdapterIdentity, preflight: tutorialCollectionAdapterFormIdentity, record: { kind: "collection-adapter", cleanup: "archive" }, render: ({ bindings }) => tutorialBoundSelector("collection-adapter-id", bindings.collectionAdapterId, "[data-collection-adapter-action=\"edit\"]") } },
      { id: "read", selector: ({ bindings }) => tutorialBoundSelector("collection-adapter-id", bindings.collectionAdapterId, "[data-collection-adapter-action=\"edit\"]"), gate: "action", waitForTarget: true, title: "Read the bound adapter", instruction: "Click Edit on this exact row. The GET result must match both its bound key and structured tutorial metadata.", request: { method: "GET", path: ({ bindings }) => `/api/collection/adapters/${encodeURIComponent(bindings.collectionAdapterId)}`, bind: "collectionAdapterId", entity: "adapter", identity: tutorialCollectionAdapterIdentity } },
      { id: "update-version", selector: "#collection-adapter-version", reveal: ["#collection-adapter-form"], gate: "field", title: "Version the edit", instruction: "Change the version before saving the update.", useValue: () => "0.0.2", validate: tutorialNonEmpty },
      { id: "update-description", selector: "#collection-adapter-description", gate: "field", title: "Describe the update", instruction: "Change the description while retaining the tutorial token.", useValue: ({ token }) => `Updated disposable collection adapter ${token}`, validate: tutorialContainsToken },
      { id: "update", selector: "#save-collection-adapter", gate: "action", risk: "persistent", confirmVerb: "UPDATE", requiresOwned: "collectionAdapterId", title: "Save the adapter update", instruction: "Confirm and click Save again. The matching PUT must return the same adapter ID.", request: { method: "PUT", path: ({ bindings }) => `/api/collection/adapters/${encodeURIComponent(bindings.collectionAdapterId)}`, bind: "collectionAdapterId", entity: "adapter", identity: tutorialCollectionAdapterIdentity } },
      { id: "archive", selector: ({ bindings }) => tutorialBoundSelector("collection-adapter-id", bindings.collectionAdapterId, "[data-collection-adapter-action=\"archive\"]"), gate: "action", risk: "cleanup", confirmVerb: "ARCHIVE", requiresOwned: "collectionAdapterId", waitForTarget: true, title: "Archive the inert adapter", instruction: "Confirm and click Archive again. This is final cleanup; the tutorial never restores it automatically.", request: { method: "DELETE", path: ({ bindings }) => `/api/collection/adapters/${encodeURIComponent(bindings.collectionAdapterId)}`, bind: "collectionAdapterId", entity: "adapter", identity: tutorialCollectionAdapterIdentity, cleanupBinding: "collectionAdapterId" } },
      { id: "session-name", selector: "#collection-session-name", gate: "field", optional: true, title: "Optional immutable session draft", instruction: "You may fill a session using a real runnable adapter, operator, calibration, native format, timing, and storage path. Skip if those facts are unavailable.", useValue: ({ token }) => `${token}-session` },
      { id: "session-boundary", selector: "#data .page-heading h1", title: "Session creation is outside this tutorial", instruction: "Collection sessions are immutable and have no cleanup endpoint. Prepare, submit, cancel, restart, fail, and complete can also change state or contact Slurm, so the tutorial stops before them." },
    ],
  },
  runs: {
    title: "Training Runs",
  ...
  evaluations: {
    title: "Evaluations",
    steps: [
      { id: "run", selector: "#evaluation-run-id", gate: "field", title: "Choose a real run", instruction: "Enter an existing run ID. The service will reject fabricated or incompatible records.", validate: tutorialNonEmpty },
      { id: "checkpoint", selector: "#evaluation-checkpoint", gate: "field", title: "Pin the real checkpoint", instruction: "Enter the exact registered inference checkpoint or known canonical path.", validate: tutorialNonEmpty },
      { id: "suite", selector: "#evaluation-suite", gate: "field", title: "Choose a returned suite", instruction: "Change this to a suite returned by the service.", validate: tutorialNonEmpty },
      { id: "episodes", selector: "#evaluation-episodes", gate: "field", title: "Start with one episode", instruction: "A one-episode smoke check limits initial work.", useValue: () => "1", validate: tutorialPositiveNumber },
      { id: "seeds", selector: "#evaluation-seeds", gate: "field", title: "Make the seed explicit", instruction: "Use a deliberate seed; zero is a conventional smoke-test choice.", useValue: () => "0", validate: tutorialNonEmpty },
      { id: "parallelism", selector: "#evaluation-parallelism", gate: "field", title: "Limit parallelism", instruction: "Start with one worker until the evaluator and environment are proven.", useValue: () => "1", validate: tutorialPositiveNumber },
      { id: "submit-boundary", selector: "#evaluations .page-heading h1", title: "Submission is outside this tutorial", instruction: "Evaluation submission can create a permanent record and real Slurm work. It remains excluded until server-enforced tutorial GPU, time, and job-count caps exist." },
    ],
  },
  adapters: {
    title: "Adapters",
    steps: [
      ...
      { id: "slug", selector: "#adapter-editor-slug", reveal: ["#adapter-editor"], gate: "field", title: "Set a unique slug", instruction: "The token isolates this adapter from production definitions.", useValue: ({ token }) => tutorialAdapterSlug(token, "adapter"), validate: tutorialNonEmpty },
      ...
      { id: "description", selector: "#adapter-description", gate: "field", title: "Tag ownership", instruction: "Retain the tutorial token so read, update, and archive can stay bound to this record.", useValue: ({ token }) => `Disposable experiment adapter ${token}`, validate: tutorialContainsToken },
      { id: "change-note", selector: "#adapter-change-note", gate: "field", title: "Explain the first version", instruction: "Record why this tutorial version exists.", useValue: ({ token }) => `Create disposable tutorial adapter ${token}`, validate: tutorialNonEmpty },
      { id: "create", selector: "#save-adapter", gate: "action", risk: "persistent", confirmVerb: "CREATE", title: "Create the adapter", instruction: "Confirm and click Save again. A matching POST must return adapter.id.", request: { method: "POST", path: "/api/adapters", bind: "adapterId", entity: "adapter", establishBinding: true, identity: tutorialExperimentAdapterIdentity, preflight: tutorialExperimentAdapterFormIdentity, record: { kind: "experiment-adapter", cleanup: "archive" }, render: ({ bindings }) => tutorialBoundSelector("adapter-id", bindings.adapterId, "[data-adapter-action=\"view\"]") } },
      { id: "read", selector: ({ bindings }) => tutorialBoundSelector("adapter-id", bindings.adapterId, "[data-adapter-action=\"view\"]"), gate: "action", waitForTarget: true, title: "Read the bound adapter", instruction: "Click View on the exact created row. Its GET response must match the immutable tutorial slug.", request: { method: "GET", path: ({ bindings }) => `/api/adapters/${encodeURIComponent(bindings.adapterId)}`, bind: "adapterId", entity: "adapter", identity: tutorialExperimentAdapterIdentity } },
      { id: "edit", selector: "#edit-adapter", reveal: ["#adapter-editor"], gate: "action", title: "Enter local edit mode", instruction: "Click Edit. This changes only the local editor until Save succeeds." },
      { id: "update-description", selector: "#adapter-description", gate: "field", title: "Change the description", instruction: "Retain the token while describing the update.", useValue: ({ token }) => `Updated disposable experiment adapter ${token}`, validate: tutorialContainsToken },
      { id: "update-note", selector: "#adapter-change-note", gate: "field", title: "Explain the immutable version", instruction: "Adapter updates create a new immutable version under the same record.", useValue: ({ token }) => `Tutorial update ${token}`, validate: tutorialNonEmpty },
      { id: "update", selector: "#save-adapter", gate: "action", risk: "persistent", confirmVerb: "UPDATE", requiresOwned: "adapterId", title: "Save the new adapter version", instruction: "Confirm and click Save again. Advancement requires a matching PUT returning the same adapter ID.", request: { method: "PUT", path: ({ bindings }) => `/api/adapters/${encodeURIComponent(bindings.adapterId)}`, bind: "adapterId", entity: "adapter", identity: tutorialExperimentAdapterIdentity } },
      { id: "archive", selector: ({ bindings }) => tutorialBoundSelector("adapter-id", bindings.adapterId, "[data-adapter-action=\"archive\"]"), gate: "action", risk: "cleanup", confirmVerb: "ARCHIVE", requiresOwned: "adapterId", waitForTarget: true, title: "Archive the tutorial adapter", instruction: "Confirm and click the bound Archive action again. The tutorial does not restore it after cleanup.", request: { method: "DELETE", path: ({ bindings }) => `/api/adapters/${encodeURIComponent(bindings.adapterId)}`, bind: "adapterId", entity: "adapter", identity: tutorialExperimentAdapterIdentity, cleanupBinding: "adapterId" } },
    ],
  },
};
...
const tutorialUi = {
  ...
  blockers: ["top", "left", "right", "bottom"].map((side) => document.querySelector(`#tutorial-blocker-${side}`)),
};

function tutorialNonEmpty(target) { return Boolean(target.value?.trim()); }
function tutorialPositiveNumber(target) { return Number(target.value) > 0; }
function tutorialContainsToken(target, context) { return target.value.includes(context.token); }
function tutorialJson(target, array) {
  try {
    const value = JSON.parse(target.value);
    return array ? Array.isArray(value) : Boolean(value && typeof value === "object" && !Array.isArray(value));
  } catch { return false; }
}
function tutorialJsonArray(target) { return tutorialJson(target, true); }
function tutorialJsonObject(target) { return tutorialJson(target, false); }
function tutorialHasExperimentPreview(payload) {
  if (experimentPreviewShapeErrors(payload).length) return false;
  return payload.blockers.length === 0
...
function tutorialCollectionAdapterIdentity({ token }) {
  return [
    { paths: ["adapter_key", "key", "manifest.key"], value: tutorialAdapterSlug(token, "collection-adapter") },
    { paths: ["manifest.metadata.tutorial_token"], value: token },
  ];
}

function tutorialExperimentAdapterIdentity({ token }) {
  return [{ paths: ["slug", "manifest.slug"], value: tutorialAdapterSlug(token, "adapter") }];
}

function tutorialResourceFormIdentity({ token }) {
  return document.querySelector("#data-resource-name")?.value === `${token}-resource`;
}

function tutorialCollectionAdapterFormIdentity({ token }) {
  if (document.querySelector("#collection-adapter-key")?.value !== tutorialAdapterSlug(token, "collection-adapter")) return false;
  try { return JSON.parse(document.querySelector("#collection-adapter-metadata")?.value || "{}").tutorial_token === token; } catch { return false; }
}

function tutorialExperimentAdapterFormIdentity({ token }) {
  return document.querySelector("#adapter-editor-slug")?.value === tutorialAdapterSlug(token, "adapter");
}

function tutorialContext() {
  return { token: tutorialState.session?.token || "", bindings: tutorialState.session?.bindings || {} };
}
...
function tutorialProgressKey(page) { return `skynet.tutorial.progress.v2.${page}`; }

function tutorialUniqueId(prefix) {
  if (window.crypto?.randomUUID) return `${prefix}-${window.crypto.randomUUID()}`;
  if (!window.crypto?.getRandomValues) throw new Error("Secure randomness is unavailable; the interactive tutorial cannot start safely.");
...
function tutorialToken() {
  ...
  const suffix = tutorialUniqueId("token").replace(/[^a-z0-9]/gi, "").slice(-12).toLowerCase();
...
function newTutorialSession(page, retainedRecords = []) {
  ...
  return { schema: 1, definitionVersion: 3, page, stepId: tutorialTours[page].steps[0]?.id || null, sessionId: token, sessionGeneration, token, completedStepIds: [], bindings: {}, ownedRecords: retainedRecords, finished: false, updatedAt: new Date().toISOString() };
}
  ...
  try {
    ...
    if (saved.definitionVersion === 2) {
      ...
      saved.ownedRecords = (saved.ownedRecords || []).map((record) => ({
        ...
        cleanupState: record.cleanupState === "cleanup pending" ? "manual identity verification required" : record.cleanupState,
      }));
    }
...
function tutorialValidateField(step, target) {
  ...
  if (typeof target.checkValidity === "function" && !target.checkValidity()) return false;
  return step.validate ? Boolean(step.validate(target, tutorialContext())) : (target.type === "checkbox" || tutorialNonEmpty(target));
}

function resetTutorialAttempt(message = "") {
  if (tutorialState.attemptTimer) window.clearTimeout(tutorialState.attemptTimer);
  ...
  if (message && tutorialState.active) tutorialUi.gateStatus.textContent = message;
}

function scheduleTutorialAttemptExpiry(attempt) {
  if (tutorialState.attemptTimer) window.clearTimeout(tutorialState.attemptTimer);
  tutorialState.attemptTimer = window.setTimeout(() => {
    if (tutorialState.pendingAttempt !== attempt || attempt.claimed || !tutorialGenerationMatches(attempt)) return;
    if (Date.now() <= attempt.expiresAt) {
      scheduleTutorialAttemptExpiry(attempt);
      return;
    }
    const confirmation = attempt.confirmationDialog;
    resetTutorialAttempt("Action expired; retype the confirmation and click again");
...
document.addEventListener("skynet:confirmation-open", (event) => {
  ...
  if (!attempt?.confirmationWindowOpen || attempt.claimed || !tutorialGenerationMatches(attempt)
      || !dialog?.matches("dialog[data-app-confirmation][open]")) return;
  attempt.confirmationDialog = dialog;
  attempt.expiresAt = attempt.confirmationDeadline;
  tutorialUi.gateStatus.textContent = "Review the application confirmation; this action remains available for up to two minutes.";
  scheduleTutorialAttemptExpiry(attempt);
});

document.addEventListener("skynet:confirmation-close", (event) => {
  const attempt = tutorialState.pendingAttempt;
  if (!attempt || attempt.confirmationDialog !== event.detail?.dialog || !tutorialGenerationMatches(attempt)) return;
  if (!event.detail.accepted || Date.now() > attempt.confirmationDeadline) {
    if (event.detail.accepted) event.preventDefault();
    resetTutorialAttempt(event.detail.accepted ? "Confirmation expired; retype the phrase and click again" : "Action cancelled; retype the phrase before trying again");
    return;
  }
  attempt.confirmationDialog = null;
  attempt.expiresAt = Date.now() + 8000;
  tutorialUi.gateStatus.textContent = "Confirmed; waiting for the exact API request";
  scheduleTutorialAttemptExpiry(attempt);
});
...
function invalidateTutorialGate() {
  ...
  if (tutorialState.recoveryTimer) window.clearTimeout(tutorialState.recoveryTimer);
  tutorialState.recoveryTimer = 0;
  tutorialState.recovering = false;
  if (tutorialState.prefillTimer) window.clearTimeout(tutorialState.prefillTimer);
...
function tutorialClaimCanSettle(claim) {
  if (!claim || claim.settled || !tutorialGenerationMatches(claim)) return false;
  return true;
}

function tutorialActionIsPending() {
  return Boolean(
    (tutorialState.pendingAttempt?.confirmationDialog && tutorialGenerationMatches(tutorialState.pendingAttempt))
...
function completeTutorialGate(message = "Completed", snapshot = null) {
  ...
  if (!tutorialState.session.completedStepIds.includes(step.id)) tutorialState.session.completedStepIds.push(step.id);
  tutorialState.gateComplete = true;
  if (!tutorialVisibleRect(tutorialState.target)) {
    tutorialState.target = workspaceHeading(tutorialState.page) || document.querySelector(".topbar") || document.body;
  ...
  elements.tutorialNext.textContent = tutorialState.index === tutorialTours[tutorialState.page].steps.length - 1 ? "Finish" : "Next";
...
function scheduleTutorialFieldGateEvaluation(step) {
  ...
  const evaluate = () => {
    tutorialState.prefillTimer = 0;
    if (!tutorialGenerationMatches(snapshot) || tutorialState.gateComplete) return;
    ...
    if (attempts-- > 0) tutorialState.prefillTimer = window.setTimeout(evaluate, 100);
  };
...
function setupTutorialGate(step) {
  ...
  elements.tutorialNext.disabled = Boolean(step.gate && !step.optional && !tutorialState.gateComplete);
  elements.tutorialNext.textContent = step.optional && !completed ? "Skip" : (tutorialState.index === tutorialTours[tutorialState.page].steps.length - 1 ? "Finish" : "Next");
  tutorialUi.gateStatus.textContent = completed ? "Completed earlier" : (step.gate ? (step.optional ? "Optional" : "Waiting for your action") : "Read, then continue");
  tutorialUi.useValue.hidden = !(step.useValue || step.applyValue);
  tutorialUi.useValue.textContent = step.applyValue ? "Use manifest tutorial values" : "Use tutorial value";
...
function tutorialConfirmationPhrase(step) { return `${step.confirmVerb || "CONFIRM"} ${tutorialState.session.token}`; }

function showTutorialConfirmation(step) {
  const phrase = tutorialConfirmationPhrase(step);
  tutorialUi.confirmSummary.textContent = step.risk === "slurm"
...
function tutorialRequestPath(request) { return tutorialResolve(request.path); }
function tutorialNormalizePath(path) { return new URL(path, window.location.origin).pathname; }
...
function tutorialObserveApiStart(path, options = {}) {
  const attempt = tutorialState.pendingAttempt;
  if (!attempt || attempt.claimed || !tutorialGenerationMatches(attempt) || attempt.confirmationDialog?.open) return null;
  if (Date.now() > attempt.expiresAt) {
    resetTutorialAttempt("Action expired; type the confirmation and click again");
    return null;
  }
  const request = attempt.request;
  const method = String(options.method || "GET").toUpperCase();
  const actualPath = tutorialNormalizePath(path);
  if (method !== request.method || !tutorialPathMatches(attempt.expectedPath, actualPath)) return null;
  const boundId = request.bind ? tutorialState.session.bindings[request.bind] : null;
  if (request.bind && !request.establishBinding) {
    if (!boundId || boundId !== attempt.bindingId) return null;
    const pathIds = actualPath.split("/").filter(Boolean).map((part) => { try { return decodeURIComponent(part); } catch { return part; } });
  ...
  const claim = { ...attempt, method, path: actualPath, boundId, settled: false };
  tutorialState.inflightClaim = claim;
  return claim;
}

function tutorialEntityId(payload, entity) {
  const nested = entity && payload && typeof payload === "object" ? payload[entity] : null;
  return nested?.id || nested?.[`${entity}_id`] || payload?.id || (entity ? payload?.[`${entity}_id`] : null) || null;
}

function tutorialResponseEntity(payload, entity) {
  return entity && payload && typeof payload === "object" ? (payload[entity] || payload) : payload;
}
...
function tutorialIdentityMatches(entity, rules) {
  return Boolean(rules?.length && rules.every((rule) => rule.paths.some((path) => tutorialValueAtPath(entity, path) === rule.value)));
}

function tutorialRecordFor(binding, id) {
  return tutorialState.session.ownedRecords.find((record) => record.binding === binding && String(record.id) === String(id));
}

function tutorialRecoverableRecord() {
  if (!tutorialState.session) return null;
  const candidates = (tutorialState.session.ownedRecords || []).filter((record) => {
    if (record.cleanup !== "archive" || record.cleanupState === "archived") return false;
    return tutorialTours[tutorialState.page].steps.some((step) => step.id === "read" && step.request?.method === "GET" && step.request.bind === record.binding);
  });
  const bound = candidates.find((record) => String(tutorialState.session.bindings[record.binding] || "") === String(record.id));
  if (bound) return bound;
  return candidates.find((record) => !tutorialState.session.bindings[record.binding]) || null;
}

function tutorialRecoveryStepIndex(record, stepId) {
  if (!record) return -1;
  return tutorialTours[tutorialState.page].steps.findIndex((step) => step.id === stepId && step.request?.bind === record.binding);
}
...
function beginTutorialRecovery(record) {
  ...
  if (existing && String(existing) !== String(record.id)) {
    tutorialSetError("A newer record is already bound. Finish or restart that record before reconciling this older ledger entry.");
    return false;
  }
  invalidateTutorialGate();
  ...
  tutorialState.session.completedStepIds = tutorialState.session.completedStepIds.filter((stepId) => stepId !== "read");
...
function tutorialActiveRecoveryRecord() {
  ...
  return (tutorialState.session.ownedRecords || []).find((record) => `${record.binding}:${record.id}` === recoveryId) || null;
}
...
function tutorialBindingIsOwned(binding) {
  ...
  return Boolean(
      ...
      && JSON.stringify(verified.expectedIdentity) === JSON.stringify(record.expectedIdentity)
  );
}

function tutorialRecordSuccess(request, id, expectedIdentity, ownerToken, entity) {
  if (!request.record || !id) return;
  const records = tutorialState.session.ownedRecords;
  if (!records.some((record) => record.kind === request.record.kind && String(record.id) === String(id))) {
    records.push({
      binding: request.bind,
      kind: request.record.kind,
      id: String(id),
      cleanup: request.record.cleanup,
        cleanupState: request.record.cleanup === "archive" ? "created_pending_verification" : "retained; no cleanup API",
      ownerToken,
      expectedIdentity,
      createdGeneration: tutorialState.sessionGeneration,
      capturedIdentity: expectedIdentity.map((rule) => ({ paths: rule.paths, value: rule.paths.map((path) => tutorialValueAtPath(entity, path)).find((value) => value !== undefined) })),
    });
  }
}
...
function tutorialCleanupSuccess(binding, id) {
  ...
  const record = tutorialRecordFor(binding, id);
  if (record && tutorialBindingIsOwned(binding)) record.cleanupState = "archived";
}
...
function waitForTutorialRender(selector, snapshot) {
  ...
  tutorialState.renderObserver.observe(document.body, { childList: true, subtree: true });
  tutorialState.renderTimer = window.setTimeout(() => {
    if (tutorialGenerationMatches(snapshot) && tutorialState.renderObserver && !check()) tutorialSetError("The API succeeded, but the bound row has not appeared yet. Refresh the page and resume this tutorial.");
  }, 10000);
}
...
function tutorialObserveApiSuccess(claim, payload) {
  ...
  if (request.success && !request.success(payload)) {
    const blockerReasons = Array.isArray(payload?.blockers)
      ? payload.blockers.flatMap((blocker) => Array.isArray(blocker?.reasons) ? blocker.reasons : []).filter(Boolean)
      : [];
    tutorialSetError(blockerReasons.length
    ...
    resetTutorialAttempt(blockerReasons.length ? "Preview remains blocked; correct the declared values and retry" : "Unexpected response; confirm and retry");
    return;
  }
  const id = request.bind ? tutorialEntityId(payload, request.entity) : null;
  if (request.bind && !id) {
    tutorialSetError("The request succeeded but did not return the required record ID.");
  ...
  if (request.bind) {
    ...
    if (request.establishBinding) {
      if (existing && existing !== String(id)) {
        tutorialSetError("A different record is already bound to this tutorial step.");
    ...
    } else if (!existing || existing !== String(id) || claim.bindingId !== String(id)) {
      tutorialSetError("The response ID did not match the immutable bound record ID.");
      resetTutorialAttempt("Bound ID mismatch; confirm and retry");
      return;
    }
  }
    const entity = tutorialResponseEntity(payload, request.entity);
    const existingRecord = request.bind ? tutorialRecordFor(request.bind, id) : null;
    const identityOwnerToken = existingRecord?.ownerToken || claim.ownerToken;
    const expectedIdentity = request.identity ? request.identity({ token: identityOwnerToken, bindings: { ...claim.bindings } }) : [];
    tutorialRecordSuccess(request, id, expectedIdentity, claim.ownerToken, entity);
    const record = request.bind ? tutorialRecordFor(request.bind, id) : null;
    const identityToVerify = record?.expectedIdentity?.length ? record.expectedIdentity : expectedIdentity;
    renderTutorialRecords();
    persistTutorialSession();
    if (request.identity && !request.cleanupBinding && !tutorialIdentityMatches(entity, identityToVerify)) {
      ...
      resetTutorialAttempt();
      if (request.establishBinding) {
        completeTutorialGate(`Created ${id}; exact read verification is still required`, claim);
        const readIndex = tutorialRecoveryStepIndex(record, "read");
        if (readIndex >= 0) tutorialState.session.stepId = "read";
        persistTutorialSession();
        tutorialSetError("The create succeeded and its exact ID is retained, but its response identity did not verify. Resume cleanup and perform the bound Read step; mismatches can only be reviewed manually.");
      } else {
        tutorialSetError("The response did not match the exact structured tutorial identity. This record remains manual-review only and cannot be archived by the tutorial.");
        tutorialUi.gateStatus.textContent = "Identity verification failed";
      }
      return;
    }
    if (request.bind && identityToVerify.length && !request.cleanupBinding && !request.establishBinding) {
      tutorialState.ownedVerified.set(request.bind, { id: String(id), ownerToken: record?.ownerToken || claim.ownerToken, expectedIdentity: identityToVerify });
      if (record?.cleanup === "archive") {
        ...
        const alreadyArchived = request.method === "GET" && Boolean(entity?.archived_at);
        record.cleanupState = alreadyArchived ? "archived" : "cleanup pending";
        if (alreadyArchived) {
          const cleanupStep = tutorialTours[tutorialState.page].steps.find((step) => step.request?.cleanupBinding === request.bind);
          if (cleanupStep && !tutorialState.session.completedStepIds.includes(cleanupStep.id)) tutorialState.session.completedStepIds.push(cleanupStep.id);
    ...
    resetTutorialAttempt();
    if (request.establishBinding) {
      completeTutorialGate(`Created and bound: ${id}; verify it with the exact Read step`, claim);
      const readIndex = tutorialRecoveryStepIndex(record, "read");
      if (readIndex >= 0) tutorialState.session.stepId = "read";
      persistTutorialSession();
    } else if (request.render) waitForTutorialRender(request.render, claim);
    else completeTutorialGate(record?.cleanupState === "archived" && request.method === "GET"
      ? `Already archived: ${id}; cleanup verified by the exact Read. Continue after cleanup.`
      : id ? `Succeeded: ${id}` : "Request succeeded", claim);
}
...
function tutorialObserveApiFailure(claim, error) {
  ...
  resetTutorialAttempt("Request failed; correct the form, retype confirmation, and retry");
}
...
function tutorialEventHitsTarget(event, target) {
  return Boolean(target && (event.target === target || target.contains(event.target)));
}
...
function onTutorialInteraction(event) {
  ...
  const step = tutorialStep();
  const target = tutorialInteractionTarget(step);
  if (step.gate === "field" && ["input", "change"].includes(event.type) && tutorialEventHitsTarget(event, target)) {
    if (event.isTrusted && tutorialValidateField(step, target)) completeTutorialGate("Input accepted");
    return;
  }
  if (event.type === "submit" && step.gate === "action" && target?.form === event.target && !tutorialState.pendingAttempt) {
    event.preventDefault();
    event.stopImmediatePropagation();
    tutorialSetError("Use the highlighted button so the tutorial can bind this exact request.");
    return;
  }
  if (event.type !== "click" || step.gate !== "action" || !tutorialEventHitsTarget(event, target) || !event.isTrusted) return;
  if (step.requiresOwned && !tutorialBindingIsOwned(step.requiresOwned)) {
    event.preventDefault();
    event.stopImmediatePropagation();
    tutorialSetError("Ownership must be verified by reading the exact bound record first. Use Back to repeat its Read step.");
    return;
  }
  if (step.request?.preflight && !step.request.preflight(tutorialContext())) {
    event.preventDefault();
    event.stopImmediatePropagation();
    tutorialSetError("The form does not contain this session's exact structured tutorial identity.");
    resetTutorialAttempt("Correct the identity fields before trying again");
    return;
  }
  if (step.request?.establishBinding && tutorialState.session.bindings[step.request.bind]) {
    event.preventDefault();
    event.stopImmediatePropagation();
    tutorialSetError("This create step already has a bound record. It cannot create or bind a second one.");
    return;
  }
  ...
  if (!step.request) {
    if (step.localPredicate) {
      ...
      window.setTimeout(() => {
        ...
        if (step.localPredicate(tutorialContext())) completeTutorialGate("Action completed locally", snapshot);
        else tutorialUi.gateStatus.textContent = "The requested local state is not open yet; use the highlighted control again";
      }, 0);
    } else {
  ...
  if (step.request.bindFromTarget) {
    ...
    if (!existing) tutorialState.session.bindings[step.request.bind] = selectedId;
  }
  ...
  tutorialState.pendingAttempt = {
    ...
    bindingId: step.request.bind ? tutorialState.session.bindings[step.request.bind] || null : null,
    bindings: { ...tutorialState.session.bindings },
    ownerToken: tutorialRecordFor(step.request.bind, tutorialState.session.bindings[step.request.bind])?.ownerToken || tutorialState.session.token,
  };
  const attempt = tutorialState.pendingAttempt;
  ...
  window.setTimeout(() => { attempt.confirmationWindowOpen = false; }, 0);
  scheduleTutorialAttemptExpiry(attempt);
  tutorialUi.gateStatus.textContent = "Action accepted; waiting for its exact API request";
}
...
function useTutorialValue(event) {
  ...
  if (step.applyValue) {
    ...
    tutorialState.gateComplete = Boolean(tutorialState.session?.completedStepIds?.includes(step.id));
    elements.tutorialNext.disabled = Boolean(step.gate && !step.optional && !tutorialState.gateComplete);
    tutorialUi.gateStatus.textContent = "Manifest tutorial values inserted; validating required fields";
    scheduleTutorialFieldGateEvaluation(step);
  ...
  try {
    ...
    tutorialState.gateComplete = Boolean(tutorialState.session?.completedStepIds?.includes(step.id));
    elements.tutorialNext.disabled = Boolean(step.gate && !step.optional && !tutorialState.gateComplete);
    tutorialUi.gateStatus.textContent = "Value inserted; validating the highlighted field";
    scheduleTutorialFieldGateEvaluation(step);
    target.focus({ preventScroll: true });
}

function collectionTutorialResumeIndex(session, requestedIndex) {
  if (session.bindings?.collectionAdapterId || requestedIndex === 0) return requestedIndex;
...
function ensureInteractiveTutorialControls() {
  ...
  tutorialUi.confirmInput.addEventListener("input", (event) => {
    ...
    tutorialState.confirmationArmed = event.target.value === tutorialConfirmationPhrase(tutorialStep());
    tutorialUi.gateStatus.textContent = tutorialState.confirmationArmed ? "Confirmed; click the highlighted control again" : "Confirmation text does not match";
  });
    tutorialUi.resume.addEventListener("click", (event) => {
      if (!event.isTrusted || !tutorialState.active || !tutorialState.session) return;
      const recovery = tutorialRecoverableRecord();
      if (recovery && beginTutorialRecovery(recovery)) return;
      let index = Math.max(0, tutorialTours[tutorialState.page].steps.findIndex((step) => step.id === tutorialState.session.stepId));
      if (tutorialState.page === "collection") index = collectionTutorialResumeIndex(tutorialState.session, index);
    tutorialState.session.finished = false;
    ...
    tutorialUi.restart.addEventListener("click", (event) => {
      if (!event.isTrusted || !tutorialState.active) return;
      invalidateTutorialGate();
      const retained = (tutorialState.session?.ownedRecords || []).map((record) => ({ ...record }));
...
function showTutorialResumeChoice() {
  ...
  const recovery = tutorialRecoverableRecord();
  elements.tutorialTitle.textContent = recovery ? "Verify or clean up the bound record" : "Resume or restart";
  elements.tutorialInstruction.textContent = recovery
    ...
    : tutorialState.page === "collection" && !tutorialState.session.bindings?.collectionAdapterId
...
async function openDataResourceEditor(id, launcher = null) {
  const revealLauncher = launcher || currentRevealLauncher();
  const requestToken = disclosureToken(elements.dataResourceForm, revealLauncher);
  try {
    ...
    if (String(resource.id || "") !== String(id)) throw new Error("Resource detail ID did not match the requested record.");
    document.querySelector("#data-resource-id").value = resource.id || id;
    document.querySelector("#data-resource-provider").value = resource.provider || "";
    document.querySelector("#data-resource-namespace").value = resource.namespace || "";
    document.querySelector("#data-resource-name").value = resource.name || "";
    document.querySelector("#data-resource-kind").value = resource.kind || "";
...
async function updateDataResource(id) {
  ...
  if (!form.reportValidity()) return;
    try {
      await api(`/api/data/resources/${encodeURIComponent(id)}`, { method: "PATCH", body: JSON.stringify({ description: document.querySelector("#data-resource-description").value.trim() }) });
      closeDisclosurePanel(form, elements.showDataResourceForm);
      resetDataResourceEditor(false);
    loadedTabs.delete("datasets");
    await loadDataRegistry(true);
    showToast("Resource updated.");
  } catch (error) { showToast(`Resource update failed: ${error.message}`, true); }
}

async function restoreDataResource(id) {
  try {
    await api(`/api/data/resources/${encodeURIComponent(id)}`, { method: "PATCH", body: JSON.stringify({ archived: false }) });
    await loadDataRegistry(true);
    showToast("Resource restored, including its existing versions.");
  } catch (error) { showToast(`Resource restore failed: ${error.message}`, true); }
}
...
async function archiveDataResource(id) {
  ...
  try {
    await api(`/api/data/resources/${encodeURIComponent(id)}`, { method: "DELETE" });
    loadedTabs.delete("datasets");
    await loadDataRegistry(true);
    showToast("Resource archived; payload files were not deleted.");
  } catch (error) { showToast(`Resource archive failed: ${error.message}`, true); }
}

function stampTutorialRecordRows() {
  const configs = [
    ["data-resources-body", "data-resource-action", "resourceId"],
    ["collection-adapters-body", "data-collection-adapter-action", "collectionAdapterId"],
...
function initializeTutorialRecordRows() {
  ...
  bodies.forEach((body) => observer.observe(body, { childList: true, subtree: true }));
  stampTutorialRecordRows();
}
...
function updateTutorialLaunchStatus(page) {
  ...
  button.title = complete ? `${tutorialTours[page].title} tutorial completed. Run it again.` : `Start the ${tutorialTours[page].title} tutorial.`;
}
...
function prepareTutorialTarget(step) {
  ...
  if (step.details) {
    ...
    if (disclosure && !disclosure.open) {
      if (!tutorialState.openedDetails.has(disclosure)) tutorialState.openedDetails.set(disclosure, false);
  ...
  while (ancestor) {
    if (ancestor.tagName === "DETAILS" && !ancestor.open) {
      if (!tutorialState.openedDetails.has(ancestor)) tutorialState.openedDetails.set(ancestor, false);
      ancestor.open = true;
    }
...
function positionTutorialBlockers(viewport, spotLeft, spotTop, spotRight, spotBottom) {
  ...
  const [topBlocker, leftBlocker, rightBlocker, bottomBlocker] = tutorialUi.blockers;
  const set = (node, x, y, w, h) => Object.assign(node.style, { left: `${x}px`, top: `${y}px`, width: `${Math.max(0, w)}px`, height: `${Math.max(0, h)}px` });
...
function positionTutorial() {
  ...
  if (!rect) {
    if (rawRect) {
      ...
      positionTutorialBlockers(viewport, viewport.left, viewport.top, viewport.left, viewport.top);
      return;
    }
    ...
    if (!tutorialState.recovering) {
      ...
      const snapshot = { sessionGeneration: tutorialState.sessionGeneration, gateGeneration: tutorialState.gateGeneration, stepId: tutorialStep()?.id };
      tutorialState.recoveryTimer = window.setTimeout(() => {
        tutorialState.recoveryTimer = 0;
        tutorialState.recovering = false;
        if (tutorialGenerationMatches(snapshot)) showTutorialUnavailableStep(tutorialStep(), tutorialState.index);
      }, 0);
    }
    return;
  }
  ...
  const left = Math.min(maxLeft, Math.max(minLeft, rect.left + rect.width / 2 - dialogRect.width / 2));
  let top;
  let placement;
  if (rect.bottom + gap + dialogRect.height <= bottom - margin) {
    ...
    top = Math.max(viewport.top + margin, Math.min(bottom - dialogRect.height - margin, viewport.top + (viewport.height - dialogRect.height) / 2));
    placement = "center";
  }
...
function observeTutorialTarget() {
  ...
  if (tutorialState.target) tutorialState.resizeObserver.observe(tutorialState.target);
...
function focusTutorialStepTarget(target) {
  ...
  window.requestAnimationFrame(() => {
    if (tutorialState.active) elements.tutorialNext.focus({ preventScroll: true });
  });
}

function showTutorialUnavailableStep(step, index) {
  if (index === tutorialState.index && tutorialActionIsPending()) return;
  if (index === tutorialState.index && tutorialState.gateComplete && tutorialState.session?.completedStepIds.includes(step.id)) {
  ...
  const completed = Boolean(tutorialState.session?.completedStepIds.includes(step.id));
  tutorialState.gateComplete = completed;
  const snapshot = { sessionGeneration: tutorialState.sessionGeneration, gateGeneration: tutorialState.gateGeneration, stepId: step.id };
  tutorialState.target = workspaceHeading(tutorialState.page)?.querySelector("h1") || workspaceHeading(tutorialState.page) || document.body;
  tutorialState.target?.setAttribute("data-tutorial-active-target", "true");
  elements.tutorialPage.textContent = tutorialTours[tutorialState.page].title;
  ...
  elements.tutorialInstruction.textContent = completed ? `${step.instruction} This step is already complete; no further action is needed.`
  ...
  elements.tutorialNext.textContent = index === tutorialTours[tutorialState.page].steps.length - 1 ? "Finish" : "Next";
  tutorialUi.useValue.hidden = true;
  tutorialUi.confirmPanel.hidden = true;
  tutorialUi.resumePanel.hidden = true;
  tutorialUi.gateStatus.textContent = completed ? "Completed; continue when ready" : "The saved control is unavailable. Verify the saved record or restart to recover.";
  tutorialUi.resumePanel.hidden = false;
  ...
  tutorialState.renderObserver.observe(document.body, { childList: true, subtree: true, attributes: true });
  scheduleTutorialPosition();
...
function showTutorialStep(requestedIndex, direction = 1) {
  ...
  while (index >= 0 && index < tour.steps.length) {
    ...
    if (candidateStep.skipIf?.()) { index += direction; continue; }
  ...
  if (!target) {
    if (direction > 0) {
      ...
      endTutorial(false);
      showToast(`${pageTitle} tutorial stopped because no visible step was available.`, true);
    }
    return;
  }
  ...
  elements.tutorialBack.disabled = index === 0;
  elements.tutorialNext.textContent = index === tour.steps.length - 1 ? "Finish" : "Next";
  ...
  tutorialState.settleTimer = window.setTimeout(scheduleTutorialPosition, reducedMotion ? 0 : 220);
  scheduleTutorialPosition();
  observeTutorialTarget();
...
function tutorialFocusables() {
  const dialogControls = [...elements.tutorialDialog.querySelectorAll("button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled])")]
    .filter((control) => !control.hidden && !control.closest("[hidden]"));
  const target = tutorialState.target;
  if (target?.matches("button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), a[href]")) dialogControls.push(target);
  return [...new Set(dialogControls)];
}

function tutorialEditableHasFocus() {
  const active = document.activeElement;
  return Boolean(active?.matches("input, select, textarea, [contenteditable]:not([contenteditable=\"false\"]), [contenteditable=\"true\"]"));
}
...
function advanceTutorial(direction = 1) {
  ...
  const tour = tutorialTours[tutorialState.page];
  const step = tutorialStep();
  if (direction > 0 && step?.gate && !step.optional && !tutorialState.gateComplete) {
    tutorialUi.gateStatus.textContent = "Complete the highlighted step before continuing";
    tutorialInteractionTarget(step)?.focus?.({ preventScroll: true });
    return false;
  }
  if (direction > 0 && tutorialState.index >= tour.steps.length - 1) {
    if (!tutorialState.gateComplete && !tutorialVisibleRect(tutorialState.target)) return false;
    invalidateTutorialGate();
    endTutorial(true);
    return true;
  }
  let nextIndex = tutorialState.index + (direction < 0 ? -1 : 1);
  if (direction > 0 && step?.request?.method === "GET" && step.request.bind && tutorialBindingIsOwned(step.request.bind)) {
    const record = tutorialRecordFor(step.request.bind, tutorialState.session.bindings[step.request.bind]);
    if (record?.cleanupState === "archived") {
      const cleanupIndex = tour.steps.findIndex((candidate) => candidate.request?.cleanupBinding === step.request.bind);
...
function onTutorialKeydown(event) {
  ...
  if (event.key === "Enter" || event.key === " ") {
    ...
    if (tutorialEventHitsTarget({ target: control }, tutorialState.target)) return;
    if (control instanceof HTMLButtonElement && elements.tutorialDialog.contains(control) && control !== elements.tutorialNext && control !== elements.tutorialBack) return;
    event.preventDefault();
    event.stopImmediatePropagation();
...
function onTutorialNavigation() {
  if (tutorialState.active && activeTab !== tutorialState.page) endTutorial(false);
}
...
function observeTutorialPage() {
  ...
  const panel = document.querySelector(`[data-tab-panel="${tutorialState.page}"]`);
...
function addTutorialRuntimeListeners() {
  ...
  for (const type of ["input", "change", "click", "submit"]) document.addEventListener(type, onTutorialInteraction, true);
  ...
  window.addEventListener("orientationchange", scheduleTutorialPosition, { passive: true });
...
function removeTutorialRuntimeListeners() {
  ...
  for (const type of ["input", "change", "click", "submit"]) document.removeEventListener(type, onTutorialInteraction, true);
  elements.tutorialNext.removeEventListener("click", onTutorialNextCapture, true);
  elements.tutorialBack.removeEventListener("click", onTutorialBackCapture, true);
  ...
  window.visualViewport?.removeEventListener("resize", scheduleTutorialPosition);
  window.visualViewport?.removeEventListener("scroll", scheduleTutorialPosition);
  tutorialState.pageObserver?.disconnect();
  tutorialState.pageObserver = null;
}
...
function endTutorial(completed = false) {
  ...
  if (tutorialState.session) {
    ...
    if (tutorialState.index >= 0) tutorialState.session.stepId = tutorialStep()?.id || tutorialState.session.stepId;
    persistTutorialSession();
  }
  invalidateTutorialGate();
  ...
  tutorialState.renderObserver?.disconnect();
  tutorialState.renderObserver = null;
  if (tutorialState.animationFrame) window.cancelAnimationFrame(tutorialState.animationFrame);
  tutorialState.animationFrame = 0;
  clearTimeout(tutorialState.settleTimer);
...
function initializeTutorials() {
  ...
  for (const [page, tour] of Object.entries(tutorialTours)) {
    ...
    if (!actions) {
      ...
      [...heading.children].filter((child) => child.tagName === "BUTTON").forEach((button) => actions.append(button));
...
function normalizedTrackingItems(entity) {
  ...
  const rawStatuses = Array.isArray(entity.tracking_statuses)
    ...
    : Array.isArray(entity.tracking?.providers)
      ...
      : [];
  const items = [...rawLinks, ...rawStatuses].filter((item) => item && typeof item === "object");
  const legacy = [
    ["wandb", entity.wandb_url || entity.wandb_run_url, entity.wandb_run_id],
    ["mlflow", entity.mlflow_url || entity.mlflow_run_url, entity.mlflow_run_id],
  ];
  legacy.forEach(([provider, url, remoteId]) => {
    if (url || remoteId) items.push({ provider, url, remote_id: remoteId, status: url ? "connected" : "queued" });
  });
...
function normalizeTrackingConnections(payload) {
  ...
  if (raw && typeof raw === "object") {
    return Object.entries(raw).map(([provider, connection]) => ({ provider, ...(connection || {}) }));
  }
  throw new Error('Tracking connection response did not contain "connections".');
}
...
function renderTrackingConnection(provider, connection) {
  ...
  const normalized = connection && typeof connection === "object"
    ? { provider, ...connection }
...
function renderTrackingConnections(payload) {
  ...
  ["wandb", "mlflow"].forEach((provider) => renderTrackingConnection(provider, byProvider.get(provider)));
}

function renderTrackingConnectionsUnavailable(message) {
  ["wandb", "mlflow"].forEach((provider) => {
    const ui = trackingConnectionElements(provider);
    trackingConnections.set(provider, { ...(trackingConnections.get(provider) || {}), status: "unavailable", connected: false, last_error: message });
...
function clearTrackingSecrets(provider) {
  trackingConnectionElements(provider).secrets.forEach((input) => { input.value = ""; });
}
...
async function submitTrackingConnection(provider, action) {
  ...
  if (action === "connect") {
    ...
    if (provider === "mlflow" && !payload.tracking_uri) {
      showToast("Enter the MLflow tracking URI.", true, { scope: notificationScope });
...
function renderTrackingNamePreview() {
  ...
  if (elements.wandbEnabled.checked) {
    ...
    const project = derivedTrackingName(elements.wandbProject.value) || experimentName || "Enter an experiment name";
    previews.push(`<div><strong>W&amp;B</strong><span>${escapeHtml(connection.entity || "No verified workspace")} / ${escapeHtml(project)}</span><small>${escapeHtml(elements.wandbRunName.value.trim() || "No run name template")}</small></div>`);
  }
  if (elements.mlflowEnabled.checked) {
    const experiment = derivedTrackingName(elements.mlflowExperiment.value) || experimentName || "Enter an experiment name";
    previews.push(`<div><strong>MLflow</strong><span>${escapeHtml(experiment)}</span><small>${escapeHtml(elements.mlflowRunName.value.trim() || "No run name template")}</small></div>`);
  }
  elements.wandbProject.placeholder = experimentName ? `Automatic: ${experimentName}` : "Defaults to the Skynet experiment name";
  elements.mlflowExperiment.placeholder = experimentName ? `Automatic: ${experimentName}` : "Defaults to the Skynet experiment name";
...
function renderSettings(payload) {
  const settings = payload && typeof payload === "object" && !Array.isArray(payload)
...
async function refreshResolvedSettings() {
  try {
    ...
    elements.settingsBody.innerHTML = emptyRow(2, "Settings could not be loaded.");
    showNotice(elements.settingsError, `Settings: ${error.message}`, { scope: "settings:resolved" });
  }
}
...
async function loadSettings(force = false) {
  ...
  try {
    ...
    if (settingsResult.status === "fulfilled") {
      ...
      elements.settingsBody.innerHTML = emptyRow(2, "Settings could not be loaded.");
      showNotice(elements.settingsError, `Settings: ${settingsResult.reason.message}`, { scope: "settings:resolved" });
    }
    if (connectionsResult.status === "rejected") showNotice(elements.settingsError, `Tracking: ${connectionsResult.reason.message}`, { scope: "settings:connections" });
    else clearNotificationScope("settings:connections");
    loadedTabs.add("settings");
  } catch (error) {
    elements.settingsBody.innerHTML = emptyRow(2, "Settings could not be loaded.");
    showNotice(elements.settingsError, `Settings API unavailable: ${error.message}`, { scope: "settings:resolved" });
  } finally {
...
function restoreSshGatewayPreference() {
  ...
  if (![...elements.gateway.options].some((option) => option.value === savedGateway)) return false;
...
function persistSshGatewayPreference() {
  try {
    window.localStorage.setItem(SSH_GATEWAY_PREFERENCE_KEY, elements.gateway.value);
  } catch {
...
elements.saveExperimentButton.addEventListener("click", () => createExperiment(false));
...
elements.sourceRefRefresh.addEventListener("click", () => {
  const pinnedCommit = elements.experimentBranch.dataset.pinnedCommit === "true";
...
elements.experimentBranch.addEventListener("change", () => {
  const repository = elements.experimentSource.value.trim();
  const branch = elements.experimentBranch.value;
  const branchTip = sourceBranches.find((branch) => branch.name === elements.experimentBranch.value)?.sha || "";
  try {
    const savedCommit = savedSourceSelection(repository).commits?.[branch] || "";
...
elements.experimentsBody.addEventListener("click", (event) => {
  ...
  if (button.dataset.experimentAction === "load") {
    loadExperimentConfiguration(button.dataset.id, button.dataset.revisionNumber, button);
    return;
  }
  if (button.dataset.experimentAction === "view") viewExperiment(button.dataset.id, button);
  if (button.dataset.experimentAction === "submit") submitDraftExperiment(button.dataset.id, button);
});
...
elements.evaluationRunId.addEventListener("input", () => {
  ...
  evaluationSuiteReloadTimer = window.setTimeout(async () => {
    ...
    if (elements.evaluationRunId.value.trim() === runId) pendingEvaluationSuiteId = "";
  }, 350);
});
elements.evaluationCheckpoint.addEventListener("input", () => scheduleEvaluationTargetValidation());
elements.evaluationTasksFilter.addEventListener("click", (event) => {
  if (elements.evaluationTasksFilter.getAttribute("aria-disabled") === "true" && event.target.closest("summary")) {
    event.preventDefault();
  }
});
...
elements.evaluationTasksAll.addEventListener("click", () => {
  elements.evaluationTasksOptions.querySelectorAll("input").forEach((input) => { input.checked = true; });
  updateEvaluationTaskLabel();
  scheduleEvaluationTargetValidation();
});
elements.evaluationTasksClear.addEventListener("click", () => {
  const defaults = selectedEvaluationSuite()?.default_tasks || selectedEvaluationSuite()?.config_json?.default_tasks || [];
  elements.evaluationTasksOptions.querySelectorAll("input").forEach((input) => { input.checked = defaults.includes(input.value); });
  applyEvaluationTaskSelectionPolicy();
  updateEvaluationTaskLabel();
  scheduleEvaluationTargetValidation();
});
elements.evaluationArgv.addEventListener("input", () => scheduleEvaluationTargetValidation());
elements.evaluationResumeArgv.addEventListener("input", () => scheduleEvaluationTargetValidation());
...
if (elements.showDataResourceForm) {
  elements.showDataResourceForm.addEventListener("click", (event) => {
    resetDataResourceEditor(false);
    revealPanel(elements.dataResourceForm, { focusTarget: elements.dataResourceProvider, launcher: event.currentTarget });
  });
}
elements.dataResourcesBody.addEventListener("click", (event) => {
  ...
  if (button.dataset.resourceAction === "archive") archiveDataResource(button.dataset.id);
  if (button.dataset.resourceAction === "restore") restoreDataResource(button.dataset.id);
});
...
elements.dataImportsBody.addEventListener("click", (event) => {
  ...
  if (button?.dataset.importAction === "cancel") cancelDataImport(button.dataset.id, button);
});
...
if (elements.showDataDerivationForm) {
  elements.showDataDerivationForm.addEventListener("click", (event) => {
    revealPanel(elements.dataDerivationForm, { focusTarget: elements.dataDerivationOutput, launcher: event.currentTarget });
  });
}
elements.dataBundlesBody.addEventListener("click", (event) => {
  const button = event.target.closest("[data-bundle-action]");
  if (button?.dataset.bundleAction === "preview") viewDataBundlePreview(button.dataset.id, button);
});
...
elements.collectionAdapterForm.addEventListener("submit", saveCollectionAdapter);
elements.collectionAdaptersBody.addEventListener("click", (event) => {
  ...
  if (button.dataset.collectionAdapterAction === "restore") setCollectionAdapterArchived(id, false);
});
elements.collectionRegisterOutput.addEventListener("change", updateCollectionRegistrationFields);
...
elements.collectionSessionsBody.addEventListener("click", (event) => {
  ...
  if (button?.dataset.collectionSessionAction === "view") viewCollectionSession(button.dataset.id, button);
});
elements.collectionSessionActions.addEventListener("click", (event) => {
  ...
  if (button) runCollectionLifecycleAction(button.dataset.collectionLifecycleAction);
});
elements.collectionLoadStdout.addEventListener("click", () => loadCollectionLog("stdout"));
elements.collectionLoadStderr.addEventListener("click", () => loadCollectionLog("stderr"));
elements.collectionCompleteForm.addEventListener("submit", completeCollectionSession);
...
elements.addAdapter.addEventListener("click", (event) => startAdapterCreate(event.currentTarget));
...
elements.editAdapter.addEventListener("click", () => setAdapterEditorMode("edit"));
